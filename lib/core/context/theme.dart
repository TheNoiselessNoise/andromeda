...
class AppConfig {
  ...
  static AndromedaTheme defaultTheme = AndromedaLightTheme();
  static AndromedaTheme darkTheme = AndromedaDarkTheme();
  static AndromedaTheme lightTheme = AndromedaLightTheme();
}

abstract class AndromedaTheme {
  static AndromedaTheme of(BuildContext? context) {
  ...
  CoreTypography get typography => AndromedaThemeTypography(this);
}

class AndromedaLightTheme extends AndromedaTheme {
...
class AndromedaDarkTheme extends AndromedaTheme {
  @override
  Color get primaryColor => primary;
  @override
  Color get secondaryColor => secondary;
...
class AndromedaThemeTypography extends CoreTypography {
  AndromedaThemeTypography(this.theme);

  final AndromedaTheme theme;
