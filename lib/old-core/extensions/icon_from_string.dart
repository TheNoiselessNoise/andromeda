...
IconData? faIconDataFromString(String? value) {
  if (value == 'zero') return FontAwesomeIcons.zero;
  if (value == 'one') return FontAwesomeIcons.one;
  if (value == 'two') return FontAwesomeIcons.two;
  if (value == 'three') return FontAwesomeIcons.three;
  if (value == 'four') return FontAwesomeIcons.four;
  if (value == 'five') return FontAwesomeIcons.five;
  if (value == 'six') return FontAwesomeIcons.six;
  if (value == 'seven') return FontAwesomeIcons.seven;
  if (value == 'eight') return FontAwesomeIcons.eight;
  if (value == 'nine') return FontAwesomeIcons.nine;
  if (value == 'fortyTwoGroup') return FontAwesomeIcons.fortyTwoGroup;
  if (value == 'innosoft') return FontAwesomeIcons.innosoft;
  if (value == 'fiveHundredPx') return FontAwesomeIcons.fiveHundredPx;
  if (value == 'a') return FontAwesomeIcons.a;
  if (value == 'accessibleIcon') return FontAwesomeIcons.accessibleIcon;
  if (value == 'accusoft') return FontAwesomeIcons.accusoft;
  if (value == 'solidAddressBook') return FontAwesomeIcons.solidAddressBook;
  if (value == 'solidContactBook') return FontAwesomeIcons.solidContactBook;
  if (value == 'addressBook') return FontAwesomeIcons.addressBook;
  if (value == 'contactBook') return FontAwesomeIcons.contactBook;
  if (value == 'solidAddressCard') return FontAwesomeIcons.solidAddressCard;
  if (value == 'solidContactCard') return FontAwesomeIcons.solidContactCard;
  if (value == 'solidVcard') return FontAwesomeIcons.solidVcard;
  if (value == 'addressCard') return FontAwesomeIcons.addressCard;
  if (value == 'contactCard') return FontAwesomeIcons.contactCard;
  if (value == 'vcard') return FontAwesomeIcons.vcard;
  if (value == 'adn') return FontAwesomeIcons.adn;
  if (value == 'adversal') return FontAwesomeIcons.adversal;
  if (value == 'affiliatetheme') return FontAwesomeIcons.affiliatetheme;
  if (value == 'airbnb') return FontAwesomeIcons.airbnb;
  if (value == 'algolia') return FontAwesomeIcons.algolia;
  if (value == 'alignCenter') return FontAwesomeIcons.alignCenter;
  if (value == 'alignJustify') return FontAwesomeIcons.alignJustify;
  if (value == 'alignLeft') return FontAwesomeIcons.alignLeft;
  if (value == 'alignRight') return FontAwesomeIcons.alignRight;
  if (value == 'alipay') return FontAwesomeIcons.alipay;
  if (value == 'amazon') return FontAwesomeIcons.amazon;
  if (value == 'amazonPay') return FontAwesomeIcons.amazonPay;
  if (value == 'amilia') return FontAwesomeIcons.amilia;
  if (value == 'anchor') return FontAwesomeIcons.anchor;
  if (value == 'anchorCircleCheck') return FontAwesomeIcons.anchorCircleCheck;
  if (value == 'anchorCircleExclamation') return FontAwesomeIcons.anchorCircleExclamation;
  if (value == 'anchorCircleXmark') return FontAwesomeIcons.anchorCircleXmark;
  if (value == 'anchorLock') return FontAwesomeIcons.anchorLock;
  if (value == 'android') return FontAwesomeIcons.android;
  if (value == 'angellist') return FontAwesomeIcons.angellist;
  if (value == 'angleDown') return FontAwesomeIcons.angleDown;
  if (value == 'angleLeft') return FontAwesomeIcons.angleLeft;
  if (value == 'angleRight') return FontAwesomeIcons.angleRight;
  if (value == 'angleUp') return FontAwesomeIcons.angleUp;
  if (value == 'anglesDown') return FontAwesomeIcons.anglesDown;
  if (value == 'angleDoubleDown') return FontAwesomeIcons.angleDoubleDown;
  if (value == 'anglesLeft') return FontAwesomeIcons.anglesLeft;
  if (value == 'angleDoubleLeft') return FontAwesomeIcons.angleDoubleLeft;
  if (value == 'anglesRight') return FontAwesomeIcons.anglesRight;
  if (value == 'angleDoubleRight') return FontAwesomeIcons.angleDoubleRight;
  if (value == 'anglesUp') return FontAwesomeIcons.anglesUp;
  if (value == 'angleDoubleUp') return FontAwesomeIcons.angleDoubleUp;
  if (value == 'angrycreative') return FontAwesomeIcons.angrycreative;
  if (value == 'angular') return FontAwesomeIcons.angular;
  if (value == 'ankh') return FontAwesomeIcons.ankh;
  if (value == 'appStore') return FontAwesomeIcons.appStore;
  if (value == 'appStoreIos') return FontAwesomeIcons.appStoreIos;
  if (value == 'apper') return FontAwesomeIcons.apper;
  if (value == 'apple') return FontAwesomeIcons.apple;
  if (value == 'applePay') return FontAwesomeIcons.applePay;
  if (value == 'appleWhole') return FontAwesomeIcons.appleWhole;
  if (value == 'appleAlt') return FontAwesomeIcons.appleAlt;
  if (value == 'archway') return FontAwesomeIcons.archway;
  if (value == 'arrowDown') return FontAwesomeIcons.arrowDown;
  if (value == 'arrowDown19') return FontAwesomeIcons.arrowDown19;
  if (value == 'sortNumericAsc') return FontAwesomeIcons.sortNumericAsc;
  if (value == 'sortNumericDown') return FontAwesomeIcons.sortNumericDown;
  if (value == 'arrowDown91') return FontAwesomeIcons.arrowDown91;
  if (value == 'sortNumericDesc') return FontAwesomeIcons.sortNumericDesc;
  if (value == 'sortNumericDownAlt') return FontAwesomeIcons.sortNumericDownAlt;
  if (value == 'arrowDownAZ') return FontAwesomeIcons.arrowDownAZ;
  if (value == 'sortAlphaAsc') return FontAwesomeIcons.sortAlphaAsc;
  if (value == 'sortAlphaDown') return FontAwesomeIcons.sortAlphaDown;
  if (value == 'arrowDownLong') return FontAwesomeIcons.arrowDownLong;
  if (value == 'longArrowDown') return FontAwesomeIcons.longArrowDown;
  if (value == 'arrowDownShortWide') return FontAwesomeIcons.arrowDownShortWide;
  if (value == 'sortAmountDesc') return FontAwesomeIcons.sortAmountDesc;
  if (value == 'sortAmountDownAlt') return FontAwesomeIcons.sortAmountDownAlt;
  if (value == 'arrowDownUpAcrossLine') return FontAwesomeIcons.arrowDownUpAcrossLine;
  if (value == 'arrowDownUpLock') return FontAwesomeIcons.arrowDownUpLock;
  if (value == 'arrowDownWideShort') return FontAwesomeIcons.arrowDownWideShort;
  if (value == 'sortAmountAsc') return FontAwesomeIcons.sortAmountAsc;
  if (value == 'sortAmountDown') return FontAwesomeIcons.sortAmountDown;
  if (value == 'arrowDownZA') return FontAwesomeIcons.arrowDownZA;
  if (value == 'sortAlphaDesc') return FontAwesomeIcons.sortAlphaDesc;
  if (value == 'sortAlphaDownAlt') return FontAwesomeIcons.sortAlphaDownAlt;
  if (value == 'arrowLeft') return FontAwesomeIcons.arrowLeft;
  if (value == 'arrowLeftLong') return FontAwesomeIcons.arrowLeftLong;
  if (value == 'longArrowLeft') return FontAwesomeIcons.longArrowLeft;
  if (value == 'arrowPointer') return FontAwesomeIcons.arrowPointer;
  if (value == 'mousePointer') return FontAwesomeIcons.mousePointer;
  if (value == 'arrowRight') return FontAwesomeIcons.arrowRight;
  if (value == 'arrowRightArrowLeft') return FontAwesomeIcons.arrowRightArrowLeft;
  if (value == 'exchange') return FontAwesomeIcons.exchange;
  if (value == 'arrowRightFromBracket') return FontAwesomeIcons.arrowRightFromBracket;
  if (value == 'signOut') return FontAwesomeIcons.signOut;
  if (value == 'arrowRightLong') return FontAwesomeIcons.arrowRightLong;
  if (value == 'longArrowRight') return FontAwesomeIcons.longArrowRight;
  if (value == 'arrowRightToBracket') return FontAwesomeIcons.arrowRightToBracket;
  if (value == 'signIn') return FontAwesomeIcons.signIn;
  if (value == 'arrowRightToCity') return FontAwesomeIcons.arrowRightToCity;
  if (value == 'arrowRotateLeft') return FontAwesomeIcons.arrowRotateLeft;
  if (value == 'arrowLeftRotate') return FontAwesomeIcons.arrowLeftRotate;
  if (value == 'arrowRotateBack') return FontAwesomeIcons.arrowRotateBack;
  if (value == 'arrowRotateBackward') return FontAwesomeIcons.arrowRotateBackward;
  if (value == 'undo') return FontAwesomeIcons.undo;
  if (value == 'arrowRotateRight') return FontAwesomeIcons.arrowRotateRight;
  if (value == 'arrowRightRotate') return FontAwesomeIcons.arrowRightRotate;
  if (value == 'arrowRotateForward') return FontAwesomeIcons.arrowRotateForward;
  if (value == 'redo') return FontAwesomeIcons.redo;
  if (value == 'arrowTrendDown') return FontAwesomeIcons.arrowTrendDown;
  if (value == 'arrowTrendUp') return FontAwesomeIcons.arrowTrendUp;
  if (value == 'arrowTurnDown') return FontAwesomeIcons.arrowTurnDown;
  if (value == 'levelDown') return FontAwesomeIcons.levelDown;
  if (value == 'arrowTurnUp') return FontAwesomeIcons.arrowTurnUp;
  if (value == 'levelUp') return FontAwesomeIcons.levelUp;
  if (value == 'arrowUp') return FontAwesomeIcons.arrowUp;
  if (value == 'arrowUp19') return FontAwesomeIcons.arrowUp19;
  if (value == 'sortNumericUp') return FontAwesomeIcons.sortNumericUp;
  if (value == 'arrowUp91') return FontAwesomeIcons.arrowUp91;
  if (value == 'sortNumericUpAlt') return FontAwesomeIcons.sortNumericUpAlt;
  if (value == 'arrowUpAZ') return FontAwesomeIcons.arrowUpAZ;
  if (value == 'sortAlphaUp') return FontAwesomeIcons.sortAlphaUp;
  if (value == 'arrowUpFromBracket') return FontAwesomeIcons.arrowUpFromBracket;
  if (value == 'arrowUpFromGroundWater') return FontAwesomeIcons.arrowUpFromGroundWater;
  if (value == 'arrowUpFromWaterPump') return FontAwesomeIcons.arrowUpFromWaterPump;
  if (value == 'arrowUpLong') return FontAwesomeIcons.arrowUpLong;
  if (value == 'longArrowUp') return FontAwesomeIcons.longArrowUp;
  if (value == 'arrowUpRightDots') return FontAwesomeIcons.arrowUpRightDots;
  if (value == 'arrowUpRightFromSquare') return FontAwesomeIcons.arrowUpRightFromSquare;
  if (value == 'externalLink') return FontAwesomeIcons.externalLink;
  if (value == 'arrowUpShortWide') return FontAwesomeIcons.arrowUpShortWide;
  if (value == 'sortAmountUpAlt') return FontAwesomeIcons.sortAmountUpAlt;
  if (value == 'arrowUpWideShort') return FontAwesomeIcons.arrowUpWideShort;
  if (value == 'sortAmountUp') return FontAwesomeIcons.sortAmountUp;
  if (value == 'arrowUpZA') return FontAwesomeIcons.arrowUpZA;
  if (value == 'sortAlphaUpAlt') return FontAwesomeIcons.sortAlphaUpAlt;
  if (value == 'arrowsDownToLine') return FontAwesomeIcons.arrowsDownToLine;
  if (value == 'arrowsDownToPeople') return FontAwesomeIcons.arrowsDownToPeople;
  if (value == 'arrowsLeftRight') return FontAwesomeIcons.arrowsLeftRight;
  if (value == 'arrowsH') return FontAwesomeIcons.arrowsH;
  if (value == 'arrowsLeftRightToLine') return FontAwesomeIcons.arrowsLeftRightToLine;
  if (value == 'arrowsRotate') return FontAwesomeIcons.arrowsRotate;
  if (value == 'refresh') return FontAwesomeIcons.refresh;
  if (value == 'sync') return FontAwesomeIcons.sync;
  if (value == 'arrowsSpin') return FontAwesomeIcons.arrowsSpin;
  if (value == 'arrowsSplitUpAndLeft') return FontAwesomeIcons.arrowsSplitUpAndLeft;
  if (value == 'arrowsToCircle') return FontAwesomeIcons.arrowsToCircle;
  if (value == 'arrowsToDot') return FontAwesomeIcons.arrowsToDot;
  if (value == 'arrowsToEye') return FontAwesomeIcons.arrowsToEye;
  if (value == 'arrowsTurnRight') return FontAwesomeIcons.arrowsTurnRight;
  if (value == 'arrowsTurnToDots') return FontAwesomeIcons.arrowsTurnToDots;
  if (value == 'arrowsUpDown') return FontAwesomeIcons.arrowsUpDown;
  if (value == 'arrowsV') return FontAwesomeIcons.arrowsV;
  if (value == 'arrowsUpDownLeftRight') return FontAwesomeIcons.arrowsUpDownLeftRight;
  if (value == 'arrows') return FontAwesomeIcons.arrows;
  if (value == 'arrowsUpToLine') return FontAwesomeIcons.arrowsUpToLine;
  if (value == 'artstation') return FontAwesomeIcons.artstation;
  if (value == 'asterisk') return FontAwesomeIcons.asterisk;
  if (value == 'asymmetrik') return FontAwesomeIcons.asymmetrik;
  if (value == 'at') return FontAwesomeIcons.at;
  if (value == 'atlassian') return FontAwesomeIcons.atlassian;
  if (value == 'atom') return FontAwesomeIcons.atom;
  if (value == 'audible') return FontAwesomeIcons.audible;
  if (value == 'audioDescription') return FontAwesomeIcons.audioDescription;
  if (value == 'australSign') return FontAwesomeIcons.australSign;
  if (value == 'autoprefixer') return FontAwesomeIcons.autoprefixer;
  if (value == 'avianex') return FontAwesomeIcons.avianex;
  if (value == 'aviato') return FontAwesomeIcons.aviato;
  if (value == 'award') return FontAwesomeIcons.award;
  if (value == 'aws') return FontAwesomeIcons.aws;
  if (value == 'b') return FontAwesomeIcons.b;
  if (value == 'baby') return FontAwesomeIcons.baby;
  if (value == 'babyCarriage') return FontAwesomeIcons.babyCarriage;
  if (value == 'carriageBaby') return FontAwesomeIcons.carriageBaby;
  if (value == 'backward') return FontAwesomeIcons.backward;
  if (value == 'backwardFast') return FontAwesomeIcons.backwardFast;
  if (value == 'fastBackward') return FontAwesomeIcons.fastBackward;
  if (value == 'backwardStep') return FontAwesomeIcons.backwardStep;
  if (value == 'stepBackward') return FontAwesomeIcons.stepBackward;
  if (value == 'bacon') return FontAwesomeIcons.bacon;
  if (value == 'bacteria') return FontAwesomeIcons.bacteria;
  if (value == 'bacterium') return FontAwesomeIcons.bacterium;
  if (value == 'bagShopping') return FontAwesomeIcons.bagShopping;
  if (value == 'shoppingBag') return FontAwesomeIcons.shoppingBag;
  if (value == 'bahai') return FontAwesomeIcons.bahai;
  if (value == 'haykal') return FontAwesomeIcons.haykal;
  if (value == 'bahtSign') return FontAwesomeIcons.bahtSign;
  if (value == 'ban') return FontAwesomeIcons.ban;
  if (value == 'cancel') return FontAwesomeIcons.cancel;
  if (value == 'banSmoking') return FontAwesomeIcons.banSmoking;
  if (value == 'smokingBan') return FontAwesomeIcons.smokingBan;
  if (value == 'bandage') return FontAwesomeIcons.bandage;
  if (value == 'bandAid') return FontAwesomeIcons.bandAid;
  if (value == 'bandcamp') return FontAwesomeIcons.bandcamp;
  if (value == 'bangladeshiTakaSign') return FontAwesomeIcons.bangladeshiTakaSign;
  if (value == 'barcode') return FontAwesomeIcons.barcode;
  if (value == 'bars') return FontAwesomeIcons.bars;
  if (value == 'navicon') return FontAwesomeIcons.navicon;
  if (value == 'barsProgress') return FontAwesomeIcons.barsProgress;
  if (value == 'tasksAlt') return FontAwesomeIcons.tasksAlt;
  if (value == 'barsStaggered') return FontAwesomeIcons.barsStaggered;
  if (value == 'reorder') return FontAwesomeIcons.reorder;
  if (value == 'stream') return FontAwesomeIcons.stream;
  if (value == 'baseball') return FontAwesomeIcons.baseball;
  if (value == 'baseballBall') return FontAwesomeIcons.baseballBall;
  if (value == 'baseballBatBall') return FontAwesomeIcons.baseballBatBall;
  if (value == 'basketShopping') return FontAwesomeIcons.basketShopping;
  if (value == 'shoppingBasket') return FontAwesomeIcons.shoppingBasket;
  if (value == 'basketball') return FontAwesomeIcons.basketball;
  if (value == 'basketballBall') return FontAwesomeIcons.basketballBall;
  if (value == 'bath') return FontAwesomeIcons.bath;
  if (value == 'bathtub') return FontAwesomeIcons.bathtub;
  if (value == 'batteryEmpty') return FontAwesomeIcons.batteryEmpty;
  if (value == 'battery0') return FontAwesomeIcons.battery0;
  if (value == 'batteryFull') return FontAwesomeIcons.batteryFull;
  if (value == 'battery') return FontAwesomeIcons.battery;
  if (value == 'battery5') return FontAwesomeIcons.battery5;
  if (value == 'batteryHalf') return FontAwesomeIcons.batteryHalf;
  if (value == 'battery3') return FontAwesomeIcons.battery3;
  if (value == 'batteryQuarter') return FontAwesomeIcons.batteryQuarter;
  if (value == 'battery2') return FontAwesomeIcons.battery2;
  if (value == 'batteryThreeQuarters') return FontAwesomeIcons.batteryThreeQuarters;
  if (value == 'battery4') return FontAwesomeIcons.battery4;
  if (value == 'battleNet') return FontAwesomeIcons.battleNet;
  if (value == 'bed') return FontAwesomeIcons.bed;
  if (value == 'bedPulse') return FontAwesomeIcons.bedPulse;
  if (value == 'procedures') return FontAwesomeIcons.procedures;
  if (value == 'beerMugEmpty') return FontAwesomeIcons.beerMugEmpty;
  if (value == 'beer') return FontAwesomeIcons.beer;
  if (value == 'behance') return FontAwesomeIcons.behance;
  if (value == 'solidBell') return FontAwesomeIcons.solidBell;
  if (value == 'bell') return FontAwesomeIcons.bell;
  if (value == 'bellConcierge') return FontAwesomeIcons.bellConcierge;
  if (value == 'conciergeBell') return FontAwesomeIcons.conciergeBell;
  if (value == 'solidBellSlash') return FontAwesomeIcons.solidBellSlash;
  if (value == 'bellSlash') return FontAwesomeIcons.bellSlash;
  if (value == 'bezierCurve') return FontAwesomeIcons.bezierCurve;
  if (value == 'bicycle') return FontAwesomeIcons.bicycle;
  if (value == 'bilibili') return FontAwesomeIcons.bilibili;
  if (value == 'bimobject') return FontAwesomeIcons.bimobject;
  if (value == 'binoculars') return FontAwesomeIcons.binoculars;
  if (value == 'biohazard') return FontAwesomeIcons.biohazard;
  if (value == 'bitbucket') return FontAwesomeIcons.bitbucket;
  if (value == 'bitcoin') return FontAwesomeIcons.bitcoin;
  if (value == 'bitcoinSign') return FontAwesomeIcons.bitcoinSign;
  if (value == 'bity') return FontAwesomeIcons.bity;
  if (value == 'blackTie') return FontAwesomeIcons.blackTie;
  if (value == 'blackberry') return FontAwesomeIcons.blackberry;
  if (value == 'blender') return FontAwesomeIcons.blender;
  if (value == 'blenderPhone') return FontAwesomeIcons.blenderPhone;
  if (value == 'blog') return FontAwesomeIcons.blog;
  if (value == 'blogger') return FontAwesomeIcons.blogger;
  if (value == 'bloggerB') return FontAwesomeIcons.bloggerB;
  if (value == 'bluetooth') return FontAwesomeIcons.bluetooth;
  if (value == 'bluetoothB') return FontAwesomeIcons.bluetoothB;
  if (value == 'bold') return FontAwesomeIcons.bold;
  if (value == 'bolt') return FontAwesomeIcons.bolt;
  if (value == 'zap') return FontAwesomeIcons.zap;
  if (value == 'boltLightning') return FontAwesomeIcons.boltLightning;
  if (value == 'bomb') return FontAwesomeIcons.bomb;
  if (value == 'bone') return FontAwesomeIcons.bone;
  if (value == 'bong') return FontAwesomeIcons.bong;
  if (value == 'book') return FontAwesomeIcons.book;
  if (value == 'bookAtlas') return FontAwesomeIcons.bookAtlas;
  if (value == 'atlas') return FontAwesomeIcons.atlas;
  if (value == 'bookBible') return FontAwesomeIcons.bookBible;
  if (value == 'bible') return FontAwesomeIcons.bible;
  if (value == 'bookBookmark') return FontAwesomeIcons.bookBookmark;
  if (value == 'bookJournalWhills') return FontAwesomeIcons.bookJournalWhills;
  if (value == 'journalWhills') return FontAwesomeIcons.journalWhills;
  if (value == 'bookMedical') return FontAwesomeIcons.bookMedical;
  if (value == 'bookOpen') return FontAwesomeIcons.bookOpen;
  if (value == 'bookOpenReader') return FontAwesomeIcons.bookOpenReader;
  if (value == 'bookReader') return FontAwesomeIcons.bookReader;
  if (value == 'bookQuran') return FontAwesomeIcons.bookQuran;
  if (value == 'quran') return FontAwesomeIcons.quran;
  if (value == 'bookSkull') return FontAwesomeIcons.bookSkull;
  if (value == 'bookDead') return FontAwesomeIcons.bookDead;
  if (value == 'bookTanakh') return FontAwesomeIcons.bookTanakh;
  if (value == 'tanakh') return FontAwesomeIcons.tanakh;
  if (value == 'solidBookmark') return FontAwesomeIcons.solidBookmark;
  if (value == 'bookmark') return FontAwesomeIcons.bookmark;
  if (value == 'bootstrap') return FontAwesomeIcons.bootstrap;
  if (value == 'borderAll') return FontAwesomeIcons.borderAll;
  if (value == 'borderNone') return FontAwesomeIcons.borderNone;
  if (value == 'borderTopLeft') return FontAwesomeIcons.borderTopLeft;
  if (value == 'borderStyle') return FontAwesomeIcons.borderStyle;
  if (value == 'boreHole') return FontAwesomeIcons.boreHole;
  if (value == 'bots') return FontAwesomeIcons.bots;
  if (value == 'bottleDroplet') return FontAwesomeIcons.bottleDroplet;
  if (value == 'bottleWater') return FontAwesomeIcons.bottleWater;
  if (value == 'bowlFood') return FontAwesomeIcons.bowlFood;
  if (value == 'bowlRice') return FontAwesomeIcons.bowlRice;
  if (value == 'bowlingBall') return FontAwesomeIcons.bowlingBall;
  if (value == 'box') return FontAwesomeIcons.box;
  if (value == 'boxArchive') return FontAwesomeIcons.boxArchive;
  if (value == 'archive') return FontAwesomeIcons.archive;
  if (value == 'boxOpen') return FontAwesomeIcons.boxOpen;
  if (value == 'boxTissue') return FontAwesomeIcons.boxTissue;
  if (value == 'boxesPacking') return FontAwesomeIcons.boxesPacking;
  if (value == 'boxesStacked') return FontAwesomeIcons.boxesStacked;
  if (value == 'boxes') return FontAwesomeIcons.boxes;
  if (value == 'boxesAlt') return FontAwesomeIcons.boxesAlt;
  if (value == 'braille') return FontAwesomeIcons.braille;
  if (value == 'brain') return FontAwesomeIcons.brain;
  if (value == 'brave') return FontAwesomeIcons.brave;
  if (value == 'braveReverse') return FontAwesomeIcons.braveReverse;
  if (value == 'brazilianRealSign') return FontAwesomeIcons.brazilianRealSign;
  if (value == 'breadSlice') return FontAwesomeIcons.breadSlice;
  if (value == 'bridge') return FontAwesomeIcons.bridge;
  if (value == 'bridgeCircleCheck') return FontAwesomeIcons.bridgeCircleCheck;
  if (value == 'bridgeCircleExclamation') return FontAwesomeIcons.bridgeCircleExclamation;
  if (value == 'bridgeCircleXmark') return FontAwesomeIcons.bridgeCircleXmark;
  if (value == 'bridgeLock') return FontAwesomeIcons.bridgeLock;
  if (value == 'bridgeWater') return FontAwesomeIcons.bridgeWater;
  if (value == 'briefcase') return FontAwesomeIcons.briefcase;
  if (value == 'briefcaseMedical') return FontAwesomeIcons.briefcaseMedical;
  if (value == 'broom') return FontAwesomeIcons.broom;
  if (value == 'broomBall') return FontAwesomeIcons.broomBall;
  if (value == 'quidditch') return FontAwesomeIcons.quidditch;
  if (value == 'quidditchBroomBall') return FontAwesomeIcons.quidditchBroomBall;
  if (value == 'brush') return FontAwesomeIcons.brush;
  if (value == 'btc') return FontAwesomeIcons.btc;
  if (value == 'bucket') return FontAwesomeIcons.bucket;
  if (value == 'buffer') return FontAwesomeIcons.buffer;
  if (value == 'bug') return FontAwesomeIcons.bug;
  if (value == 'bugSlash') return FontAwesomeIcons.bugSlash;
  if (value == 'bugs') return FontAwesomeIcons.bugs;
  if (value == 'solidBuilding') return FontAwesomeIcons.solidBuilding;
  if (value == 'building') return FontAwesomeIcons.building;
  if (value == 'buildingCircleArrowRight') return FontAwesomeIcons.buildingCircleArrowRight;
  if (value == 'buildingCircleCheck') return FontAwesomeIcons.buildingCircleCheck;
  if (value == 'buildingCircleExclamation') return FontAwesomeIcons.buildingCircleExclamation;
  if (value == 'buildingCircleXmark') return FontAwesomeIcons.buildingCircleXmark;
  if (value == 'buildingColumns') return FontAwesomeIcons.buildingColumns;
  if (value == 'bank') return FontAwesomeIcons.bank;
  if (value == 'institution') return FontAwesomeIcons.institution;
  if (value == 'museum') return FontAwesomeIcons.museum;
  if (value == 'university') return FontAwesomeIcons.university;
  if (value == 'buildingFlag') return FontAwesomeIcons.buildingFlag;
  if (value == 'buildingLock') return FontAwesomeIcons.buildingLock;
  if (value == 'buildingNgo') return FontAwesomeIcons.buildingNgo;
  if (value == 'buildingShield') return FontAwesomeIcons.buildingShield;
  if (value == 'buildingUn') return FontAwesomeIcons.buildingUn;
  if (value == 'buildingUser') return FontAwesomeIcons.buildingUser;
  if (value == 'buildingWheat') return FontAwesomeIcons.buildingWheat;
  if (value == 'bullhorn') return FontAwesomeIcons.bullhorn;
  if (value == 'bullseye') return FontAwesomeIcons.bullseye;
  if (value == 'burger') return FontAwesomeIcons.burger;
  if (value == 'hamburger') return FontAwesomeIcons.hamburger;
  if (value == 'buromobelexperte') return FontAwesomeIcons.buromobelexperte;
  if (value == 'burst') return FontAwesomeIcons.burst;
  if (value == 'bus') return FontAwesomeIcons.bus;
  if (value == 'busSimple') return FontAwesomeIcons.busSimple;
  if (value == 'busAlt') return FontAwesomeIcons.busAlt;
  if (value == 'businessTime') return FontAwesomeIcons.businessTime;
  if (value == 'briefcaseClock') return FontAwesomeIcons.briefcaseClock;
  if (value == 'buyNLarge') return FontAwesomeIcons.buyNLarge;
  if (value == 'buysellads') return FontAwesomeIcons.buysellads;
  if (value == 'c') return FontAwesomeIcons.c;
  if (value == 'cableCar') return FontAwesomeIcons.cableCar;
  if (value == 'tram') return FontAwesomeIcons.tram;
  if (value == 'cakeCandles') return FontAwesomeIcons.cakeCandles;
  if (value == 'birthdayCake') return FontAwesomeIcons.birthdayCake;
  if (value == 'cake') return FontAwesomeIcons.cake;
  if (value == 'calculator') return FontAwesomeIcons.calculator;
  if (value == 'solidCalendar') return FontAwesomeIcons.solidCalendar;
  if (value == 'calendar') return FontAwesomeIcons.calendar;
  if (value == 'solidCalendarCheck') return FontAwesomeIcons.solidCalendarCheck;
  if (value == 'calendarCheck') return FontAwesomeIcons.calendarCheck;
  if (value == 'calendarDay') return FontAwesomeIcons.calendarDay;
  if (value == 'solidCalendarDays') return FontAwesomeIcons.solidCalendarDays;
  if (value == 'solidCalendarAlt') return FontAwesomeIcons.solidCalendarAlt;
  if (value == 'calendarDays') return FontAwesomeIcons.calendarDays;
  if (value == 'calendarAlt') return FontAwesomeIcons.calendarAlt;
  if (value == 'solidCalendarMinus') return FontAwesomeIcons.solidCalendarMinus;
  if (value == 'calendarMinus') return FontAwesomeIcons.calendarMinus;
  if (value == 'solidCalendarPlus') return FontAwesomeIcons.solidCalendarPlus;
  if (value == 'calendarPlus') return FontAwesomeIcons.calendarPlus;
  if (value == 'calendarWeek') return FontAwesomeIcons.calendarWeek;
  if (value == 'solidCalendarXmark') return FontAwesomeIcons.solidCalendarXmark;
  if (value == 'solidCalendarTimes') return FontAwesomeIcons.solidCalendarTimes;
  if (value == 'calendarXmark') return FontAwesomeIcons.calendarXmark;
  if (value == 'calendarTimes') return FontAwesomeIcons.calendarTimes;
  if (value == 'camera') return FontAwesomeIcons.camera;
  if (value == 'cameraAlt') return FontAwesomeIcons.cameraAlt;
  if (value == 'cameraRetro') return FontAwesomeIcons.cameraRetro;
  if (value == 'cameraRotate') return FontAwesomeIcons.cameraRotate;
  if (value == 'campground') return FontAwesomeIcons.campground;
  if (value == 'canadianMapleLeaf') return FontAwesomeIcons.canadianMapleLeaf;
  if (value == 'candyCane') return FontAwesomeIcons.candyCane;
  if (value == 'cannabis') return FontAwesomeIcons.cannabis;
  if (value == 'capsules') return FontAwesomeIcons.capsules;
  if (value == 'car') return FontAwesomeIcons.car;
  if (value == 'automobile') return FontAwesomeIcons.automobile;
  if (value == 'carBattery') return FontAwesomeIcons.carBattery;
  if (value == 'batteryCar') return FontAwesomeIcons.batteryCar;
  if (value == 'carBurst') return FontAwesomeIcons.carBurst;
  if (value == 'carCrash') return FontAwesomeIcons.carCrash;
  if (value == 'carOn') return FontAwesomeIcons.carOn;
  if (value == 'carRear') return FontAwesomeIcons.carRear;
  if (value == 'carAlt') return FontAwesomeIcons.carAlt;
  if (value == 'carSide') return FontAwesomeIcons.carSide;
  if (value == 'carTunnel') return FontAwesomeIcons.carTunnel;
  if (value == 'caravan') return FontAwesomeIcons.caravan;
  if (value == 'caretDown') return FontAwesomeIcons.caretDown;
  if (value == 'caretLeft') return FontAwesomeIcons.caretLeft;
  if (value == 'caretRight') return FontAwesomeIcons.caretRight;
  if (value == 'caretUp') return FontAwesomeIcons.caretUp;
  if (value == 'carrot') return FontAwesomeIcons.carrot;
  if (value == 'cartArrowDown') return FontAwesomeIcons.cartArrowDown;
  if (value == 'cartFlatbed') return FontAwesomeIcons.cartFlatbed;
  if (value == 'dollyFlatbed') return FontAwesomeIcons.dollyFlatbed;
  if (value == 'cartFlatbedSuitcase') return FontAwesomeIcons.cartFlatbedSuitcase;
  if (value == 'luggageCart') return FontAwesomeIcons.luggageCart;
  if (value == 'cartPlus') return FontAwesomeIcons.cartPlus;
  if (value == 'cartShopping') return FontAwesomeIcons.cartShopping;
  if (value == 'shoppingCart') return FontAwesomeIcons.shoppingCart;
  if (value == 'cashRegister') return FontAwesomeIcons.cashRegister;
  if (value == 'cat') return FontAwesomeIcons.cat;
  if (value == 'ccAmazonPay') return FontAwesomeIcons.ccAmazonPay;
  if (value == 'ccAmex') return FontAwesomeIcons.ccAmex;
  if (value == 'ccApplePay') return FontAwesomeIcons.ccApplePay;
  if (value == 'ccDinersClub') return FontAwesomeIcons.ccDinersClub;
  if (value == 'ccDiscover') return FontAwesomeIcons.ccDiscover;
  if (value == 'ccJcb') return FontAwesomeIcons.ccJcb;
  if (value == 'ccMastercard') return FontAwesomeIcons.ccMastercard;
  if (value == 'ccPaypal') return FontAwesomeIcons.ccPaypal;
  if (value == 'ccStripe') return FontAwesomeIcons.ccStripe;
  if (value == 'ccVisa') return FontAwesomeIcons.ccVisa;
  if (value == 'cediSign') return FontAwesomeIcons.cediSign;
  if (value == 'centSign') return FontAwesomeIcons.centSign;
  if (value == 'centercode') return FontAwesomeIcons.centercode;
  if (value == 'centos') return FontAwesomeIcons.centos;
  if (value == 'certificate') return FontAwesomeIcons.certificate;
  if (value == 'chair') return FontAwesomeIcons.chair;
  if (value == 'chalkboard') return FontAwesomeIcons.chalkboard;
  if (value == 'blackboard') return FontAwesomeIcons.blackboard;
  if (value == 'chalkboardUser') return FontAwesomeIcons.chalkboardUser;
  if (value == 'chalkboardTeacher') return FontAwesomeIcons.chalkboardTeacher;
  if (value == 'champagneGlasses') return FontAwesomeIcons.champagneGlasses;
  if (value == 'glassCheers') return FontAwesomeIcons.glassCheers;
  if (value == 'chargingStation') return FontAwesomeIcons.chargingStation;
  if (value == 'chartArea') return FontAwesomeIcons.chartArea;
  if (value == 'areaChart') return FontAwesomeIcons.areaChart;
  if (value == 'solidChartBar') return FontAwesomeIcons.solidChartBar;
  if (value == 'solidBarChart') return FontAwesomeIcons.solidBarChart;
  if (value == 'chartBar') return FontAwesomeIcons.chartBar;
  if (value == 'barChart') return FontAwesomeIcons.barChart;
  if (value == 'chartColumn') return FontAwesomeIcons.chartColumn;
  if (value == 'chartGantt') return FontAwesomeIcons.chartGantt;
  if (value == 'chartLine') return FontAwesomeIcons.chartLine;
  if (value == 'lineChart') return FontAwesomeIcons.lineChart;
  if (value == 'chartPie') return FontAwesomeIcons.chartPie;
  if (value == 'pieChart') return FontAwesomeIcons.pieChart;
  if (value == 'chartSimple') return FontAwesomeIcons.chartSimple;
  if (value == 'check') return FontAwesomeIcons.check;
  if (value == 'checkDouble') return FontAwesomeIcons.checkDouble;
  if (value == 'checkToSlot') return FontAwesomeIcons.checkToSlot;
  if (value == 'voteYea') return FontAwesomeIcons.voteYea;
  if (value == 'cheese') return FontAwesomeIcons.cheese;
  if (value == 'chess') return FontAwesomeIcons.chess;
  if (value == 'solidChessBishop') return FontAwesomeIcons.solidChessBishop;
  if (value == 'chessBishop') return FontAwesomeIcons.chessBishop;
  if (value == 'chessBoard') return FontAwesomeIcons.chessBoard;
  if (value == 'solidChessKing') return FontAwesomeIcons.solidChessKing;
  if (value == 'chessKing') return FontAwesomeIcons.chessKing;
  if (value == 'solidChessKnight') return FontAwesomeIcons.solidChessKnight;
  if (value == 'chessKnight') return FontAwesomeIcons.chessKnight;
  if (value == 'solidChessPawn') return FontAwesomeIcons.solidChessPawn;
  if (value == 'chessPawn') return FontAwesomeIcons.chessPawn;
  if (value == 'solidChessQueen') return FontAwesomeIcons.solidChessQueen;
  if (value == 'chessQueen') return FontAwesomeIcons.chessQueen;
  if (value == 'solidChessRook') return FontAwesomeIcons.solidChessRook;
  if (value == 'chessRook') return FontAwesomeIcons.chessRook;
  if (value == 'chevronDown') return FontAwesomeIcons.chevronDown;
  if (value == 'chevronLeft') return FontAwesomeIcons.chevronLeft;
  if (value == 'chevronRight') return FontAwesomeIcons.chevronRight;
  if (value == 'chevronUp') return FontAwesomeIcons.chevronUp;
  if (value == 'child') return FontAwesomeIcons.child;
  if (value == 'childCombatant') return FontAwesomeIcons.childCombatant;
  if (value == 'childRifle') return FontAwesomeIcons.childRifle;
  if (value == 'childDress') return FontAwesomeIcons.childDress;
  if (value == 'childReaching') return FontAwesomeIcons.childReaching;
  if (value == 'children') return FontAwesomeIcons.children;
  if (value == 'chrome') return FontAwesomeIcons.chrome;
  if (value == 'chromecast') return FontAwesomeIcons.chromecast;
  if (value == 'church') return FontAwesomeIcons.church;
  if (value == 'solidCircle') return FontAwesomeIcons.solidCircle;
  if (value == 'circle') return FontAwesomeIcons.circle;
  if (value == 'circleArrowDown') return FontAwesomeIcons.circleArrowDown;
  if (value == 'arrowCircleDown') return FontAwesomeIcons.arrowCircleDown;
  if (value == 'circleArrowLeft') return FontAwesomeIcons.circleArrowLeft;
  if (value == 'arrowCircleLeft') return FontAwesomeIcons.arrowCircleLeft;
  if (value == 'circleArrowRight') return FontAwesomeIcons.circleArrowRight;
  if (value == 'arrowCircleRight') return FontAwesomeIcons.arrowCircleRight;
  if (value == 'circleArrowUp') return FontAwesomeIcons.circleArrowUp;
  if (value == 'arrowCircleUp') return FontAwesomeIcons.arrowCircleUp;
  if (value == 'solidCircleCheck') return FontAwesomeIcons.solidCircleCheck;
  if (value == 'solidCheckCircle') return FontAwesomeIcons.solidCheckCircle;
  if (value == 'circleCheck') return FontAwesomeIcons.circleCheck;
  if (value == 'checkCircle') return FontAwesomeIcons.checkCircle;
  if (value == 'circleChevronDown') return FontAwesomeIcons.circleChevronDown;
  if (value == 'chevronCircleDown') return FontAwesomeIcons.chevronCircleDown;
  if (value == 'circleChevronLeft') return FontAwesomeIcons.circleChevronLeft;
  if (value == 'chevronCircleLeft') return FontAwesomeIcons.chevronCircleLeft;
  if (value == 'circleChevronRight') return FontAwesomeIcons.circleChevronRight;
  if (value == 'chevronCircleRight') return FontAwesomeIcons.chevronCircleRight;
  if (value == 'circleChevronUp') return FontAwesomeIcons.circleChevronUp;
  if (value == 'chevronCircleUp') return FontAwesomeIcons.chevronCircleUp;
  if (value == 'circleDollarToSlot') return FontAwesomeIcons.circleDollarToSlot;
  if (value == 'donate') return FontAwesomeIcons.donate;
  if (value == 'solidCircleDot') return FontAwesomeIcons.solidCircleDot;
  if (value == 'solidDotCircle') return FontAwesomeIcons.solidDotCircle;
  if (value == 'circleDot') return FontAwesomeIcons.circleDot;
  if (value == 'dotCircle') return FontAwesomeIcons.dotCircle;
  if (value == 'solidCircleDown') return FontAwesomeIcons.solidCircleDown;
  if (value == 'solidArrowAltCircleDown') return FontAwesomeIcons.solidArrowAltCircleDown;
  if (value == 'circleDown') return FontAwesomeIcons.circleDown;
  if (value == 'arrowAltCircleDown') return FontAwesomeIcons.arrowAltCircleDown;
  if (value == 'circleExclamation') return FontAwesomeIcons.circleExclamation;
  if (value == 'exclamationCircle') return FontAwesomeIcons.exclamationCircle;
  if (value == 'circleH') return FontAwesomeIcons.circleH;
  if (value == 'hospitalSymbol') return FontAwesomeIcons.hospitalSymbol;
  if (value == 'circleHalfStroke') return FontAwesomeIcons.circleHalfStroke;
  if (value == 'adjust') return FontAwesomeIcons.adjust;
  if (value == 'circleInfo') return FontAwesomeIcons.circleInfo;
  if (value == 'infoCircle') return FontAwesomeIcons.infoCircle;
  if (value == 'solidCircleLeft') return FontAwesomeIcons.solidCircleLeft;
  if (value == 'solidArrowAltCircleLeft') return FontAwesomeIcons.solidArrowAltCircleLeft;
  if (value == 'circleLeft') return FontAwesomeIcons.circleLeft;
  if (value == 'arrowAltCircleLeft') return FontAwesomeIcons.arrowAltCircleLeft;
  if (value == 'circleMinus') return FontAwesomeIcons.circleMinus;
  if (value == 'minusCircle') return FontAwesomeIcons.minusCircle;
  if (value == 'circleNodes') return FontAwesomeIcons.circleNodes;
  if (value == 'circleNotch') return FontAwesomeIcons.circleNotch;
  if (value == 'solidCirclePause') return FontAwesomeIcons.solidCirclePause;
  if (value == 'solidPauseCircle') return FontAwesomeIcons.solidPauseCircle;
  if (value == 'circlePause') return FontAwesomeIcons.circlePause;
  if (value == 'pauseCircle') return FontAwesomeIcons.pauseCircle;
  if (value == 'solidCirclePlay') return FontAwesomeIcons.solidCirclePlay;
  if (value == 'solidPlayCircle') return FontAwesomeIcons.solidPlayCircle;
  if (value == 'circlePlay') return FontAwesomeIcons.circlePlay;
  if (value == 'playCircle') return FontAwesomeIcons.playCircle;
  if (value == 'circlePlus') return FontAwesomeIcons.circlePlus;
  if (value == 'plusCircle') return FontAwesomeIcons.plusCircle;
  if (value == 'solidCircleQuestion') return FontAwesomeIcons.solidCircleQuestion;
  if (value == 'solidQuestionCircle') return FontAwesomeIcons.solidQuestionCircle;
  if (value == 'circleQuestion') return FontAwesomeIcons.circleQuestion;
  if (value == 'questionCircle') return FontAwesomeIcons.questionCircle;
  if (value == 'circleRadiation') return FontAwesomeIcons.circleRadiation;
  if (value == 'radiationAlt') return FontAwesomeIcons.radiationAlt;
  if (value == 'solidCircleRight') return FontAwesomeIcons.solidCircleRight;
  if (value == 'solidArrowAltCircleRight') return FontAwesomeIcons.solidArrowAltCircleRight;
  if (value == 'circleRight') return FontAwesomeIcons.circleRight;
  if (value == 'arrowAltCircleRight') return FontAwesomeIcons.arrowAltCircleRight;
  if (value == 'solidCircleStop') return FontAwesomeIcons.solidCircleStop;
  if (value == 'solidStopCircle') return FontAwesomeIcons.solidStopCircle;
  if (value == 'circleStop') return FontAwesomeIcons.circleStop;
  if (value == 'stopCircle') return FontAwesomeIcons.stopCircle;
  if (value == 'solidCircleUp') return FontAwesomeIcons.solidCircleUp;
  if (value == 'solidArrowAltCircleUp') return FontAwesomeIcons.solidArrowAltCircleUp;
  if (value == 'circleUp') return FontAwesomeIcons.circleUp;
  if (value == 'arrowAltCircleUp') return FontAwesomeIcons.arrowAltCircleUp;
  if (value == 'solidCircleUser') return FontAwesomeIcons.solidCircleUser;
  if (value == 'solidUserCircle') return FontAwesomeIcons.solidUserCircle;
  if (value == 'circleUser') return FontAwesomeIcons.circleUser;
  if (value == 'userCircle') return FontAwesomeIcons.userCircle;
  if (value == 'solidCircleXmark') return FontAwesomeIcons.solidCircleXmark;
  if (value == 'solidTimesCircle') return FontAwesomeIcons.solidTimesCircle;
  if (value == 'solidXmarkCircle') return FontAwesomeIcons.solidXmarkCircle;
  if (value == 'circleXmark') return FontAwesomeIcons.circleXmark;
  if (value == 'timesCircle') return FontAwesomeIcons.timesCircle;
  if (value == 'xmarkCircle') return FontAwesomeIcons.xmarkCircle;
  if (value == 'city') return FontAwesomeIcons.city;
  if (value == 'clapperboard') return FontAwesomeIcons.clapperboard;
  if (value == 'solidClipboard') return FontAwesomeIcons.solidClipboard;
  if (value == 'clipboard') return FontAwesomeIcons.clipboard;
  if (value == 'clipboardCheck') return FontAwesomeIcons.clipboardCheck;
  if (value == 'clipboardList') return FontAwesomeIcons.clipboardList;
  if (value == 'clipboardQuestion') return FontAwesomeIcons.clipboardQuestion;
  if (value == 'clipboardUser') return FontAwesomeIcons.clipboardUser;
  if (value == 'solidClock') return FontAwesomeIcons.solidClock;
  if (value == 'solidClockFour') return FontAwesomeIcons.solidClockFour;
  if (value == 'clock') return FontAwesomeIcons.clock;
  if (value == 'clockFour') return FontAwesomeIcons.clockFour;
  if (value == 'clockRotateLeft') return FontAwesomeIcons.clockRotateLeft;
  if (value == 'history') return FontAwesomeIcons.history;
  if (value == 'solidClone') return FontAwesomeIcons.solidClone;
  if (value == 'clone') return FontAwesomeIcons.clone;
  if (value == 'solidClosedCaptioning') return FontAwesomeIcons.solidClosedCaptioning;
  if (value == 'closedCaptioning') return FontAwesomeIcons.closedCaptioning;
  if (value == 'cloud') return FontAwesomeIcons.cloud;
  if (value == 'cloudArrowDown') return FontAwesomeIcons.cloudArrowDown;
  if (value == 'cloudDownload') return FontAwesomeIcons.cloudDownload;
  if (value == 'cloudDownloadAlt') return FontAwesomeIcons.cloudDownloadAlt;
  if (value == 'cloudArrowUp') return FontAwesomeIcons.cloudArrowUp;
  if (value == 'cloudUpload') return FontAwesomeIcons.cloudUpload;
  if (value == 'cloudUploadAlt') return FontAwesomeIcons.cloudUploadAlt;
  if (value == 'cloudBolt') return FontAwesomeIcons.cloudBolt;
  if (value == 'thunderstorm') return FontAwesomeIcons.thunderstorm;
  if (value == 'cloudMeatball') return FontAwesomeIcons.cloudMeatball;
  if (value == 'cloudMoon') return FontAwesomeIcons.cloudMoon;
  if (value == 'cloudMoonRain') return FontAwesomeIcons.cloudMoonRain;
  if (value == 'cloudRain') return FontAwesomeIcons.cloudRain;
  if (value == 'cloudShowersHeavy') return FontAwesomeIcons.cloudShowersHeavy;
  if (value == 'cloudShowersWater') return FontAwesomeIcons.cloudShowersWater;
  if (value == 'cloudSun') return FontAwesomeIcons.cloudSun;
  if (value == 'cloudSunRain') return FontAwesomeIcons.cloudSunRain;
  if (value == 'cloudflare') return FontAwesomeIcons.cloudflare;
  if (value == 'cloudscale') return FontAwesomeIcons.cloudscale;
  if (value == 'cloudsmith') return FontAwesomeIcons.cloudsmith;
  if (value == 'cloudversify') return FontAwesomeIcons.cloudversify;
  if (value == 'clover') return FontAwesomeIcons.clover;
  if (value == 'cmplid') return FontAwesomeIcons.cmplid;
  if (value == 'code') return FontAwesomeIcons.code;
  if (value == 'codeBranch') return FontAwesomeIcons.codeBranch;
  if (value == 'codeCommit') return FontAwesomeIcons.codeCommit;
  if (value == 'codeCompare') return FontAwesomeIcons.codeCompare;
  if (value == 'codeFork') return FontAwesomeIcons.codeFork;
  if (value == 'codeMerge') return FontAwesomeIcons.codeMerge;
  if (value == 'codePullRequest') return FontAwesomeIcons.codePullRequest;
  if (value == 'codepen') return FontAwesomeIcons.codepen;
  if (value == 'codiepie') return FontAwesomeIcons.codiepie;
  if (value == 'coins') return FontAwesomeIcons.coins;
  if (value == 'colonSign') return FontAwesomeIcons.colonSign;
  if (value == 'solidComment') return FontAwesomeIcons.solidComment;
  if (value == 'comment') return FontAwesomeIcons.comment;
  if (value == 'commentDollar') return FontAwesomeIcons.commentDollar;
  if (value == 'solidCommentDots') return FontAwesomeIcons.solidCommentDots;
  if (value == 'solidCommenting') return FontAwesomeIcons.solidCommenting;
  if (value == 'commentDots') return FontAwesomeIcons.commentDots;
  if (value == 'commenting') return FontAwesomeIcons.commenting;
  if (value == 'commentMedical') return FontAwesomeIcons.commentMedical;
  if (value == 'commentSlash') return FontAwesomeIcons.commentSlash;
  if (value == 'commentSms') return FontAwesomeIcons.commentSms;
  if (value == 'sms') return FontAwesomeIcons.sms;
  if (value == 'solidComments') return FontAwesomeIcons.solidComments;
  if (value == 'comments') return FontAwesomeIcons.comments;
  if (value == 'commentsDollar') return FontAwesomeIcons.commentsDollar;
  if (value == 'compactDisc') return FontAwesomeIcons.compactDisc;
  if (value == 'solidCompass') return FontAwesomeIcons.solidCompass;
  if (value == 'compass') return FontAwesomeIcons.compass;
  if (value == 'compassDrafting') return FontAwesomeIcons.compassDrafting;
  if (value == 'draftingCompass') return FontAwesomeIcons.draftingCompass;
  if (value == 'compress') return FontAwesomeIcons.compress;
  if (value == 'computer') return FontAwesomeIcons.computer;
  if (value == 'computerMouse') return FontAwesomeIcons.computerMouse;
  if (value == 'mouse') return FontAwesomeIcons.mouse;
  if (value == 'confluence') return FontAwesomeIcons.confluence;
  if (value == 'connectdevelop') return FontAwesomeIcons.connectdevelop;
  if (value == 'contao') return FontAwesomeIcons.contao;
  if (value == 'cookie') return FontAwesomeIcons.cookie;
  if (value == 'cookieBite') return FontAwesomeIcons.cookieBite;
  if (value == 'solidCopy') return FontAwesomeIcons.solidCopy;
  if (value == 'copy') return FontAwesomeIcons.copy;
  if (value == 'solidCopyright') return FontAwesomeIcons.solidCopyright;
  if (value == 'copyright') return FontAwesomeIcons.copyright;
  if (value == 'cottonBureau') return FontAwesomeIcons.cottonBureau;
  if (value == 'couch') return FontAwesomeIcons.couch;
  if (value == 'cow') return FontAwesomeIcons.cow;
  if (value == 'cpanel') return FontAwesomeIcons.cpanel;
  if (value == 'creativeCommons') return FontAwesomeIcons.creativeCommons;
  if (value == 'creativeCommonsBy') return FontAwesomeIcons.creativeCommonsBy;
  if (value == 'creativeCommonsNc') return FontAwesomeIcons.creativeCommonsNc;
  if (value == 'creativeCommonsNcEu') return FontAwesomeIcons.creativeCommonsNcEu;
  if (value == 'creativeCommonsNcJp') return FontAwesomeIcons.creativeCommonsNcJp;
  if (value == 'creativeCommonsNd') return FontAwesomeIcons.creativeCommonsNd;
  if (value == 'creativeCommonsPd') return FontAwesomeIcons.creativeCommonsPd;
  if (value == 'creativeCommonsPdAlt') return FontAwesomeIcons.creativeCommonsPdAlt;
  if (value == 'creativeCommonsRemix') return FontAwesomeIcons.creativeCommonsRemix;
  if (value == 'creativeCommonsSa') return FontAwesomeIcons.creativeCommonsSa;
  if (value == 'creativeCommonsSampling') return FontAwesomeIcons.creativeCommonsSampling;
  if (value == 'creativeCommonsSamplingPlus') return FontAwesomeIcons.creativeCommonsSamplingPlus;
  if (value == 'creativeCommonsShare') return FontAwesomeIcons.creativeCommonsShare;
  if (value == 'creativeCommonsZero') return FontAwesomeIcons.creativeCommonsZero;
  if (value == 'solidCreditCard') return FontAwesomeIcons.solidCreditCard;
  if (value == 'solidCreditCardAlt') return FontAwesomeIcons.solidCreditCardAlt;
  if (value == 'creditCard') return FontAwesomeIcons.creditCard;
  if (value == 'creditCardAlt') return FontAwesomeIcons.creditCardAlt;
  if (value == 'criticalRole') return FontAwesomeIcons.criticalRole;
  if (value == 'crop') return FontAwesomeIcons.crop;
  if (value == 'cropSimple') return FontAwesomeIcons.cropSimple;
  if (value == 'cropAlt') return FontAwesomeIcons.cropAlt;
  if (value == 'cross') return FontAwesomeIcons.cross;
  if (value == 'crosshairs') return FontAwesomeIcons.crosshairs;
  if (value == 'crow') return FontAwesomeIcons.crow;
  if (value == 'crown') return FontAwesomeIcons.crown;
  if (value == 'crutch') return FontAwesomeIcons.crutch;
  if (value == 'cruzeiroSign') return FontAwesomeIcons.cruzeiroSign;
  if (value == 'css3') return FontAwesomeIcons.css3;
  if (value == 'css3Alt') return FontAwesomeIcons.css3Alt;
  if (value == 'cube') return FontAwesomeIcons.cube;
  if (value == 'cubes') return FontAwesomeIcons.cubes;
  if (value == 'cubesStacked') return FontAwesomeIcons.cubesStacked;
  if (value == 'cuttlefish') return FontAwesomeIcons.cuttlefish;
  if (value == 'd') return FontAwesomeIcons.d;
  if (value == 'dAndD') return FontAwesomeIcons.dAndD;
  if (value == 'dAndDBeyond') return FontAwesomeIcons.dAndDBeyond;
  if (value == 'dailymotion') return FontAwesomeIcons.dailymotion;
  if (value == 'dashcube') return FontAwesomeIcons.dashcube;
  if (value == 'database') return FontAwesomeIcons.database;
  if (value == 'debian') return FontAwesomeIcons.debian;
  if (value == 'deezer') return FontAwesomeIcons.deezer;
  if (value == 'deleteLeft') return FontAwesomeIcons.deleteLeft;
  if (value == 'backspace') return FontAwesomeIcons.backspace;
  if (value == 'delicious') return FontAwesomeIcons.delicious;
  if (value == 'democrat') return FontAwesomeIcons.democrat;
  if (value == 'deploydog') return FontAwesomeIcons.deploydog;
  if (value == 'deskpro') return FontAwesomeIcons.deskpro;
  if (value == 'desktop') return FontAwesomeIcons.desktop;
  if (value == 'desktopAlt') return FontAwesomeIcons.desktopAlt;
  if (value == 'dev') return FontAwesomeIcons.dev;
  if (value == 'deviantart') return FontAwesomeIcons.deviantart;
  if (value == 'dharmachakra') return FontAwesomeIcons.dharmachakra;
  if (value == 'dhl') return FontAwesomeIcons.dhl;
  if (value == 'diagramNext') return FontAwesomeIcons.diagramNext;
  if (value == 'diagramPredecessor') return FontAwesomeIcons.diagramPredecessor;
  if (value == 'diagramProject') return FontAwesomeIcons.diagramProject;
  if (value == 'projectDiagram') return FontAwesomeIcons.projectDiagram;
  if (value == 'diagramSuccessor') return FontAwesomeIcons.diagramSuccessor;
  if (value == 'diamond') return FontAwesomeIcons.diamond;
  if (value == 'diamondTurnRight') return FontAwesomeIcons.diamondTurnRight;
  if (value == 'directions') return FontAwesomeIcons.directions;
  if (value == 'diaspora') return FontAwesomeIcons.diaspora;
  if (value == 'dice') return FontAwesomeIcons.dice;
  if (value == 'diceD20') return FontAwesomeIcons.diceD20;
  if (value == 'diceD6') return FontAwesomeIcons.diceD6;
  if (value == 'diceFive') return FontAwesomeIcons.diceFive;
  if (value == 'diceFour') return FontAwesomeIcons.diceFour;
  if (value == 'diceOne') return FontAwesomeIcons.diceOne;
  if (value == 'diceSix') return FontAwesomeIcons.diceSix;
  if (value == 'diceThree') return FontAwesomeIcons.diceThree;
  if (value == 'diceTwo') return FontAwesomeIcons.diceTwo;
  if (value == 'digg') return FontAwesomeIcons.digg;
  if (value == 'digitalOcean') return FontAwesomeIcons.digitalOcean;
  if (value == 'discord') return FontAwesomeIcons.discord;
  if (value == 'discourse') return FontAwesomeIcons.discourse;
  if (value == 'disease') return FontAwesomeIcons.disease;
  if (value == 'display') return FontAwesomeIcons.display;
  if (value == 'divide') return FontAwesomeIcons.divide;
  if (value == 'dna') return FontAwesomeIcons.dna;
  if (value == 'dochub') return FontAwesomeIcons.dochub;
  if (value == 'docker') return FontAwesomeIcons.docker;
  if (value == 'dog') return FontAwesomeIcons.dog;
  if (value == 'dollarSign') return FontAwesomeIcons.dollarSign;
  if (value == 'dollar') return FontAwesomeIcons.dollar;
  if (value == 'usd') return FontAwesomeIcons.usd;
  if (value == 'dolly') return FontAwesomeIcons.dolly;
  if (value == 'dollyBox') return FontAwesomeIcons.dollyBox;
  if (value == 'dongSign') return FontAwesomeIcons.dongSign;
  if (value == 'doorClosed') return FontAwesomeIcons.doorClosed;
  if (value == 'doorOpen') return FontAwesomeIcons.doorOpen;
  if (value == 'dove') return FontAwesomeIcons.dove;
  if (value == 'downLeftAndUpRightToCenter') return FontAwesomeIcons.downLeftAndUpRightToCenter;
  if (value == 'compressAlt') return FontAwesomeIcons.compressAlt;
  if (value == 'downLong') return FontAwesomeIcons.downLong;
  if (value == 'longArrowAltDown') return FontAwesomeIcons.longArrowAltDown;
  if (value == 'download') return FontAwesomeIcons.download;
  if (value == 'draft2digital') return FontAwesomeIcons.draft2digital;
  if (value == 'dragon') return FontAwesomeIcons.dragon;
  if (value == 'drawPolygon') return FontAwesomeIcons.drawPolygon;
  if (value == 'dribbble') return FontAwesomeIcons.dribbble;
  if (value == 'dropbox') return FontAwesomeIcons.dropbox;
  if (value == 'droplet') return FontAwesomeIcons.droplet;
  if (value == 'tint') return FontAwesomeIcons.tint;
  if (value == 'dropletSlash') return FontAwesomeIcons.dropletSlash;
  if (value == 'tintSlash') return FontAwesomeIcons.tintSlash;
  if (value == 'drum') return FontAwesomeIcons.drum;
  if (value == 'drumSteelpan') return FontAwesomeIcons.drumSteelpan;
  if (value == 'drumstickBite') return FontAwesomeIcons.drumstickBite;
  if (value == 'drupal') return FontAwesomeIcons.drupal;
  if (value == 'dumbbell') return FontAwesomeIcons.dumbbell;
  if (value == 'dumpster') return FontAwesomeIcons.dumpster;
  if (value == 'dumpsterFire') return FontAwesomeIcons.dumpsterFire;
  if (value == 'dungeon') return FontAwesomeIcons.dungeon;
  if (value == 'dyalog') return FontAwesomeIcons.dyalog;
  if (value == 'e') return FontAwesomeIcons.e;
  if (value == 'earDeaf') return FontAwesomeIcons.earDeaf;
  if (value == 'deaf') return FontAwesomeIcons.deaf;
  if (value == 'deafness') return FontAwesomeIcons.deafness;
  if (value == 'hardOfHearing') return FontAwesomeIcons.hardOfHearing;
  if (value == 'earListen') return FontAwesomeIcons.earListen;
  if (value == 'assistiveListeningSystems') return FontAwesomeIcons.assistiveListeningSystems;
  if (value == 'earlybirds') return FontAwesomeIcons.earlybirds;
  if (value == 'earthAfrica') return FontAwesomeIcons.earthAfrica;
  if (value == 'globeAfrica') return FontAwesomeIcons.globeAfrica;
  if (value == 'earthAmericas') return FontAwesomeIcons.earthAmericas;
  if (value == 'earth') return FontAwesomeIcons.earth;
  if (value == 'earthAmerica') return FontAwesomeIcons.earthAmerica;
  if (value == 'globeAmericas') return FontAwesomeIcons.globeAmericas;
  if (value == 'earthAsia') return FontAwesomeIcons.earthAsia;
  if (value == 'globeAsia') return FontAwesomeIcons.globeAsia;
  if (value == 'earthEurope') return FontAwesomeIcons.earthEurope;
  if (value == 'globeEurope') return FontAwesomeIcons.globeEurope;
  if (value == 'earthOceania') return FontAwesomeIcons.earthOceania;
  if (value == 'globeOceania') return FontAwesomeIcons.globeOceania;
  if (value == 'ebay') return FontAwesomeIcons.ebay;
  if (value == 'edge') return FontAwesomeIcons.edge;
  if (value == 'edgeLegacy') return FontAwesomeIcons.edgeLegacy;
  if (value == 'egg') return FontAwesomeIcons.egg;
  if (value == 'eject') return FontAwesomeIcons.eject;
  if (value == 'elementor') return FontAwesomeIcons.elementor;
  if (value == 'elevator') return FontAwesomeIcons.elevator;
  if (value == 'ellipsis') return FontAwesomeIcons.ellipsis;
  if (value == 'ellipsisH') return FontAwesomeIcons.ellipsisH;
  if (value == 'ellipsisVertical') return FontAwesomeIcons.ellipsisVertical;
  if (value == 'ellipsisV') return FontAwesomeIcons.ellipsisV;
  if (value == 'ello') return FontAwesomeIcons.ello;
  if (value == 'ember') return FontAwesomeIcons.ember;
  if (value == 'empire') return FontAwesomeIcons.empire;
  if (value == 'solidEnvelope') return FontAwesomeIcons.solidEnvelope;
  if (value == 'envelope') return FontAwesomeIcons.envelope;
  if (value == 'envelopeCircleCheck') return FontAwesomeIcons.envelopeCircleCheck;
  if (value == 'solidEnvelopeOpen') return FontAwesomeIcons.solidEnvelopeOpen;
  if (value == 'envelopeOpen') return FontAwesomeIcons.envelopeOpen;
  if (value == 'envelopeOpenText') return FontAwesomeIcons.envelopeOpenText;
  if (value == 'envelopesBulk') return FontAwesomeIcons.envelopesBulk;
  if (value == 'mailBulk') return FontAwesomeIcons.mailBulk;
  if (value == 'envira') return FontAwesomeIcons.envira;
  if (value == 'equals') return FontAwesomeIcons.equals;
  if (value == 'eraser') return FontAwesomeIcons.eraser;
  if (value == 'erlang') return FontAwesomeIcons.erlang;
  if (value == 'ethereum') return FontAwesomeIcons.ethereum;
  if (value == 'ethernet') return FontAwesomeIcons.ethernet;
  if (value == 'etsy') return FontAwesomeIcons.etsy;
  if (value == 'euroSign') return FontAwesomeIcons.euroSign;
  if (value == 'eur') return FontAwesomeIcons.eur;
  if (value == 'euro') return FontAwesomeIcons.euro;
  if (value == 'evernote') return FontAwesomeIcons.evernote;
  if (value == 'exclamation') return FontAwesomeIcons.exclamation;
  if (value == 'expand') return FontAwesomeIcons.expand;
  if (value == 'expeditedssl') return FontAwesomeIcons.expeditedssl;
  if (value == 'explosion') return FontAwesomeIcons.explosion;
  if (value == 'solidEye') return FontAwesomeIcons.solidEye;
  if (value == 'eye') return FontAwesomeIcons.eye;
  if (value == 'eyeDropper') return FontAwesomeIcons.eyeDropper;
  if (value == 'eyeDropperEmpty') return FontAwesomeIcons.eyeDropperEmpty;
  if (value == 'eyedropper') return FontAwesomeIcons.eyedropper;
  if (value == 'eyeLowVision') return FontAwesomeIcons.eyeLowVision;
  if (value == 'lowVision') return FontAwesomeIcons.lowVision;
  if (value == 'solidEyeSlash') return FontAwesomeIcons.solidEyeSlash;
  if (value == 'eyeSlash') return FontAwesomeIcons.eyeSlash;
  if (value == 'f') return FontAwesomeIcons.f;
  if (value == 'solidFaceAngry') return FontAwesomeIcons.solidFaceAngry;
  if (value == 'solidAngry') return FontAwesomeIcons.solidAngry;
  if (value == 'faceAngry') return FontAwesomeIcons.faceAngry;
  if (value == 'angry') return FontAwesomeIcons.angry;
  if (value == 'solidFaceDizzy') return FontAwesomeIcons.solidFaceDizzy;
  if (value == 'solidDizzy') return FontAwesomeIcons.solidDizzy;
  if (value == 'faceDizzy') return FontAwesomeIcons.faceDizzy;
  if (value == 'dizzy') return FontAwesomeIcons.dizzy;
  if (value == 'solidFaceFlushed') return FontAwesomeIcons.solidFaceFlushed;
  if (value == 'solidFlushed') return FontAwesomeIcons.solidFlushed;
  if (value == 'faceFlushed') return FontAwesomeIcons.faceFlushed;
  if (value == 'flushed') return FontAwesomeIcons.flushed;
  if (value == 'solidFaceFrown') return FontAwesomeIcons.solidFaceFrown;
  if (value == 'solidFrown') return FontAwesomeIcons.solidFrown;
  if (value == 'faceFrown') return FontAwesomeIcons.faceFrown;
  if (value == 'frown') return FontAwesomeIcons.frown;
  if (value == 'solidFaceFrownOpen') return FontAwesomeIcons.solidFaceFrownOpen;
  if (value == 'solidFrownOpen') return FontAwesomeIcons.solidFrownOpen;
  if (value == 'faceFrownOpen') return FontAwesomeIcons.faceFrownOpen;
  if (value == 'frownOpen') return FontAwesomeIcons.frownOpen;
  if (value == 'solidFaceGrimace') return FontAwesomeIcons.solidFaceGrimace;
  if (value == 'solidGrimace') return FontAwesomeIcons.solidGrimace;
  if (value == 'faceGrimace') return FontAwesomeIcons.faceGrimace;
  if (value == 'grimace') return FontAwesomeIcons.grimace;
  if (value == 'solidFaceGrin') return FontAwesomeIcons.solidFaceGrin;
  if (value == 'solidGrin') return FontAwesomeIcons.solidGrin;
  if (value == 'faceGrin') return FontAwesomeIcons.faceGrin;
  if (value == 'grin') return FontAwesomeIcons.grin;
  if (value == 'solidFaceGrinBeam') return FontAwesomeIcons.solidFaceGrinBeam;
  if (value == 'solidGrinBeam') return FontAwesomeIcons.solidGrinBeam;
  if (value == 'faceGrinBeam') return FontAwesomeIcons.faceGrinBeam;
  if (value == 'grinBeam') return FontAwesomeIcons.grinBeam;
  if (value == 'solidFaceGrinBeamSweat') return FontAwesomeIcons.solidFaceGrinBeamSweat;
  if (value == 'solidGrinBeamSweat') return FontAwesomeIcons.solidGrinBeamSweat;
  if (value == 'faceGrinBeamSweat') return FontAwesomeIcons.faceGrinBeamSweat;
  if (value == 'grinBeamSweat') return FontAwesomeIcons.grinBeamSweat;
  if (value == 'solidFaceGrinHearts') return FontAwesomeIcons.solidFaceGrinHearts;
  if (value == 'solidGrinHearts') return FontAwesomeIcons.solidGrinHearts;
  if (value == 'faceGrinHearts') return FontAwesomeIcons.faceGrinHearts;
  if (value == 'grinHearts') return FontAwesomeIcons.grinHearts;
  if (value == 'solidFaceGrinSquint') return FontAwesomeIcons.solidFaceGrinSquint;
  if (value == 'solidGrinSquint') return FontAwesomeIcons.solidGrinSquint;
  if (value == 'faceGrinSquint') return FontAwesomeIcons.faceGrinSquint;
  if (value == 'grinSquint') return FontAwesomeIcons.grinSquint;
  if (value == 'solidFaceGrinSquintTears') return FontAwesomeIcons.solidFaceGrinSquintTears;
  if (value == 'solidGrinSquintTears') return FontAwesomeIcons.solidGrinSquintTears;
  if (value == 'faceGrinSquintTears') return FontAwesomeIcons.faceGrinSquintTears;
  if (value == 'grinSquintTears') return FontAwesomeIcons.grinSquintTears;
  if (value == 'solidFaceGrinStars') return FontAwesomeIcons.solidFaceGrinStars;
  if (value == 'solidGrinStars') return FontAwesomeIcons.solidGrinStars;
  if (value == 'faceGrinStars') return FontAwesomeIcons.faceGrinStars;
  if (value == 'grinStars') return FontAwesomeIcons.grinStars;
  if (value == 'solidFaceGrinTears') return FontAwesomeIcons.solidFaceGrinTears;
  if (value == 'solidGrinTears') return FontAwesomeIcons.solidGrinTears;
  if (value == 'faceGrinTears') return FontAwesomeIcons.faceGrinTears;
  if (value == 'grinTears') return FontAwesomeIcons.grinTears;
  if (value == 'solidFaceGrinTongue') return FontAwesomeIcons.solidFaceGrinTongue;
  if (value == 'solidGrinTongue') return FontAwesomeIcons.solidGrinTongue;
  if (value == 'faceGrinTongue') return FontAwesomeIcons.faceGrinTongue;
  if (value == 'grinTongue') return FontAwesomeIcons.grinTongue;
  if (value == 'solidFaceGrinTongueSquint') return FontAwesomeIcons.solidFaceGrinTongueSquint;
  if (value == 'solidGrinTongueSquint') return FontAwesomeIcons.solidGrinTongueSquint;
  if (value == 'faceGrinTongueSquint') return FontAwesomeIcons.faceGrinTongueSquint;
  if (value == 'grinTongueSquint') return FontAwesomeIcons.grinTongueSquint;
  if (value == 'solidFaceGrinTongueWink') return FontAwesomeIcons.solidFaceGrinTongueWink;
  if (value == 'solidGrinTongueWink') return FontAwesomeIcons.solidGrinTongueWink;
  if (value == 'faceGrinTongueWink') return FontAwesomeIcons.faceGrinTongueWink;
  if (value == 'grinTongueWink') return FontAwesomeIcons.grinTongueWink;
  if (value == 'solidFaceGrinWide') return FontAwesomeIcons.solidFaceGrinWide;
  if (value == 'solidGrinAlt') return FontAwesomeIcons.solidGrinAlt;
  if (value == 'faceGrinWide') return FontAwesomeIcons.faceGrinWide;
  if (value == 'grinAlt') return FontAwesomeIcons.grinAlt;
  if (value == 'solidFaceGrinWink') return FontAwesomeIcons.solidFaceGrinWink;
  if (value == 'solidGrinWink') return FontAwesomeIcons.solidGrinWink;
  if (value == 'faceGrinWink') return FontAwesomeIcons.faceGrinWink;
  if (value == 'grinWink') return FontAwesomeIcons.grinWink;
  if (value == 'solidFaceKiss') return FontAwesomeIcons.solidFaceKiss;
  if (value == 'solidKiss') return FontAwesomeIcons.solidKiss;
  if (value == 'faceKiss') return FontAwesomeIcons.faceKiss;
  if (value == 'kiss') return FontAwesomeIcons.kiss;
  if (value == 'solidFaceKissBeam') return FontAwesomeIcons.solidFaceKissBeam;
  if (value == 'solidKissBeam') return FontAwesomeIcons.solidKissBeam;
  if (value == 'faceKissBeam') return FontAwesomeIcons.faceKissBeam;
  if (value == 'kissBeam') return FontAwesomeIcons.kissBeam;
  if (value == 'solidFaceKissWinkHeart') return FontAwesomeIcons.solidFaceKissWinkHeart;
  if (value == 'solidKissWinkHeart') return FontAwesomeIcons.solidKissWinkHeart;
  if (value == 'faceKissWinkHeart') return FontAwesomeIcons.faceKissWinkHeart;
  if (value == 'kissWinkHeart') return FontAwesomeIcons.kissWinkHeart;
  if (value == 'solidFaceLaugh') return FontAwesomeIcons.solidFaceLaugh;
  if (value == 'solidLaugh') return FontAwesomeIcons.solidLaugh;
  if (value == 'faceLaugh') return FontAwesomeIcons.faceLaugh;
  if (value == 'laugh') return FontAwesomeIcons.laugh;
  if (value == 'solidFaceLaughBeam') return FontAwesomeIcons.solidFaceLaughBeam;
  if (value == 'solidLaughBeam') return FontAwesomeIcons.solidLaughBeam;
  if (value == 'faceLaughBeam') return FontAwesomeIcons.faceLaughBeam;
  if (value == 'laughBeam') return FontAwesomeIcons.laughBeam;
  if (value == 'solidFaceLaughSquint') return FontAwesomeIcons.solidFaceLaughSquint;
  if (value == 'solidLaughSquint') return FontAwesomeIcons.solidLaughSquint;
  if (value == 'faceLaughSquint') return FontAwesomeIcons.faceLaughSquint;
  if (value == 'laughSquint') return FontAwesomeIcons.laughSquint;
  if (value == 'solidFaceLaughWink') return FontAwesomeIcons.solidFaceLaughWink;
  if (value == 'solidLaughWink') return FontAwesomeIcons.solidLaughWink;
  if (value == 'faceLaughWink') return FontAwesomeIcons.faceLaughWink;
  if (value == 'laughWink') return FontAwesomeIcons.laughWink;
  if (value == 'solidFaceMeh') return FontAwesomeIcons.solidFaceMeh;
  if (value == 'solidMeh') return FontAwesomeIcons.solidMeh;
  if (value == 'faceMeh') return FontAwesomeIcons.faceMeh;
  if (value == 'meh') return FontAwesomeIcons.meh;
  if (value == 'solidFaceMehBlank') return FontAwesomeIcons.solidFaceMehBlank;
  if (value == 'solidMehBlank') return FontAwesomeIcons.solidMehBlank;
  if (value == 'faceMehBlank') return FontAwesomeIcons.faceMehBlank;
  if (value == 'mehBlank') return FontAwesomeIcons.mehBlank;
  if (value == 'solidFaceRollingEyes') return FontAwesomeIcons.solidFaceRollingEyes;
  if (value == 'solidMehRollingEyes') return FontAwesomeIcons.solidMehRollingEyes;
  if (value == 'faceRollingEyes') return FontAwesomeIcons.faceRollingEyes;
  if (value == 'mehRollingEyes') return FontAwesomeIcons.mehRollingEyes;
  if (value == 'solidFaceSadCry') return FontAwesomeIcons.solidFaceSadCry;
  if (value == 'solidSadCry') return FontAwesomeIcons.solidSadCry;
  if (value == 'faceSadCry') return FontAwesomeIcons.faceSadCry;
  if (value == 'sadCry') return FontAwesomeIcons.sadCry;
  if (value == 'solidFaceSadTear') return FontAwesomeIcons.solidFaceSadTear;
  if (value == 'solidSadTear') return FontAwesomeIcons.solidSadTear;
  if (value == 'faceSadTear') return FontAwesomeIcons.faceSadTear;
  if (value == 'sadTear') return FontAwesomeIcons.sadTear;
  if (value == 'solidFaceSmile') return FontAwesomeIcons.solidFaceSmile;
  if (value == 'solidSmile') return FontAwesomeIcons.solidSmile;
  if (value == 'faceSmile') return FontAwesomeIcons.faceSmile;
  if (value == 'smile') return FontAwesomeIcons.smile;
  if (value == 'solidFaceSmileBeam') return FontAwesomeIcons.solidFaceSmileBeam;
  if (value == 'solidSmileBeam') return FontAwesomeIcons.solidSmileBeam;
  if (value == 'faceSmileBeam') return FontAwesomeIcons.faceSmileBeam;
  if (value == 'smileBeam') return FontAwesomeIcons.smileBeam;
  if (value == 'solidFaceSmileWink') return FontAwesomeIcons.solidFaceSmileWink;
  if (value == 'solidSmileWink') return FontAwesomeIcons.solidSmileWink;
  if (value == 'faceSmileWink') return FontAwesomeIcons.faceSmileWink;
  if (value == 'smileWink') return FontAwesomeIcons.smileWink;
  if (value == 'solidFaceSurprise') return FontAwesomeIcons.solidFaceSurprise;
  if (value == 'solidSurprise') return FontAwesomeIcons.solidSurprise;
  if (value == 'faceSurprise') return FontAwesomeIcons.faceSurprise;
  if (value == 'surprise') return FontAwesomeIcons.surprise;
  if (value == 'solidFaceTired') return FontAwesomeIcons.solidFaceTired;
  if (value == 'solidTired') return FontAwesomeIcons.solidTired;
  if (value == 'faceTired') return FontAwesomeIcons.faceTired;
  if (value == 'tired') return FontAwesomeIcons.tired;
  if (value == 'facebook') return FontAwesomeIcons.facebook;
  if (value == 'facebookF') return FontAwesomeIcons.facebookF;
  if (value == 'facebookMessenger') return FontAwesomeIcons.facebookMessenger;
  if (value == 'fan') return FontAwesomeIcons.fan;
  if (value == 'fantasyFlightGames') return FontAwesomeIcons.fantasyFlightGames;
  if (value == 'faucet') return FontAwesomeIcons.faucet;
  if (value == 'faucetDrip') return FontAwesomeIcons.faucetDrip;
  if (value == 'fax') return FontAwesomeIcons.fax;
  if (value == 'feather') return FontAwesomeIcons.feather;
  if (value == 'featherPointed') return FontAwesomeIcons.featherPointed;
  if (value == 'featherAlt') return FontAwesomeIcons.featherAlt;
  if (value == 'fedex') return FontAwesomeIcons.fedex;
  if (value == 'fedora') return FontAwesomeIcons.fedora;
  if (value == 'ferry') return FontAwesomeIcons.ferry;
  if (value == 'figma') return FontAwesomeIcons.figma;
  if (value == 'solidFile') return FontAwesomeIcons.solidFile;
  if (value == 'file') return FontAwesomeIcons.file;
  if (value == 'fileArrowDown') return FontAwesomeIcons.fileArrowDown;
  if (value == 'fileDownload') return FontAwesomeIcons.fileDownload;
  if (value == 'fileArrowUp') return FontAwesomeIcons.fileArrowUp;
  if (value == 'fileUpload') return FontAwesomeIcons.fileUpload;
  if (value == 'solidFileAudio') return FontAwesomeIcons.solidFileAudio;
  if (value == 'fileAudio') return FontAwesomeIcons.fileAudio;
  if (value == 'fileCircleCheck') return FontAwesomeIcons.fileCircleCheck;
  if (value == 'fileCircleExclamation') return FontAwesomeIcons.fileCircleExclamation;
  if (value == 'fileCircleMinus') return FontAwesomeIcons.fileCircleMinus;
  if (value == 'fileCirclePlus') return FontAwesomeIcons.fileCirclePlus;
  if (value == 'fileCircleQuestion') return FontAwesomeIcons.fileCircleQuestion;
  if (value == 'fileCircleXmark') return FontAwesomeIcons.fileCircleXmark;
  if (value == 'solidFileCode') return FontAwesomeIcons.solidFileCode;
  if (value == 'fileCode') return FontAwesomeIcons.fileCode;
  if (value == 'fileContract') return FontAwesomeIcons.fileContract;
  if (value == 'fileCsv') return FontAwesomeIcons.fileCsv;
  if (value == 'solidFileExcel') return FontAwesomeIcons.solidFileExcel;
  if (value == 'fileExcel') return FontAwesomeIcons.fileExcel;
  if (value == 'fileExport') return FontAwesomeIcons.fileExport;
  if (value == 'arrowRightFromFile') return FontAwesomeIcons.arrowRightFromFile;
  if (value == 'solidFileImage') return FontAwesomeIcons.solidFileImage;
  if (value == 'fileImage') return FontAwesomeIcons.fileImage;
  if (value == 'fileImport') return FontAwesomeIcons.fileImport;
  if (value == 'arrowRightToFile') return FontAwesomeIcons.arrowRightToFile;
  if (value == 'fileInvoice') return FontAwesomeIcons.fileInvoice;
  if (value == 'fileInvoiceDollar') return FontAwesomeIcons.fileInvoiceDollar;
  if (value == 'solidFileLines') return FontAwesomeIcons.solidFileLines;
  if (value == 'solidFileAlt') return FontAwesomeIcons.solidFileAlt;
  if (value == 'solidFileText') return FontAwesomeIcons.solidFileText;
  if (value == 'fileLines') return FontAwesomeIcons.fileLines;
  if (value == 'fileAlt') return FontAwesomeIcons.fileAlt;
  if (value == 'fileText') return FontAwesomeIcons.fileText;
  if (value == 'fileMedical') return FontAwesomeIcons.fileMedical;
  if (value == 'solidFilePdf') return FontAwesomeIcons.solidFilePdf;
  if (value == 'filePdf') return FontAwesomeIcons.filePdf;
  if (value == 'filePen') return FontAwesomeIcons.filePen;
  if (value == 'fileEdit') return FontAwesomeIcons.fileEdit;
  if (value == 'solidFilePowerpoint') return FontAwesomeIcons.solidFilePowerpoint;
  if (value == 'filePowerpoint') return FontAwesomeIcons.filePowerpoint;
  if (value == 'filePrescription') return FontAwesomeIcons.filePrescription;
  if (value == 'fileShield') return FontAwesomeIcons.fileShield;
  if (value == 'fileSignature') return FontAwesomeIcons.fileSignature;
  if (value == 'solidFileVideo') return FontAwesomeIcons.solidFileVideo;
  if (value == 'fileVideo') return FontAwesomeIcons.fileVideo;
  if (value == 'fileWaveform') return FontAwesomeIcons.fileWaveform;
  if (value == 'fileMedicalAlt') return FontAwesomeIcons.fileMedicalAlt;
  if (value == 'solidFileWord') return FontAwesomeIcons.solidFileWord;
  if (value == 'fileWord') return FontAwesomeIcons.fileWord;
  if (value == 'solidFileZipper') return FontAwesomeIcons.solidFileZipper;
  if (value == 'solidFileArchive') return FontAwesomeIcons.solidFileArchive;
  if (value == 'fileZipper') return FontAwesomeIcons.fileZipper;
  if (value == 'fileArchive') return FontAwesomeIcons.fileArchive;
  if (value == 'fill') return FontAwesomeIcons.fill;
  if (value == 'fillDrip') return FontAwesomeIcons.fillDrip;
  if (value == 'film') return FontAwesomeIcons.film;
  if (value == 'filter') return FontAwesomeIcons.filter;
  if (value == 'filterCircleDollar') return FontAwesomeIcons.filterCircleDollar;
  if (value == 'funnelDollar') return FontAwesomeIcons.funnelDollar;
  if (value == 'filterCircleXmark') return FontAwesomeIcons.filterCircleXmark;
  if (value == 'fingerprint') return FontAwesomeIcons.fingerprint;
  if (value == 'fire') return FontAwesomeIcons.fire;
  if (value == 'fireBurner') return FontAwesomeIcons.fireBurner;
  if (value == 'fireExtinguisher') return FontAwesomeIcons.fireExtinguisher;
  if (value == 'fireFlameCurved') return FontAwesomeIcons.fireFlameCurved;
  if (value == 'fireAlt') return FontAwesomeIcons.fireAlt;
  if (value == 'fireFlameSimple') return FontAwesomeIcons.fireFlameSimple;
  if (value == 'burn') return FontAwesomeIcons.burn;
  if (value == 'firefox') return FontAwesomeIcons.firefox;
  if (value == 'firefoxBrowser') return FontAwesomeIcons.firefoxBrowser;
  if (value == 'firstOrder') return FontAwesomeIcons.firstOrder;
  if (value == 'firstOrderAlt') return FontAwesomeIcons.firstOrderAlt;
  if (value == 'firstdraft') return FontAwesomeIcons.firstdraft;
  if (value == 'fish') return FontAwesomeIcons.fish;
  if (value == 'fishFins') return FontAwesomeIcons.fishFins;
  if (value == 'solidFlag') return FontAwesomeIcons.solidFlag;
  if (value == 'flag') return FontAwesomeIcons.flag;
  if (value == 'flagCheckered') return FontAwesomeIcons.flagCheckered;
  if (value == 'flagUsa') return FontAwesomeIcons.flagUsa;
  if (value == 'flask') return FontAwesomeIcons.flask;
  if (value == 'flaskVial') return FontAwesomeIcons.flaskVial;
  if (value == 'flickr') return FontAwesomeIcons.flickr;
  if (value == 'flipboard') return FontAwesomeIcons.flipboard;
  if (value == 'solidFloppyDisk') return FontAwesomeIcons.solidFloppyDisk;
  if (value == 'solidSave') return FontAwesomeIcons.solidSave;
  if (value == 'floppyDisk') return FontAwesomeIcons.floppyDisk;
  if (value == 'save') return FontAwesomeIcons.save;
  if (value == 'florinSign') return FontAwesomeIcons.florinSign;
  if (value == 'fly') return FontAwesomeIcons.fly;
  if (value == 'solidFolder') return FontAwesomeIcons.solidFolder;
  if (value == 'solidFolderBlank') return FontAwesomeIcons.solidFolderBlank;
  if (value == 'folder') return FontAwesomeIcons.folder;
  if (value == 'folderBlank') return FontAwesomeIcons.folderBlank;
  if (value == 'solidFolderClosed') return FontAwesomeIcons.solidFolderClosed;
  if (value == 'folderClosed') return FontAwesomeIcons.folderClosed;
  if (value == 'folderMinus') return FontAwesomeIcons.folderMinus;
  if (value == 'solidFolderOpen') return FontAwesomeIcons.solidFolderOpen;
  if (value == 'folderOpen') return FontAwesomeIcons.folderOpen;
  if (value == 'folderPlus') return FontAwesomeIcons.folderPlus;
  if (value == 'folderTree') return FontAwesomeIcons.folderTree;
  if (value == 'font') return FontAwesomeIcons.font;
  if (value == 'solidFontAwesome') return FontAwesomeIcons.solidFontAwesome;
  if (value == 'solidFontAwesomeFlag') return FontAwesomeIcons.solidFontAwesomeFlag;
  if (value == 'solidFontAwesomeLogoFull') return FontAwesomeIcons.solidFontAwesomeLogoFull;
  if (value == 'fontAwesome') return FontAwesomeIcons.fontAwesome;
  if (value == 'fontAwesomeFlag') return FontAwesomeIcons.fontAwesomeFlag;
  if (value == 'fontAwesomeLogoFull') return FontAwesomeIcons.fontAwesomeLogoFull;
  if (value == 'brandsFontAwesome') return FontAwesomeIcons.brandsFontAwesome;
  if (value == 'brandsFontAwesomeFlag') return FontAwesomeIcons.brandsFontAwesomeFlag;
  if (value == 'brandsFontAwesomeLogoFull') return FontAwesomeIcons.brandsFontAwesomeLogoFull;
  if (value == 'fonticons') return FontAwesomeIcons.fonticons;
  if (value == 'fonticonsFi') return FontAwesomeIcons.fonticonsFi;
  if (value == 'football') return FontAwesomeIcons.football;
  if (value == 'footballBall') return FontAwesomeIcons.footballBall;
  if (value == 'fortAwesome') return FontAwesomeIcons.fortAwesome;
  if (value == 'fortAwesomeAlt') return FontAwesomeIcons.fortAwesomeAlt;
  if (value == 'forumbee') return FontAwesomeIcons.forumbee;
  if (value == 'forward') return FontAwesomeIcons.forward;
  if (value == 'forwardFast') return FontAwesomeIcons.forwardFast;
  if (value == 'fastForward') return FontAwesomeIcons.fastForward;
  if (value == 'forwardStep') return FontAwesomeIcons.forwardStep;
  if (value == 'stepForward') return FontAwesomeIcons.stepForward;
  if (value == 'foursquare') return FontAwesomeIcons.foursquare;
  if (value == 'francSign') return FontAwesomeIcons.francSign;
  if (value == 'freeCodeCamp') return FontAwesomeIcons.freeCodeCamp;
  if (value == 'freebsd') return FontAwesomeIcons.freebsd;
  if (value == 'frog') return FontAwesomeIcons.frog;
  if (value == 'fulcrum') return FontAwesomeIcons.fulcrum;
  if (value == 'solidFutbol') return FontAwesomeIcons.solidFutbol;
  if (value == 'solidFutbolBall') return FontAwesomeIcons.solidFutbolBall;
  if (value == 'solidSoccerBall') return FontAwesomeIcons.solidSoccerBall;
  if (value == 'futbol') return FontAwesomeIcons.futbol;
  if (value == 'futbolBall') return FontAwesomeIcons.futbolBall;
  if (value == 'soccerBall') return FontAwesomeIcons.soccerBall;
  if (value == 'g') return FontAwesomeIcons.g;
  if (value == 'galacticRepublic') return FontAwesomeIcons.galacticRepublic;
  if (value == 'galacticSenate') return FontAwesomeIcons.galacticSenate;
  if (value == 'gamepad') return FontAwesomeIcons.gamepad;
  if (value == 'gasPump') return FontAwesomeIcons.gasPump;
  if (value == 'gauge') return FontAwesomeIcons.gauge;
  if (value == 'dashboard') return FontAwesomeIcons.dashboard;
  if (value == 'gaugeMed') return FontAwesomeIcons.gaugeMed;
  if (value == 'tachometerAltAverage') return FontAwesomeIcons.tachometerAltAverage;
  if (value == 'gaugeHigh') return FontAwesomeIcons.gaugeHigh;
  if (value == 'tachometerAlt') return FontAwesomeIcons.tachometerAlt;
  if (value == 'tachometerAltFast') return FontAwesomeIcons.tachometerAltFast;
  if (value == 'gaugeSimple') return FontAwesomeIcons.gaugeSimple;
  if (value == 'gaugeSimpleMed') return FontAwesomeIcons.gaugeSimpleMed;
  if (value == 'tachometerAverage') return FontAwesomeIcons.tachometerAverage;
  if (value == 'gaugeSimpleHigh') return FontAwesomeIcons.gaugeSimpleHigh;
  if (value == 'tachometer') return FontAwesomeIcons.tachometer;
  if (value == 'tachometerFast') return FontAwesomeIcons.tachometerFast;
  if (value == 'gavel') return FontAwesomeIcons.gavel;
  if (value == 'legal') return FontAwesomeIcons.legal;
  if (value == 'gear') return FontAwesomeIcons.gear;
  if (value == 'cog') return FontAwesomeIcons.cog;
  if (value == 'gears') return FontAwesomeIcons.gears;
  if (value == 'cogs') return FontAwesomeIcons.cogs;
  if (value == 'solidGem') return FontAwesomeIcons.solidGem;
  if (value == 'gem') return FontAwesomeIcons.gem;
  if (value == 'genderless') return FontAwesomeIcons.genderless;
  if (value == 'getPocket') return FontAwesomeIcons.getPocket;
  if (value == 'gg') return FontAwesomeIcons.gg;
  if (value == 'ggCircle') return FontAwesomeIcons.ggCircle;
  if (value == 'ghost') return FontAwesomeIcons.ghost;
  if (value == 'gift') return FontAwesomeIcons.gift;
  if (value == 'gifts') return FontAwesomeIcons.gifts;
  if (value == 'git') return FontAwesomeIcons.git;
  if (value == 'gitAlt') return FontAwesomeIcons.gitAlt;
  if (value == 'github') return FontAwesomeIcons.github;
  if (value == 'githubAlt') return FontAwesomeIcons.githubAlt;
  if (value == 'gitkraken') return FontAwesomeIcons.gitkraken;
  if (value == 'gitlab') return FontAwesomeIcons.gitlab;
  if (value == 'gitter') return FontAwesomeIcons.gitter;
  if (value == 'glassWater') return FontAwesomeIcons.glassWater;
  if (value == 'glassWaterDroplet') return FontAwesomeIcons.glassWaterDroplet;
  if (value == 'glasses') return FontAwesomeIcons.glasses;
  if (value == 'glide') return FontAwesomeIcons.glide;
  if (value == 'glideG') return FontAwesomeIcons.glideG;
  if (value == 'globe') return FontAwesomeIcons.globe;
  if (value == 'gofore') return FontAwesomeIcons.gofore;
  if (value == 'golang') return FontAwesomeIcons.golang;
  if (value == 'golfBallTee') return FontAwesomeIcons.golfBallTee;
  if (value == 'golfBall') return FontAwesomeIcons.golfBall;
  if (value == 'goodreads') return FontAwesomeIcons.goodreads;
  if (value == 'goodreadsG') return FontAwesomeIcons.goodreadsG;
  if (value == 'google') return FontAwesomeIcons.google;
  if (value == 'googleDrive') return FontAwesomeIcons.googleDrive;
  if (value == 'googlePay') return FontAwesomeIcons.googlePay;
  if (value == 'googlePlay') return FontAwesomeIcons.googlePlay;
  if (value == 'googlePlus') return FontAwesomeIcons.googlePlus;
  if (value == 'googlePlusG') return FontAwesomeIcons.googlePlusG;
  if (value == 'googleScholar') return FontAwesomeIcons.googleScholar;
  if (value == 'googleWallet') return FontAwesomeIcons.googleWallet;
  if (value == 'gopuram') return FontAwesomeIcons.gopuram;
  if (value == 'graduationCap') return FontAwesomeIcons.graduationCap;
  if (value == 'mortarBoard') return FontAwesomeIcons.mortarBoard;
  if (value == 'gratipay') return FontAwesomeIcons.gratipay;
  if (value == 'grav') return FontAwesomeIcons.grav;
  if (value == 'greaterThan') return FontAwesomeIcons.greaterThan;
  if (value == 'greaterThanEqual') return FontAwesomeIcons.greaterThanEqual;
  if (value == 'grip') return FontAwesomeIcons.grip;
  if (value == 'gripHorizontal') return FontAwesomeIcons.gripHorizontal;
  if (value == 'gripLines') return FontAwesomeIcons.gripLines;
  if (value == 'gripLinesVertical') return FontAwesomeIcons.gripLinesVertical;
  if (value == 'gripVertical') return FontAwesomeIcons.gripVertical;
  if (value == 'gripfire') return FontAwesomeIcons.gripfire;
  if (value == 'groupArrowsRotate') return FontAwesomeIcons.groupArrowsRotate;
  if (value == 'grunt') return FontAwesomeIcons.grunt;
  if (value == 'guaraniSign') return FontAwesomeIcons.guaraniSign;
  if (value == 'guilded') return FontAwesomeIcons.guilded;
  if (value == 'guitar') return FontAwesomeIcons.guitar;
  if (value == 'gulp') return FontAwesomeIcons.gulp;
  if (value == 'gun') return FontAwesomeIcons.gun;
  if (value == 'h') return FontAwesomeIcons.h;
  if (value == 'hackerNews') return FontAwesomeIcons.hackerNews;
  if (value == 'hackerrank') return FontAwesomeIcons.hackerrank;
  if (value == 'hammer') return FontAwesomeIcons.hammer;
  if (value == 'hamsa') return FontAwesomeIcons.hamsa;
  if (value == 'solidHand') return FontAwesomeIcons.solidHand;
  if (value == 'solidHandPaper') return FontAwesomeIcons.solidHandPaper;
  if (value == 'hand') return FontAwesomeIcons.hand;
  if (value == 'handPaper') return FontAwesomeIcons.handPaper;
  if (value == 'solidHandBackFist') return FontAwesomeIcons.solidHandBackFist;
  if (value == 'solidHandRock') return FontAwesomeIcons.solidHandRock;
  if (value == 'handBackFist') return FontAwesomeIcons.handBackFist;
  if (value == 'handRock') return FontAwesomeIcons.handRock;
  if (value == 'handDots') return FontAwesomeIcons.handDots;
  if (value == 'allergies') return FontAwesomeIcons.allergies;
  if (value == 'handFist') return FontAwesomeIcons.handFist;
  if (value == 'fistRaised') return FontAwesomeIcons.fistRaised;
  if (value == 'handHolding') return FontAwesomeIcons.handHolding;
  if (value == 'handHoldingDollar') return FontAwesomeIcons.handHoldingDollar;
  if (value == 'handHoldingUsd') return FontAwesomeIcons.handHoldingUsd;
  if (value == 'handHoldingDroplet') return FontAwesomeIcons.handHoldingDroplet;
  if (value == 'handHoldingWater') return FontAwesomeIcons.handHoldingWater;
  if (value == 'handHoldingHand') return FontAwesomeIcons.handHoldingHand;
  if (value == 'handHoldingHeart') return FontAwesomeIcons.handHoldingHeart;
  if (value == 'handHoldingMedical') return FontAwesomeIcons.handHoldingMedical;
  if (value == 'solidHandLizard') return FontAwesomeIcons.solidHandLizard;
  if (value == 'handLizard') return FontAwesomeIcons.handLizard;
  if (value == 'handMiddleFinger') return FontAwesomeIcons.handMiddleFinger;
  if (value == 'solidHandPeace') return FontAwesomeIcons.solidHandPeace;
  if (value == 'handPeace') return FontAwesomeIcons.handPeace;
  if (value == 'solidHandPointDown') return FontAwesomeIcons.solidHandPointDown;
  if (value == 'handPointDown') return FontAwesomeIcons.handPointDown;
  if (value == 'solidHandPointLeft') return FontAwesomeIcons.solidHandPointLeft;
  if (value == 'handPointLeft') return FontAwesomeIcons.handPointLeft;
  if (value == 'solidHandPointRight') return FontAwesomeIcons.solidHandPointRight;
  if (value == 'handPointRight') return FontAwesomeIcons.handPointRight;
  if (value == 'solidHandPointUp') return FontAwesomeIcons.solidHandPointUp;
  if (value == 'handPointUp') return FontAwesomeIcons.handPointUp;
  if (value == 'solidHandPointer') return FontAwesomeIcons.solidHandPointer;
  if (value == 'handPointer') return FontAwesomeIcons.handPointer;
  if (value == 'solidHandScissors') return FontAwesomeIcons.solidHandScissors;
  if (value == 'handScissors') return FontAwesomeIcons.handScissors;
  if (value == 'handSparkles') return FontAwesomeIcons.handSparkles;
  if (value == 'solidHandSpock') return FontAwesomeIcons.solidHandSpock;
  if (value == 'handSpock') return FontAwesomeIcons.handSpock;
  if (value == 'handcuffs') return FontAwesomeIcons.handcuffs;
  if (value == 'hands') return FontAwesomeIcons.hands;
  if (value == 'signLanguage') return FontAwesomeIcons.signLanguage;
  if (value == 'signing') return FontAwesomeIcons.signing;
  if (value == 'handsAslInterpreting') return FontAwesomeIcons.handsAslInterpreting;
  if (value == 'americanSignLanguageInterpreting') return FontAwesomeIcons.americanSignLanguageInterpreting;
  if (value == 'aslInterpreting') return FontAwesomeIcons.aslInterpreting;
  if (value == 'handsAmericanSignLanguageInterpreting') return FontAwesomeIcons.handsAmericanSignLanguageInterpreting;
  if (value == 'handsBound') return FontAwesomeIcons.handsBound;
  if (value == 'handsBubbles') return FontAwesomeIcons.handsBubbles;
  if (value == 'handsWash') return FontAwesomeIcons.handsWash;
  if (value == 'handsClapping') return FontAwesomeIcons.handsClapping;
  if (value == 'handsHolding') return FontAwesomeIcons.handsHolding;
  if (value == 'handsHoldingChild') return FontAwesomeIcons.handsHoldingChild;
  if (value == 'handsHoldingCircle') return FontAwesomeIcons.handsHoldingCircle;
  if (value == 'handsPraying') return FontAwesomeIcons.handsPraying;
  if (value == 'prayingHands') return FontAwesomeIcons.prayingHands;
  if (value == 'solidHandshake') return FontAwesomeIcons.solidHandshake;
  if (value == 'handshake') return FontAwesomeIcons.handshake;
  if (value == 'handshakeAngle') return FontAwesomeIcons.handshakeAngle;
  if (value == 'handsHelping') return FontAwesomeIcons.handsHelping;
  if (value == 'handshakeSimple') return FontAwesomeIcons.handshakeSimple;
  if (value == 'handshakeAlt') return FontAwesomeIcons.handshakeAlt;
  if (value == 'handshakeSimpleSlash') return FontAwesomeIcons.handshakeSimpleSlash;
  if (value == 'handshakeAltSlash') return FontAwesomeIcons.handshakeAltSlash;
  if (value == 'handshakeSlash') return FontAwesomeIcons.handshakeSlash;
  if (value == 'hanukiah') return FontAwesomeIcons.hanukiah;
  if (value == 'solidHardDrive') return FontAwesomeIcons.solidHardDrive;
  if (value == 'solidHdd') return FontAwesomeIcons.solidHdd;
  if (value == 'hardDrive') return FontAwesomeIcons.hardDrive;
  if (value == 'hdd') return FontAwesomeIcons.hdd;
  if (value == 'hashnode') return FontAwesomeIcons.hashnode;
  if (value == 'hashtag') return FontAwesomeIcons.hashtag;
  if (value == 'hatCowboy') return FontAwesomeIcons.hatCowboy;
  if (value == 'hatCowboySide') return FontAwesomeIcons.hatCowboySide;
  if (value == 'hatWizard') return FontAwesomeIcons.hatWizard;
  if (value == 'headSideCough') return FontAwesomeIcons.headSideCough;
  if (value == 'headSideCoughSlash') return FontAwesomeIcons.headSideCoughSlash;
  if (value == 'headSideMask') return FontAwesomeIcons.headSideMask;
  if (value == 'headSideVirus') return FontAwesomeIcons.headSideVirus;
  if (value == 'heading') return FontAwesomeIcons.heading;
  if (value == 'header') return FontAwesomeIcons.header;
  if (value == 'headphones') return FontAwesomeIcons.headphones;
  if (value == 'headphonesSimple') return FontAwesomeIcons.headphonesSimple;
  if (value == 'headphonesAlt') return FontAwesomeIcons.headphonesAlt;
  if (value == 'headset') return FontAwesomeIcons.headset;
  if (value == 'solidHeart') return FontAwesomeIcons.solidHeart;
  if (value == 'heart') return FontAwesomeIcons.heart;
  if (value == 'heartCircleBolt') return FontAwesomeIcons.heartCircleBolt;
  if (value == 'heartCircleCheck') return FontAwesomeIcons.heartCircleCheck;
  if (value == 'heartCircleExclamation') return FontAwesomeIcons.heartCircleExclamation;
  if (value == 'heartCircleMinus') return FontAwesomeIcons.heartCircleMinus;
  if (value == 'heartCirclePlus') return FontAwesomeIcons.heartCirclePlus;
  if (value == 'heartCircleXmark') return FontAwesomeIcons.heartCircleXmark;
  if (value == 'heartCrack') return FontAwesomeIcons.heartCrack;
  if (value == 'heartBroken') return FontAwesomeIcons.heartBroken;
  if (value == 'heartPulse') return FontAwesomeIcons.heartPulse;
  if (value == 'heartbeat') return FontAwesomeIcons.heartbeat;
  if (value == 'helicopter') return FontAwesomeIcons.helicopter;
  if (value == 'helicopterSymbol') return FontAwesomeIcons.helicopterSymbol;
  if (value == 'helmetSafety') return FontAwesomeIcons.helmetSafety;
  if (value == 'hardHat') return FontAwesomeIcons.hardHat;
  if (value == 'hatHard') return FontAwesomeIcons.hatHard;
  if (value == 'helmetUn') return FontAwesomeIcons.helmetUn;
  if (value == 'highlighter') return FontAwesomeIcons.highlighter;
  if (value == 'hillAvalanche') return FontAwesomeIcons.hillAvalanche;
  if (value == 'hillRockslide') return FontAwesomeIcons.hillRockslide;
  if (value == 'hippo') return FontAwesomeIcons.hippo;
  if (value == 'hips') return FontAwesomeIcons.hips;
  if (value == 'hireAHelper') return FontAwesomeIcons.hireAHelper;
  if (value == 'hive') return FontAwesomeIcons.hive;
  if (value == 'hockeyPuck') return FontAwesomeIcons.hockeyPuck;
  if (value == 'hollyBerry') return FontAwesomeIcons.hollyBerry;
  if (value == 'hooli') return FontAwesomeIcons.hooli;
  if (value == 'hornbill') return FontAwesomeIcons.hornbill;
  if (value == 'horse') return FontAwesomeIcons.horse;
  if (value == 'horseHead') return FontAwesomeIcons.horseHead;
  if (value == 'solidHospital') return FontAwesomeIcons.solidHospital;
  if (value == 'solidHospitalAlt') return FontAwesomeIcons.solidHospitalAlt;
  if (value == 'solidHospitalWide') return FontAwesomeIcons.solidHospitalWide;
  if (value == 'hospital') return FontAwesomeIcons.hospital;
  if (value == 'hospitalAlt') return FontAwesomeIcons.hospitalAlt;
  if (value == 'hospitalWide') return FontAwesomeIcons.hospitalWide;
  if (value == 'hospitalUser') return FontAwesomeIcons.hospitalUser;
  if (value == 'hotTubPerson') return FontAwesomeIcons.hotTubPerson;
  if (value == 'hotTub') return FontAwesomeIcons.hotTub;
  if (value == 'hotdog') return FontAwesomeIcons.hotdog;
  if (value == 'hotel') return FontAwesomeIcons.hotel;
  if (value == 'hotjar') return FontAwesomeIcons.hotjar;
  if (value == 'solidHourglass') return FontAwesomeIcons.solidHourglass;
  if (value == 'solidHourglassEmpty') return FontAwesomeIcons.solidHourglassEmpty;
  if (value == 'hourglass') return FontAwesomeIcons.hourglass;
  if (value == 'hourglassEmpty') return FontAwesomeIcons.hourglassEmpty;
  if (value == 'hourglassEnd') return FontAwesomeIcons.hourglassEnd;
  if (value == 'hourglass3') return FontAwesomeIcons.hourglass3;
  if (value == 'solidHourglassHalf') return FontAwesomeIcons.solidHourglassHalf;
  if (value == 'solidHourglass2') return FontAwesomeIcons.solidHourglass2;
  if (value == 'hourglassHalf') return FontAwesomeIcons.hourglassHalf;
  if (value == 'hourglass2') return FontAwesomeIcons.hourglass2;
  if (value == 'hourglassStart') return FontAwesomeIcons.hourglassStart;
  if (value == 'hourglass1') return FontAwesomeIcons.hourglass1;
  if (value == 'house') return FontAwesomeIcons.house;
  if (value == 'home') return FontAwesomeIcons.home;
  if (value == 'homeAlt') return FontAwesomeIcons.homeAlt;
  if (value == 'homeLgAlt') return FontAwesomeIcons.homeLgAlt;
  if (value == 'houseChimney') return FontAwesomeIcons.houseChimney;
  if (value == 'homeLg') return FontAwesomeIcons.homeLg;
  if (value == 'houseChimneyCrack') return FontAwesomeIcons.houseChimneyCrack;
  if (value == 'houseDamage') return FontAwesomeIcons.houseDamage;
  if (value == 'houseChimneyMedical') return FontAwesomeIcons.houseChimneyMedical;
  if (value == 'clinicMedical') return FontAwesomeIcons.clinicMedical;
  if (value == 'houseChimneyUser') return FontAwesomeIcons.houseChimneyUser;
  if (value == 'houseChimneyWindow') return FontAwesomeIcons.houseChimneyWindow;
  if (value == 'houseCircleCheck') return FontAwesomeIcons.houseCircleCheck;
  if (value == 'houseCircleExclamation') return FontAwesomeIcons.houseCircleExclamation;
  if (value == 'houseCircleXmark') return FontAwesomeIcons.houseCircleXmark;
  if (value == 'houseCrack') return FontAwesomeIcons.houseCrack;
  if (value == 'houseFire') return FontAwesomeIcons.houseFire;
  if (value == 'houseFlag') return FontAwesomeIcons.houseFlag;
  if (value == 'houseFloodWater') return FontAwesomeIcons.houseFloodWater;
  if (value == 'houseFloodWaterCircleArrowRight') return FontAwesomeIcons.houseFloodWaterCircleArrowRight;
  if (value == 'houseLaptop') return FontAwesomeIcons.houseLaptop;
  if (value == 'laptopHouse') return FontAwesomeIcons.laptopHouse;
  if (value == 'houseLock') return FontAwesomeIcons.houseLock;
  if (value == 'houseMedical') return FontAwesomeIcons.houseMedical;
  if (value == 'houseMedicalCircleCheck') return FontAwesomeIcons.houseMedicalCircleCheck;
  if (value == 'houseMedicalCircleExclamation') return FontAwesomeIcons.houseMedicalCircleExclamation;
  if (value == 'houseMedicalCircleXmark') return FontAwesomeIcons.houseMedicalCircleXmark;
  if (value == 'houseMedicalFlag') return FontAwesomeIcons.houseMedicalFlag;
  if (value == 'houseSignal') return FontAwesomeIcons.houseSignal;
  if (value == 'houseTsunami') return FontAwesomeIcons.houseTsunami;
  if (value == 'houseUser') return FontAwesomeIcons.houseUser;
  if (value == 'homeUser') return FontAwesomeIcons.homeUser;
  if (value == 'houzz') return FontAwesomeIcons.houzz;
  if (value == 'hryvniaSign') return FontAwesomeIcons.hryvniaSign;
  if (value == 'hryvnia') return FontAwesomeIcons.hryvnia;
  if (value == 'html5') return FontAwesomeIcons.html5;
  if (value == 'hubspot') return FontAwesomeIcons.hubspot;
  if (value == 'hurricane') return FontAwesomeIcons.hurricane;
  if (value == 'i') return FontAwesomeIcons.i;
  if (value == 'iCursor') return FontAwesomeIcons.iCursor;
  if (value == 'iceCream') return FontAwesomeIcons.iceCream;
  if (value == 'icicles') return FontAwesomeIcons.icicles;
  if (value == 'icons') return FontAwesomeIcons.icons;
  if (value == 'heartMusicCameraBolt') return FontAwesomeIcons.heartMusicCameraBolt;
  if (value == 'solidIdBadge') return FontAwesomeIcons.solidIdBadge;
  if (value == 'idBadge') return FontAwesomeIcons.idBadge;
  if (value == 'solidIdCard') return FontAwesomeIcons.solidIdCard;
  if (value == 'solidDriversLicense') return FontAwesomeIcons.solidDriversLicense;
  if (value == 'idCard') return FontAwesomeIcons.idCard;
  if (value == 'driversLicense') return FontAwesomeIcons.driversLicense;
  if (value == 'idCardClip') return FontAwesomeIcons.idCardClip;
  if (value == 'idCardAlt') return FontAwesomeIcons.idCardAlt;
  if (value == 'ideal') return FontAwesomeIcons.ideal;
  if (value == 'igloo') return FontAwesomeIcons.igloo;
  if (value == 'solidImage') return FontAwesomeIcons.solidImage;
  if (value == 'image') return FontAwesomeIcons.image;
  if (value == 'imagePortrait') return FontAwesomeIcons.imagePortrait;
  if (value == 'portrait') return FontAwesomeIcons.portrait;
  if (value == 'solidImages') return FontAwesomeIcons.solidImages;
  if (value == 'images') return FontAwesomeIcons.images;
  if (value == 'imdb') return FontAwesomeIcons.imdb;
  if (value == 'inbox') return FontAwesomeIcons.inbox;
  if (value == 'indent') return FontAwesomeIcons.indent;
  if (value == 'indianRupeeSign') return FontAwesomeIcons.indianRupeeSign;
  if (value == 'indianRupee') return FontAwesomeIcons.indianRupee;
  if (value == 'inr') return FontAwesomeIcons.inr;
  if (value == 'industry') return FontAwesomeIcons.industry;
  if (value == 'infinity') return FontAwesomeIcons.infinity;
  if (value == 'info') return FontAwesomeIcons.info;
  if (value == 'instagram') return FontAwesomeIcons.instagram;
  if (value == 'instalod') return FontAwesomeIcons.instalod;
  if (value == 'intercom') return FontAwesomeIcons.intercom;
  if (value == 'internetExplorer') return FontAwesomeIcons.internetExplorer;
  if (value == 'invision') return FontAwesomeIcons.invision;
  if (value == 'ioxhost') return FontAwesomeIcons.ioxhost;
  if (value == 'italic') return FontAwesomeIcons.italic;
  if (value == 'itchIo') return FontAwesomeIcons.itchIo;
  if (value == 'itunes') return FontAwesomeIcons.itunes;
  if (value == 'itunesNote') return FontAwesomeIcons.itunesNote;
  if (value == 'j') return FontAwesomeIcons.j;
  if (value == 'jar') return FontAwesomeIcons.jar;
  if (value == 'jarWheat') return FontAwesomeIcons.jarWheat;
  if (value == 'java') return FontAwesomeIcons.java;
  if (value == 'jedi') return FontAwesomeIcons.jedi;
  if (value == 'jediOrder') return FontAwesomeIcons.jediOrder;
  if (value == 'jenkins') return FontAwesomeIcons.jenkins;
  if (value == 'jetFighter') return FontAwesomeIcons.jetFighter;
  if (value == 'fighterJet') return FontAwesomeIcons.fighterJet;
  if (value == 'jetFighterUp') return FontAwesomeIcons.jetFighterUp;
  if (value == 'jira') return FontAwesomeIcons.jira;
  if (value == 'joget') return FontAwesomeIcons.joget;
  if (value == 'joint') return FontAwesomeIcons.joint;
  if (value == 'joomla') return FontAwesomeIcons.joomla;
  if (value == 'js') return FontAwesomeIcons.js;
  if (value == 'jsfiddle') return FontAwesomeIcons.jsfiddle;
  if (value == 'jugDetergent') return FontAwesomeIcons.jugDetergent;
  if (value == 'k') return FontAwesomeIcons.k;
  if (value == 'kaaba') return FontAwesomeIcons.kaaba;
  if (value == 'kaggle') return FontAwesomeIcons.kaggle;
  if (value == 'key') return FontAwesomeIcons.key;
  if (value == 'keybase') return FontAwesomeIcons.keybase;
  if (value == 'solidKeyboard') return FontAwesomeIcons.solidKeyboard;
  if (value == 'keyboard') return FontAwesomeIcons.keyboard;
  if (value == 'keycdn') return FontAwesomeIcons.keycdn;
  if (value == 'khanda') return FontAwesomeIcons.khanda;
  if (value == 'kickstarter') return FontAwesomeIcons.kickstarter;
  if (value == 'kickstarterK') return FontAwesomeIcons.kickstarterK;
  if (value == 'kipSign') return FontAwesomeIcons.kipSign;
  if (value == 'kitMedical') return FontAwesomeIcons.kitMedical;
  if (value == 'firstAid') return FontAwesomeIcons.firstAid;
  if (value == 'kitchenSet') return FontAwesomeIcons.kitchenSet;
  if (value == 'kiwiBird') return FontAwesomeIcons.kiwiBird;
  if (value == 'korvue') return FontAwesomeIcons.korvue;
  if (value == 'l') return FontAwesomeIcons.l;
  if (value == 'landMineOn') return FontAwesomeIcons.landMineOn;
  if (value == 'landmark') return FontAwesomeIcons.landmark;
  if (value == 'landmarkDome') return FontAwesomeIcons.landmarkDome;
  if (value == 'landmarkAlt') return FontAwesomeIcons.landmarkAlt;
  if (value == 'landmarkFlag') return FontAwesomeIcons.landmarkFlag;
  if (value == 'language') return FontAwesomeIcons.language;
  if (value == 'laptop') return FontAwesomeIcons.laptop;
  if (value == 'laptopCode') return FontAwesomeIcons.laptopCode;
  if (value == 'laptopFile') return FontAwesomeIcons.laptopFile;
  if (value == 'laptopMedical') return FontAwesomeIcons.laptopMedical;
  if (value == 'laravel') return FontAwesomeIcons.laravel;
  if (value == 'lariSign') return FontAwesomeIcons.lariSign;
  if (value == 'lastfm') return FontAwesomeIcons.lastfm;
  if (value == 'layerGroup') return FontAwesomeIcons.layerGroup;
  if (value == 'leaf') return FontAwesomeIcons.leaf;
  if (value == 'leanpub') return FontAwesomeIcons.leanpub;
  if (value == 'leftLong') return FontAwesomeIcons.leftLong;
  if (value == 'longArrowAltLeft') return FontAwesomeIcons.longArrowAltLeft;
  if (value == 'leftRight') return FontAwesomeIcons.leftRight;
  if (value == 'arrowsAltH') return FontAwesomeIcons.arrowsAltH;
  if (value == 'solidLemon') return FontAwesomeIcons.solidLemon;
  if (value == 'lemon') return FontAwesomeIcons.lemon;
  if (value == 'less') return FontAwesomeIcons.less;
  if (value == 'lessThan') return FontAwesomeIcons.lessThan;
  if (value == 'lessThanEqual') return FontAwesomeIcons.lessThanEqual;
  if (value == 'letterboxd') return FontAwesomeIcons.letterboxd;
  if (value == 'solidLifeRing') return FontAwesomeIcons.solidLifeRing;
  if (value == 'lifeRing') return FontAwesomeIcons.lifeRing;
  if (value == 'solidLightbulb') return FontAwesomeIcons.solidLightbulb;
  if (value == 'lightbulb') return FontAwesomeIcons.lightbulb;
  if (value == 'line') return FontAwesomeIcons.line;
  if (value == 'linesLeaning') return FontAwesomeIcons.linesLeaning;
  if (value == 'link') return FontAwesomeIcons.link;
  if (value == 'chain') return FontAwesomeIcons.chain;
  if (value == 'linkSlash') return FontAwesomeIcons.linkSlash;
  if (value == 'chainBroken') return FontAwesomeIcons.chainBroken;
  if (value == 'chainSlash') return FontAwesomeIcons.chainSlash;
  if (value == 'unlink') return FontAwesomeIcons.unlink;
  if (value == 'linkedin') return FontAwesomeIcons.linkedin;
  if (value == 'linkedinIn') return FontAwesomeIcons.linkedinIn;
  if (value == 'linode') return FontAwesomeIcons.linode;
  if (value == 'linux') return FontAwesomeIcons.linux;
  if (value == 'liraSign') return FontAwesomeIcons.liraSign;
  if (value == 'list') return FontAwesomeIcons.list;
  if (value == 'listSquares') return FontAwesomeIcons.listSquares;
  if (value == 'listCheck') return FontAwesomeIcons.listCheck;
  if (value == 'tasks') return FontAwesomeIcons.tasks;
  if (value == 'listOl') return FontAwesomeIcons.listOl;
  if (value == 'list12') return FontAwesomeIcons.list12;
  if (value == 'listNumeric') return FontAwesomeIcons.listNumeric;
  if (value == 'listUl') return FontAwesomeIcons.listUl;
  if (value == 'listDots') return FontAwesomeIcons.listDots;
  if (value == 'litecoinSign') return FontAwesomeIcons.litecoinSign;
  if (value == 'locationArrow') return FontAwesomeIcons.locationArrow;
  if (value == 'locationCrosshairs') return FontAwesomeIcons.locationCrosshairs;
  if (value == 'location') return FontAwesomeIcons.location;
  if (value == 'locationDot') return FontAwesomeIcons.locationDot;
  if (value == 'mapMarkerAlt') return FontAwesomeIcons.mapMarkerAlt;
  if (value == 'locationPin') return FontAwesomeIcons.locationPin;
  if (value == 'mapMarker') return FontAwesomeIcons.mapMarker;
  if (value == 'locationPinLock') return FontAwesomeIcons.locationPinLock;
  if (value == 'lock') return FontAwesomeIcons.lock;
  if (value == 'lockOpen') return FontAwesomeIcons.lockOpen;
  if (value == 'locust') return FontAwesomeIcons.locust;
  if (value == 'lungs') return FontAwesomeIcons.lungs;
  if (value == 'lungsVirus') return FontAwesomeIcons.lungsVirus;
  if (value == 'lyft') return FontAwesomeIcons.lyft;
  if (value == 'm') return FontAwesomeIcons.m;
  if (value == 'magento') return FontAwesomeIcons.magento;
  if (value == 'magnet') return FontAwesomeIcons.magnet;
  if (value == 'magnifyingGlass') return FontAwesomeIcons.magnifyingGlass;
  if (value == 'search') return FontAwesomeIcons.search;
  if (value == 'magnifyingGlassArrowRight') return FontAwesomeIcons.magnifyingGlassArrowRight;
  if (value == 'magnifyingGlassChart') return FontAwesomeIcons.magnifyingGlassChart;
  if (value == 'magnifyingGlassDollar') return FontAwesomeIcons.magnifyingGlassDollar;
  if (value == 'searchDollar') return FontAwesomeIcons.searchDollar;
  if (value == 'magnifyingGlassLocation') return FontAwesomeIcons.magnifyingGlassLocation;
  if (value == 'searchLocation') return FontAwesomeIcons.searchLocation;
  if (value == 'magnifyingGlassMinus') return FontAwesomeIcons.magnifyingGlassMinus;
  if (value == 'searchMinus') return FontAwesomeIcons.searchMinus;
  if (value == 'magnifyingGlassPlus') return FontAwesomeIcons.magnifyingGlassPlus;
  if (value == 'searchPlus') return FontAwesomeIcons.searchPlus;
  if (value == 'mailchimp') return FontAwesomeIcons.mailchimp;
  if (value == 'manatSign') return FontAwesomeIcons.manatSign;
  if (value == 'mandalorian') return FontAwesomeIcons.mandalorian;
  if (value == 'solidMap') return FontAwesomeIcons.solidMap;
  if (value == 'map') return FontAwesomeIcons.map;
  if (value == 'mapLocation') return FontAwesomeIcons.mapLocation;
  if (value == 'mapMarked') return FontAwesomeIcons.mapMarked;
  if (value == 'mapLocationDot') return FontAwesomeIcons.mapLocationDot;
  if (value == 'mapMarkedAlt') return FontAwesomeIcons.mapMarkedAlt;
  if (value == 'mapPin') return FontAwesomeIcons.mapPin;
  if (value == 'markdown') return FontAwesomeIcons.markdown;
  if (value == 'marker') return FontAwesomeIcons.marker;
  if (value == 'mars') return FontAwesomeIcons.mars;
  if (value == 'marsAndVenus') return FontAwesomeIcons.marsAndVenus;
  if (value == 'marsAndVenusBurst') return FontAwesomeIcons.marsAndVenusBurst;
  if (value == 'marsDouble') return FontAwesomeIcons.marsDouble;
  if (value == 'marsStroke') return FontAwesomeIcons.marsStroke;
  if (value == 'marsStrokeRight') return FontAwesomeIcons.marsStrokeRight;
  if (value == 'marsStrokeH') return FontAwesomeIcons.marsStrokeH;
  if (value == 'marsStrokeUp') return FontAwesomeIcons.marsStrokeUp;
  if (value == 'marsStrokeV') return FontAwesomeIcons.marsStrokeV;
  if (value == 'martiniGlass') return FontAwesomeIcons.martiniGlass;
  if (value == 'glassMartiniAlt') return FontAwesomeIcons.glassMartiniAlt;
  if (value == 'martiniGlassCitrus') return FontAwesomeIcons.martiniGlassCitrus;
  if (value == 'cocktail') return FontAwesomeIcons.cocktail;
  if (value == 'martiniGlassEmpty') return FontAwesomeIcons.martiniGlassEmpty;
  if (value == 'glassMartini') return FontAwesomeIcons.glassMartini;
  if (value == 'mask') return FontAwesomeIcons.mask;
  if (value == 'maskFace') return FontAwesomeIcons.maskFace;
  if (value == 'maskVentilator') return FontAwesomeIcons.maskVentilator;
  if (value == 'masksTheater') return FontAwesomeIcons.masksTheater;
  if (value == 'theaterMasks') return FontAwesomeIcons.theaterMasks;
  if (value == 'mastodon') return FontAwesomeIcons.mastodon;
  if (value == 'mattressPillow') return FontAwesomeIcons.mattressPillow;
  if (value == 'maxcdn') return FontAwesomeIcons.maxcdn;
  if (value == 'maximize') return FontAwesomeIcons.maximize;
  if (value == 'expandArrowsAlt') return FontAwesomeIcons.expandArrowsAlt;
  if (value == 'mdb') return FontAwesomeIcons.mdb;
  if (value == 'medal') return FontAwesomeIcons.medal;
  if (value == 'medapps') return FontAwesomeIcons.medapps;
  if (value == 'medium') return FontAwesomeIcons.medium;
  if (value == 'mediumM') return FontAwesomeIcons.mediumM;
  if (value == 'medrt') return FontAwesomeIcons.medrt;
  if (value == 'meetup') return FontAwesomeIcons.meetup;
  if (value == 'megaport') return FontAwesomeIcons.megaport;
  if (value == 'memory') return FontAwesomeIcons.memory;
  if (value == 'mendeley') return FontAwesomeIcons.mendeley;
  if (value == 'menorah') return FontAwesomeIcons.menorah;
  if (value == 'mercury') return FontAwesomeIcons.mercury;
  if (value == 'solidMessage') return FontAwesomeIcons.solidMessage;
  if (value == 'solidCommentAlt') return FontAwesomeIcons.solidCommentAlt;
  if (value == 'message') return FontAwesomeIcons.message;
  if (value == 'commentAlt') return FontAwesomeIcons.commentAlt;
  if (value == 'meta') return FontAwesomeIcons.meta;
  if (value == 'meteor') return FontAwesomeIcons.meteor;
  if (value == 'microblog') return FontAwesomeIcons.microblog;
  if (value == 'microchip') return FontAwesomeIcons.microchip;
  if (value == 'microphone') return FontAwesomeIcons.microphone;
  if (value == 'microphoneLines') return FontAwesomeIcons.microphoneLines;
  if (value == 'microphoneAlt') return FontAwesomeIcons.microphoneAlt;
  if (value == 'microphoneLinesSlash') return FontAwesomeIcons.microphoneLinesSlash;
  if (value == 'microphoneAltSlash') return FontAwesomeIcons.microphoneAltSlash;
  if (value == 'microphoneSlash') return FontAwesomeIcons.microphoneSlash;
  if (value == 'microscope') return FontAwesomeIcons.microscope;
  if (value == 'microsoft') return FontAwesomeIcons.microsoft;
  if (value == 'millSign') return FontAwesomeIcons.millSign;
  if (value == 'minimize') return FontAwesomeIcons.minimize;
  if (value == 'compressArrowsAlt') return FontAwesomeIcons.compressArrowsAlt;
  if (value == 'mintbit') return FontAwesomeIcons.mintbit;
  if (value == 'minus') return FontAwesomeIcons.minus;
  if (value == 'subtract') return FontAwesomeIcons.subtract;
  if (value == 'mitten') return FontAwesomeIcons.mitten;
  if (value == 'mix') return FontAwesomeIcons.mix;
  if (value == 'mixcloud') return FontAwesomeIcons.mixcloud;
  if (value == 'mixer') return FontAwesomeIcons.mixer;
  if (value == 'mizuni') return FontAwesomeIcons.mizuni;
  if (value == 'mobile') return FontAwesomeIcons.mobile;
  if (value == 'mobileAndroid') return FontAwesomeIcons.mobileAndroid;
  if (value == 'mobilePhone') return FontAwesomeIcons.mobilePhone;
  if (value == 'mobileButton') return FontAwesomeIcons.mobileButton;
  if (value == 'mobileRetro') return FontAwesomeIcons.mobileRetro;
  if (value == 'mobileScreen') return FontAwesomeIcons.mobileScreen;
  if (value == 'mobileAndroidAlt') return FontAwesomeIcons.mobileAndroidAlt;
  if (value == 'mobileScreenButton') return FontAwesomeIcons.mobileScreenButton;
  if (value == 'mobileAlt') return FontAwesomeIcons.mobileAlt;
  if (value == 'modx') return FontAwesomeIcons.modx;
  if (value == 'monero') return FontAwesomeIcons.monero;
  if (value == 'moneyBill') return FontAwesomeIcons.moneyBill;
  if (value == 'solidMoneyBill1') return FontAwesomeIcons.solidMoneyBill1;
  if (value == 'solidMoneyBillAlt') return FontAwesomeIcons.solidMoneyBillAlt;
  if (value == 'moneyBill1') return FontAwesomeIcons.moneyBill1;
  if (value == 'moneyBillAlt') return FontAwesomeIcons.moneyBillAlt;
  if (value == 'moneyBill1Wave') return FontAwesomeIcons.moneyBill1Wave;
  if (value == 'moneyBillWaveAlt') return FontAwesomeIcons.moneyBillWaveAlt;
  if (value == 'moneyBillTransfer') return FontAwesomeIcons.moneyBillTransfer;
  if (value == 'moneyBillTrendUp') return FontAwesomeIcons.moneyBillTrendUp;
  if (value == 'moneyBillWave') return FontAwesomeIcons.moneyBillWave;
  if (value == 'moneyBillWheat') return FontAwesomeIcons.moneyBillWheat;
  if (value == 'moneyBills') return FontAwesomeIcons.moneyBills;
  if (value == 'moneyCheck') return FontAwesomeIcons.moneyCheck;
  if (value == 'moneyCheckDollar') return FontAwesomeIcons.moneyCheckDollar;
  if (value == 'moneyCheckAlt') return FontAwesomeIcons.moneyCheckAlt;
  if (value == 'monument') return FontAwesomeIcons.monument;
  if (value == 'solidMoon') return FontAwesomeIcons.solidMoon;
  if (value == 'moon') return FontAwesomeIcons.moon;
  if (value == 'mortarPestle') return FontAwesomeIcons.mortarPestle;
  if (value == 'mosque') return FontAwesomeIcons.mosque;
  if (value == 'mosquito') return FontAwesomeIcons.mosquito;
  if (value == 'mosquitoNet') return FontAwesomeIcons.mosquitoNet;
  if (value == 'motorcycle') return FontAwesomeIcons.motorcycle;
  if (value == 'mound') return FontAwesomeIcons.mound;
  if (value == 'mountain') return FontAwesomeIcons.mountain;
  if (value == 'mountainCity') return FontAwesomeIcons.mountainCity;
  if (value == 'mountainSun') return FontAwesomeIcons.mountainSun;
  if (value == 'mugHot') return FontAwesomeIcons.mugHot;
  if (value == 'mugSaucer') return FontAwesomeIcons.mugSaucer;
  if (value == 'coffee') return FontAwesomeIcons.coffee;
  if (value == 'music') return FontAwesomeIcons.music;
  if (value == 'n') return FontAwesomeIcons.n;
  if (value == 'nairaSign') return FontAwesomeIcons.nairaSign;
  if (value == 'napster') return FontAwesomeIcons.napster;
  if (value == 'neos') return FontAwesomeIcons.neos;
  if (value == 'networkWired') return FontAwesomeIcons.networkWired;
  if (value == 'neuter') return FontAwesomeIcons.neuter;
  if (value == 'solidNewspaper') return FontAwesomeIcons.solidNewspaper;
  if (value == 'newspaper') return FontAwesomeIcons.newspaper;
  if (value == 'nfcDirectional') return FontAwesomeIcons.nfcDirectional;
  if (value == 'nfcSymbol') return FontAwesomeIcons.nfcSymbol;
  if (value == 'nimblr') return FontAwesomeIcons.nimblr;
  if (value == 'node') return FontAwesomeIcons.node;
  if (value == 'nodeJs') return FontAwesomeIcons.nodeJs;
  if (value == 'notEqual') return FontAwesomeIcons.notEqual;
  if (value == 'notdef') return FontAwesomeIcons.notdef;
  if (value == 'solidNoteSticky') return FontAwesomeIcons.solidNoteSticky;
  if (value == 'solidStickyNote') return FontAwesomeIcons.solidStickyNote;
  if (value == 'noteSticky') return FontAwesomeIcons.noteSticky;
  if (value == 'stickyNote') return FontAwesomeIcons.stickyNote;
  if (value == 'notesMedical') return FontAwesomeIcons.notesMedical;
  if (value == 'npm') return FontAwesomeIcons.npm;
  if (value == 'ns8') return FontAwesomeIcons.ns8;
  if (value == 'nutritionix') return FontAwesomeIcons.nutritionix;
  if (value == 'o') return FontAwesomeIcons.o;
  if (value == 'solidObjectGroup') return FontAwesomeIcons.solidObjectGroup;
  if (value == 'objectGroup') return FontAwesomeIcons.objectGroup;
  if (value == 'solidObjectUngroup') return FontAwesomeIcons.solidObjectUngroup;
  if (value == 'objectUngroup') return FontAwesomeIcons.objectUngroup;
  if (value == 'octopusDeploy') return FontAwesomeIcons.octopusDeploy;
  if (value == 'odnoklassniki') return FontAwesomeIcons.odnoklassniki;
  if (value == 'odysee') return FontAwesomeIcons.odysee;
  if (value == 'oilCan') return FontAwesomeIcons.oilCan;
  if (value == 'oilWell') return FontAwesomeIcons.oilWell;
  if (value == 'oldRepublic') return FontAwesomeIcons.oldRepublic;
  if (value == 'om') return FontAwesomeIcons.om;
  if (value == 'opencart') return FontAwesomeIcons.opencart;
  if (value == 'openid') return FontAwesomeIcons.openid;
  if (value == 'opensuse') return FontAwesomeIcons.opensuse;
  if (value == 'opera') return FontAwesomeIcons.opera;
  if (value == 'optinMonster') return FontAwesomeIcons.optinMonster;
  if (value == 'orcid') return FontAwesomeIcons.orcid;
  if (value == 'osi') return FontAwesomeIcons.osi;
  if (value == 'otter') return FontAwesomeIcons.otter;
  if (value == 'outdent') return FontAwesomeIcons.outdent;
  if (value == 'dedent') return FontAwesomeIcons.dedent;
  if (value == 'p') return FontAwesomeIcons.p;
  if (value == 'padlet') return FontAwesomeIcons.padlet;
  if (value == 'page4') return FontAwesomeIcons.page4;
  if (value == 'pagelines') return FontAwesomeIcons.pagelines;
  if (value == 'pager') return FontAwesomeIcons.pager;
  if (value == 'paintRoller') return FontAwesomeIcons.paintRoller;
  if (value == 'paintbrush') return FontAwesomeIcons.paintbrush;
  if (value == 'paintBrush') return FontAwesomeIcons.paintBrush;
  if (value == 'palette') return FontAwesomeIcons.palette;
  if (value == 'palfed') return FontAwesomeIcons.palfed;
  if (value == 'pallet') return FontAwesomeIcons.pallet;
  if (value == 'panorama') return FontAwesomeIcons.panorama;
  if (value == 'solidPaperPlane') return FontAwesomeIcons.solidPaperPlane;
  if (value == 'paperPlane') return FontAwesomeIcons.paperPlane;
  if (value == 'paperclip') return FontAwesomeIcons.paperclip;
  if (value == 'parachuteBox') return FontAwesomeIcons.parachuteBox;
  if (value == 'paragraph') return FontAwesomeIcons.paragraph;
  if (value == 'passport') return FontAwesomeIcons.passport;
  if (value == 'solidPaste') return FontAwesomeIcons.solidPaste;
  if (value == 'solidFileClipboard') return FontAwesomeIcons.solidFileClipboard;
  if (value == 'paste') return FontAwesomeIcons.paste;
  if (value == 'fileClipboard') return FontAwesomeIcons.fileClipboard;
  if (value == 'patreon') return FontAwesomeIcons.patreon;
  if (value == 'pause') return FontAwesomeIcons.pause;
  if (value == 'paw') return FontAwesomeIcons.paw;
  if (value == 'paypal') return FontAwesomeIcons.paypal;
  if (value == 'peace') return FontAwesomeIcons.peace;
  if (value == 'pen') return FontAwesomeIcons.pen;
  if (value == 'penClip') return FontAwesomeIcons.penClip;
  if (value == 'penAlt') return FontAwesomeIcons.penAlt;
  if (value == 'penFancy') return FontAwesomeIcons.penFancy;
  if (value == 'penNib') return FontAwesomeIcons.penNib;
  if (value == 'penRuler') return FontAwesomeIcons.penRuler;
  if (value == 'pencilRuler') return FontAwesomeIcons.pencilRuler;
  if (value == 'solidPenToSquare') return FontAwesomeIcons.solidPenToSquare;
  if (value == 'solidEdit') return FontAwesomeIcons.solidEdit;
  if (value == 'penToSquare') return FontAwesomeIcons.penToSquare;
  if (value == 'edit') return FontAwesomeIcons.edit;
  if (value == 'pencil') return FontAwesomeIcons.pencil;
  if (value == 'pencilAlt') return FontAwesomeIcons.pencilAlt;
  if (value == 'peopleArrows') return FontAwesomeIcons.peopleArrows;
  if (value == 'peopleArrowsLeftRight') return FontAwesomeIcons.peopleArrowsLeftRight;
  if (value == 'peopleCarryBox') return FontAwesomeIcons.peopleCarryBox;
  if (value == 'peopleCarry') return FontAwesomeIcons.peopleCarry;
  if (value == 'peopleGroup') return FontAwesomeIcons.peopleGroup;
  if (value == 'peopleLine') return FontAwesomeIcons.peopleLine;
  if (value == 'peoplePulling') return FontAwesomeIcons.peoplePulling;
  if (value == 'peopleRobbery') return FontAwesomeIcons.peopleRobbery;
  if (value == 'peopleRoof') return FontAwesomeIcons.peopleRoof;
  if (value == 'pepperHot') return FontAwesomeIcons.pepperHot;
  if (value == 'perbyte') return FontAwesomeIcons.perbyte;
  if (value == 'percent') return FontAwesomeIcons.percent;
  if (value == 'percentage') return FontAwesomeIcons.percentage;
  if (value == 'periscope') return FontAwesomeIcons.periscope;
  if (value == 'person') return FontAwesomeIcons.person;
  if (value == 'male') return FontAwesomeIcons.male;
  if (value == 'personArrowDownToLine') return FontAwesomeIcons.personArrowDownToLine;
  if (value == 'personArrowUpFromLine') return FontAwesomeIcons.personArrowUpFromLine;
  if (value == 'personBiking') return FontAwesomeIcons.personBiking;
  if (value == 'biking') return FontAwesomeIcons.biking;
  if (value == 'personBooth') return FontAwesomeIcons.personBooth;
  if (value == 'personBreastfeeding') return FontAwesomeIcons.personBreastfeeding;
  if (value == 'personBurst') return FontAwesomeIcons.personBurst;
  if (value == 'personCane') return FontAwesomeIcons.personCane;
  if (value == 'personChalkboard') return FontAwesomeIcons.personChalkboard;
  if (value == 'personCircleCheck') return FontAwesomeIcons.personCircleCheck;
  if (value == 'personCircleExclamation') return FontAwesomeIcons.personCircleExclamation;
  if (value == 'personCircleMinus') return FontAwesomeIcons.personCircleMinus;
  if (value == 'personCirclePlus') return FontAwesomeIcons.personCirclePlus;
  if (value == 'personCircleQuestion') return FontAwesomeIcons.personCircleQuestion;
  if (value == 'personCircleXmark') return FontAwesomeIcons.personCircleXmark;
  if (value == 'personDigging') return FontAwesomeIcons.personDigging;
  if (value == 'digging') return FontAwesomeIcons.digging;
  if (value == 'personDotsFromLine') return FontAwesomeIcons.personDotsFromLine;
  if (value == 'diagnoses') return FontAwesomeIcons.diagnoses;
  if (value == 'personDress') return FontAwesomeIcons.personDress;
  if (value == 'female') return FontAwesomeIcons.female;
  if (value == 'personDressBurst') return FontAwesomeIcons.personDressBurst;
  if (value == 'personDrowning') return FontAwesomeIcons.personDrowning;
  if (value == 'personFalling') return FontAwesomeIcons.personFalling;
  if (value == 'personFallingBurst') return FontAwesomeIcons.personFallingBurst;
  if (value == 'personHalfDress') return FontAwesomeIcons.personHalfDress;
  if (value == 'personHarassing') return FontAwesomeIcons.personHarassing;
  if (value == 'personHiking') return FontAwesomeIcons.personHiking;
  if (value == 'hiking') return FontAwesomeIcons.hiking;
  if (value == 'personMilitaryPointing') return FontAwesomeIcons.personMilitaryPointing;
  if (value == 'personMilitaryRifle') return FontAwesomeIcons.personMilitaryRifle;
  if (value == 'personMilitaryToPerson') return FontAwesomeIcons.personMilitaryToPerson;
  if (value == 'personPraying') return FontAwesomeIcons.personPraying;
  if (value == 'pray') return FontAwesomeIcons.pray;
  if (value == 'personPregnant') return FontAwesomeIcons.personPregnant;
  if (value == 'personRays') return FontAwesomeIcons.personRays;
  if (value == 'personRifle') return FontAwesomeIcons.personRifle;
  if (value == 'personRunning') return FontAwesomeIcons.personRunning;
  if (value == 'running') return FontAwesomeIcons.running;
  if (value == 'personShelter') return FontAwesomeIcons.personShelter;
  if (value == 'personSkating') return FontAwesomeIcons.personSkating;
  if (value == 'skating') return FontAwesomeIcons.skating;
  if (value == 'personSkiing') return FontAwesomeIcons.personSkiing;
  if (value == 'skiing') return FontAwesomeIcons.skiing;
  if (value == 'personSkiingNordic') return FontAwesomeIcons.personSkiingNordic;
  if (value == 'skiingNordic') return FontAwesomeIcons.skiingNordic;
  if (value == 'personSnowboarding') return FontAwesomeIcons.personSnowboarding;
  if (value == 'snowboarding') return FontAwesomeIcons.snowboarding;
  if (value == 'personSwimming') return FontAwesomeIcons.personSwimming;
  if (value == 'swimmer') return FontAwesomeIcons.swimmer;
  if (value == 'personThroughWindow') return FontAwesomeIcons.personThroughWindow;
  if (value == 'personWalking') return FontAwesomeIcons.personWalking;
  if (value == 'walking') return FontAwesomeIcons.walking;
  if (value == 'personWalkingArrowLoopLeft') return FontAwesomeIcons.personWalkingArrowLoopLeft;
  if (value == 'personWalkingArrowRight') return FontAwesomeIcons.personWalkingArrowRight;
  if (value == 'personWalkingDashedLineArrowRight') return FontAwesomeIcons.personWalkingDashedLineArrowRight;
  if (value == 'personWalkingLuggage') return FontAwesomeIcons.personWalkingLuggage;
  if (value == 'personWalkingWithCane') return FontAwesomeIcons.personWalkingWithCane;
  if (value == 'blind') return FontAwesomeIcons.blind;
  if (value == 'pesetaSign') return FontAwesomeIcons.pesetaSign;
  if (value == 'pesoSign') return FontAwesomeIcons.pesoSign;
  if (value == 'phabricator') return FontAwesomeIcons.phabricator;
  if (value == 'phoenixFramework') return FontAwesomeIcons.phoenixFramework;
  if (value == 'phoenixSquadron') return FontAwesomeIcons.phoenixSquadron;
  if (value == 'phone') return FontAwesomeIcons.phone;
  if (value == 'phoneFlip') return FontAwesomeIcons.phoneFlip;
  if (value == 'phoneAlt') return FontAwesomeIcons.phoneAlt;
  if (value == 'phoneSlash') return FontAwesomeIcons.phoneSlash;
  if (value == 'phoneVolume') return FontAwesomeIcons.phoneVolume;
  if (value == 'volumeControlPhone') return FontAwesomeIcons.volumeControlPhone;
  if (value == 'photoFilm') return FontAwesomeIcons.photoFilm;
  if (value == 'photoVideo') return FontAwesomeIcons.photoVideo;
  if (value == 'php') return FontAwesomeIcons.php;
  if (value == 'piedPiper') return FontAwesomeIcons.piedPiper;
  if (value == 'piedPiperAlt') return FontAwesomeIcons.piedPiperAlt;
  if (value == 'piedPiperHat') return FontAwesomeIcons.piedPiperHat;
  if (value == 'piedPiperPp') return FontAwesomeIcons.piedPiperPp;
  if (value == 'piggyBank') return FontAwesomeIcons.piggyBank;
  if (value == 'pills') return FontAwesomeIcons.pills;
  if (value == 'pinterest') return FontAwesomeIcons.pinterest;
  if (value == 'pinterestP') return FontAwesomeIcons.pinterestP;
  if (value == 'pix') return FontAwesomeIcons.pix;
  if (value == 'pixiv') return FontAwesomeIcons.pixiv;
  if (value == 'pizzaSlice') return FontAwesomeIcons.pizzaSlice;
  if (value == 'placeOfWorship') return FontAwesomeIcons.placeOfWorship;
  if (value == 'plane') return FontAwesomeIcons.plane;
  if (value == 'planeArrival') return FontAwesomeIcons.planeArrival;
  if (value == 'planeCircleCheck') return FontAwesomeIcons.planeCircleCheck;
  if (value == 'planeCircleExclamation') return FontAwesomeIcons.planeCircleExclamation;
  if (value == 'planeCircleXmark') return FontAwesomeIcons.planeCircleXmark;
  if (value == 'planeDeparture') return FontAwesomeIcons.planeDeparture;
  if (value == 'planeLock') return FontAwesomeIcons.planeLock;
  if (value == 'planeSlash') return FontAwesomeIcons.planeSlash;
  if (value == 'planeUp') return FontAwesomeIcons.planeUp;
  if (value == 'plantWilt') return FontAwesomeIcons.plantWilt;
  if (value == 'plateWheat') return FontAwesomeIcons.plateWheat;
  if (value == 'play') return FontAwesomeIcons.play;
  if (value == 'playstation') return FontAwesomeIcons.playstation;
  if (value == 'plug') return FontAwesomeIcons.plug;
  if (value == 'plugCircleBolt') return FontAwesomeIcons.plugCircleBolt;
  if (value == 'plugCircleCheck') return FontAwesomeIcons.plugCircleCheck;
  if (value == 'plugCircleExclamation') return FontAwesomeIcons.plugCircleExclamation;
  if (value == 'plugCircleMinus') return FontAwesomeIcons.plugCircleMinus;
  if (value == 'plugCirclePlus') return FontAwesomeIcons.plugCirclePlus;
  if (value == 'plugCircleXmark') return FontAwesomeIcons.plugCircleXmark;
  if (value == 'plus') return FontAwesomeIcons.plus;
  if (value == 'add') return FontAwesomeIcons.add;
  if (value == 'plusMinus') return FontAwesomeIcons.plusMinus;
  if (value == 'podcast') return FontAwesomeIcons.podcast;
  if (value == 'poo') return FontAwesomeIcons.poo;
  if (value == 'pooStorm') return FontAwesomeIcons.pooStorm;
  if (value == 'pooBolt') return FontAwesomeIcons.pooBolt;
  if (value == 'poop') return FontAwesomeIcons.poop;
  if (value == 'powerOff') return FontAwesomeIcons.powerOff;
  if (value == 'prescription') return FontAwesomeIcons.prescription;
  if (value == 'prescriptionBottle') return FontAwesomeIcons.prescriptionBottle;
  if (value == 'prescriptionBottleMedical') return FontAwesomeIcons.prescriptionBottleMedical;
  if (value == 'prescriptionBottleAlt') return FontAwesomeIcons.prescriptionBottleAlt;
  if (value == 'print') return FontAwesomeIcons.print;
  if (value == 'productHunt') return FontAwesomeIcons.productHunt;
  if (value == 'pumpMedical') return FontAwesomeIcons.pumpMedical;
  if (value == 'pumpSoap') return FontAwesomeIcons.pumpSoap;
  if (value == 'pushed') return FontAwesomeIcons.pushed;
  if (value == 'puzzlePiece') return FontAwesomeIcons.puzzlePiece;
  if (value == 'python') return FontAwesomeIcons.python;
  if (value == 'q') return FontAwesomeIcons.q;
  if (value == 'qq') return FontAwesomeIcons.qq;
  if (value == 'qrcode') return FontAwesomeIcons.qrcode;
  if (value == 'question') return FontAwesomeIcons.question;
  if (value == 'quinscape') return FontAwesomeIcons.quinscape;
  if (value == 'quora') return FontAwesomeIcons.quora;
  if (value == 'quoteLeft') return FontAwesomeIcons.quoteLeft;
  if (value == 'quoteLeftAlt') return FontAwesomeIcons.quoteLeftAlt;
  if (value == 'quoteRight') return FontAwesomeIcons.quoteRight;
  if (value == 'quoteRightAlt') return FontAwesomeIcons.quoteRightAlt;
  if (value == 'r') return FontAwesomeIcons.r;
  if (value == 'rProject') return FontAwesomeIcons.rProject;
  if (value == 'radiation') return FontAwesomeIcons.radiation;
  if (value == 'radio') return FontAwesomeIcons.radio;
  if (value == 'rainbow') return FontAwesomeIcons.rainbow;
  if (value == 'rankingStar') return FontAwesomeIcons.rankingStar;
  if (value == 'raspberryPi') return FontAwesomeIcons.raspberryPi;
  if (value == 'ravelry') return FontAwesomeIcons.ravelry;
  if (value == 'react') return FontAwesomeIcons.react;
  if (value == 'reacteurope') return FontAwesomeIcons.reacteurope;
  if (value == 'readme') return FontAwesomeIcons.readme;
  if (value == 'rebel') return FontAwesomeIcons.rebel;
  if (value == 'receipt') return FontAwesomeIcons.receipt;
  if (value == 'recordVinyl') return FontAwesomeIcons.recordVinyl;
  if (value == 'rectangleAd') return FontAwesomeIcons.rectangleAd;
  if (value == 'ad') return FontAwesomeIcons.ad;
  if (value == 'solidRectangleList') return FontAwesomeIcons.solidRectangleList;
  if (value == 'solidListAlt') return FontAwesomeIcons.solidListAlt;
  if (value == 'rectangleList') return FontAwesomeIcons.rectangleList;
  if (value == 'listAlt') return FontAwesomeIcons.listAlt;
  if (value == 'solidRectangleXmark') return FontAwesomeIcons.solidRectangleXmark;
  if (value == 'solidRectangleTimes') return FontAwesomeIcons.solidRectangleTimes;
  if (value == 'solidTimesRectangle') return FontAwesomeIcons.solidTimesRectangle;
  if (value == 'solidWindowClose') return FontAwesomeIcons.solidWindowClose;
  if (value == 'rectangleXmark') return FontAwesomeIcons.rectangleXmark;
  if (value == 'rectangleTimes') return FontAwesomeIcons.rectangleTimes;
  if (value == 'timesRectangle') return FontAwesomeIcons.timesRectangle;
  if (value == 'windowClose') return FontAwesomeIcons.windowClose;
  if (value == 'recycle') return FontAwesomeIcons.recycle;
  if (value == 'redRiver') return FontAwesomeIcons.redRiver;
  if (value == 'reddit') return FontAwesomeIcons.reddit;
  if (value == 'redditAlien') return FontAwesomeIcons.redditAlien;
  if (value == 'redhat') return FontAwesomeIcons.redhat;
  if (value == 'solidRegistered') return FontAwesomeIcons.solidRegistered;
  if (value == 'registered') return FontAwesomeIcons.registered;
  if (value == 'renren') return FontAwesomeIcons.renren;
  if (value == 'repeat') return FontAwesomeIcons.repeat;
  if (value == 'reply') return FontAwesomeIcons.reply;
  if (value == 'mailReply') return FontAwesomeIcons.mailReply;
  if (value == 'replyAll') return FontAwesomeIcons.replyAll;
  if (value == 'mailReplyAll') return FontAwesomeIcons.mailReplyAll;
  if (value == 'replyd') return FontAwesomeIcons.replyd;
  if (value == 'republican') return FontAwesomeIcons.republican;
  if (value == 'researchgate') return FontAwesomeIcons.researchgate;
  if (value == 'resolving') return FontAwesomeIcons.resolving;
  if (value == 'restroom') return FontAwesomeIcons.restroom;
  if (value == 'retweet') return FontAwesomeIcons.retweet;
  if (value == 'rev') return FontAwesomeIcons.rev;
  if (value == 'ribbon') return FontAwesomeIcons.ribbon;
  if (value == 'rightFromBracket') return FontAwesomeIcons.rightFromBracket;
  if (value == 'signOutAlt') return FontAwesomeIcons.signOutAlt;
  if (value == 'rightLeft') return FontAwesomeIcons.rightLeft;
  if (value == 'exchangeAlt') return FontAwesomeIcons.exchangeAlt;
  if (value == 'rightLong') return FontAwesomeIcons.rightLong;
  if (value == 'longArrowAltRight') return FontAwesomeIcons.longArrowAltRight;
  if (value == 'rightToBracket') return FontAwesomeIcons.rightToBracket;
  if (value == 'signInAlt') return FontAwesomeIcons.signInAlt;
  if (value == 'ring') return FontAwesomeIcons.ring;
  if (value == 'road') return FontAwesomeIcons.road;
  if (value == 'roadBarrier') return FontAwesomeIcons.roadBarrier;
  if (value == 'roadBridge') return FontAwesomeIcons.roadBridge;
  if (value == 'roadCircleCheck') return FontAwesomeIcons.roadCircleCheck;
  if (value == 'roadCircleExclamation') return FontAwesomeIcons.roadCircleExclamation;
  if (value == 'roadCircleXmark') return FontAwesomeIcons.roadCircleXmark;
  if (value == 'roadLock') return FontAwesomeIcons.roadLock;
  if (value == 'roadSpikes') return FontAwesomeIcons.roadSpikes;
  if (value == 'robot') return FontAwesomeIcons.robot;
  if (value == 'rocket') return FontAwesomeIcons.rocket;
  if (value == 'rocketchat') return FontAwesomeIcons.rocketchat;
  if (value == 'rockrms') return FontAwesomeIcons.rockrms;
  if (value == 'rotate') return FontAwesomeIcons.rotate;
  if (value == 'syncAlt') return FontAwesomeIcons.syncAlt;
  if (value == 'rotateLeft') return FontAwesomeIcons.rotateLeft;
  if (value == 'rotateBack') return FontAwesomeIcons.rotateBack;
  if (value == 'rotateBackward') return FontAwesomeIcons.rotateBackward;
  if (value == 'undoAlt') return FontAwesomeIcons.undoAlt;
  if (value == 'rotateRight') return FontAwesomeIcons.rotateRight;
  if (value == 'redoAlt') return FontAwesomeIcons.redoAlt;
  if (value == 'rotateForward') return FontAwesomeIcons.rotateForward;
  if (value == 'route') return FontAwesomeIcons.route;
  if (value == 'rss') return FontAwesomeIcons.rss;
  if (value == 'feed') return FontAwesomeIcons.feed;
  if (value == 'rubleSign') return FontAwesomeIcons.rubleSign;
  if (value == 'rouble') return FontAwesomeIcons.rouble;
  if (value == 'rub') return FontAwesomeIcons.rub;
  if (value == 'ruble') return FontAwesomeIcons.ruble;
  if (value == 'rug') return FontAwesomeIcons.rug;
  if (value == 'ruler') return FontAwesomeIcons.ruler;
  if (value == 'rulerCombined') return FontAwesomeIcons.rulerCombined;
  if (value == 'rulerHorizontal') return FontAwesomeIcons.rulerHorizontal;
  if (value == 'rulerVertical') return FontAwesomeIcons.rulerVertical;
  if (value == 'rupeeSign') return FontAwesomeIcons.rupeeSign;
  if (value == 'rupee') return FontAwesomeIcons.rupee;
  if (value == 'rupiahSign') return FontAwesomeIcons.rupiahSign;
  if (value == 'rust') return FontAwesomeIcons.rust;
  if (value == 's') return FontAwesomeIcons.s;
  if (value == 'sackDollar') return FontAwesomeIcons.sackDollar;
  if (value == 'sackXmark') return FontAwesomeIcons.sackXmark;
  if (value == 'safari') return FontAwesomeIcons.safari;
  if (value == 'sailboat') return FontAwesomeIcons.sailboat;
  if (value == 'salesforce') return FontAwesomeIcons.salesforce;
  if (value == 'sass') return FontAwesomeIcons.sass;
  if (value == 'satellite') return FontAwesomeIcons.satellite;
  if (value == 'satelliteDish') return FontAwesomeIcons.satelliteDish;
  if (value == 'scaleBalanced') return FontAwesomeIcons.scaleBalanced;
  if (value == 'balanceScale') return FontAwesomeIcons.balanceScale;
  if (value == 'scaleUnbalanced') return FontAwesomeIcons.scaleUnbalanced;
  if (value == 'balanceScaleLeft') return FontAwesomeIcons.balanceScaleLeft;
  if (value == 'scaleUnbalancedFlip') return FontAwesomeIcons.scaleUnbalancedFlip;
  if (value == 'balanceScaleRight') return FontAwesomeIcons.balanceScaleRight;
  if (value == 'schlix') return FontAwesomeIcons.schlix;
  if (value == 'school') return FontAwesomeIcons.school;
  if (value == 'schoolCircleCheck') return FontAwesomeIcons.schoolCircleCheck;
  if (value == 'schoolCircleExclamation') return FontAwesomeIcons.schoolCircleExclamation;
  if (value == 'schoolCircleXmark') return FontAwesomeIcons.schoolCircleXmark;
  if (value == 'schoolFlag') return FontAwesomeIcons.schoolFlag;
  if (value == 'schoolLock') return FontAwesomeIcons.schoolLock;
  if (value == 'scissors') return FontAwesomeIcons.scissors;
  if (value == 'cut') return FontAwesomeIcons.cut;
  if (value == 'screenpal') return FontAwesomeIcons.screenpal;
  if (value == 'screwdriver') return FontAwesomeIcons.screwdriver;
  if (value == 'screwdriverWrench') return FontAwesomeIcons.screwdriverWrench;
  if (value == 'tools') return FontAwesomeIcons.tools;
  if (value == 'scribd') return FontAwesomeIcons.scribd;
  if (value == 'scroll') return FontAwesomeIcons.scroll;
  if (value == 'scrollTorah') return FontAwesomeIcons.scrollTorah;
  if (value == 'torah') return FontAwesomeIcons.torah;
  if (value == 'sdCard') return FontAwesomeIcons.sdCard;
  if (value == 'searchengin') return FontAwesomeIcons.searchengin;
  if (value == 'section') return FontAwesomeIcons.section;
  if (value == 'seedling') return FontAwesomeIcons.seedling;
  if (value == 'sprout') return FontAwesomeIcons.sprout;
  if (value == 'sellcast') return FontAwesomeIcons.sellcast;
  if (value == 'sellsy') return FontAwesomeIcons.sellsy;
  if (value == 'server') return FontAwesomeIcons.server;
  if (value == 'servicestack') return FontAwesomeIcons.servicestack;
  if (value == 'shapes') return FontAwesomeIcons.shapes;
  if (value == 'triangleCircleSquare') return FontAwesomeIcons.triangleCircleSquare;
  if (value == 'share') return FontAwesomeIcons.share;
  if (value == 'mailForward') return FontAwesomeIcons.mailForward;
  if (value == 'solidShareFromSquare') return FontAwesomeIcons.solidShareFromSquare;
  if (value == 'solidShareSquare') return FontAwesomeIcons.solidShareSquare;
  if (value == 'shareFromSquare') return FontAwesomeIcons.shareFromSquare;
  if (value == 'shareSquare') return FontAwesomeIcons.shareSquare;
  if (value == 'shareNodes') return FontAwesomeIcons.shareNodes;
  if (value == 'shareAlt') return FontAwesomeIcons.shareAlt;
  if (value == 'sheetPlastic') return FontAwesomeIcons.sheetPlastic;
  if (value == 'shekelSign') return FontAwesomeIcons.shekelSign;
  if (value == 'ils') return FontAwesomeIcons.ils;
  if (value == 'shekel') return FontAwesomeIcons.shekel;
  if (value == 'sheqel') return FontAwesomeIcons.sheqel;
  if (value == 'sheqelSign') return FontAwesomeIcons.sheqelSign;
  if (value == 'shield') return FontAwesomeIcons.shield;
  if (value == 'shieldBlank') return FontAwesomeIcons.shieldBlank;
  if (value == 'shieldCat') return FontAwesomeIcons.shieldCat;
  if (value == 'shieldDog') return FontAwesomeIcons.shieldDog;
  if (value == 'shieldHalved') return FontAwesomeIcons.shieldHalved;
  if (value == 'shieldAlt') return FontAwesomeIcons.shieldAlt;
  if (value == 'shieldHeart') return FontAwesomeIcons.shieldHeart;
  if (value == 'shieldVirus') return FontAwesomeIcons.shieldVirus;
  if (value == 'ship') return FontAwesomeIcons.ship;
  if (value == 'shirt') return FontAwesomeIcons.shirt;
  if (value == 'tShirt') return FontAwesomeIcons.tShirt;
  if (value == 'tshirt') return FontAwesomeIcons.tshirt;
  if (value == 'shirtsinbulk') return FontAwesomeIcons.shirtsinbulk;
  if (value == 'shoePrints') return FontAwesomeIcons.shoePrints;
  if (value == 'shoelace') return FontAwesomeIcons.shoelace;
  if (value == 'shop') return FontAwesomeIcons.shop;
  if (value == 'storeAlt') return FontAwesomeIcons.storeAlt;
  if (value == 'shopLock') return FontAwesomeIcons.shopLock;
  if (value == 'shopSlash') return FontAwesomeIcons.shopSlash;
  if (value == 'storeAltSlash') return FontAwesomeIcons.storeAltSlash;
  if (value == 'shopify') return FontAwesomeIcons.shopify;
  if (value == 'shopware') return FontAwesomeIcons.shopware;
  if (value == 'shower') return FontAwesomeIcons.shower;
  if (value == 'shrimp') return FontAwesomeIcons.shrimp;
  if (value == 'shuffle') return FontAwesomeIcons.shuffle;
  if (value == 'random') return FontAwesomeIcons.random;
  if (value == 'shuttleSpace') return FontAwesomeIcons.shuttleSpace;
  if (value == 'spaceShuttle') return FontAwesomeIcons.spaceShuttle;
  if (value == 'signHanging') return FontAwesomeIcons.signHanging;
  if (value == 'sign') return FontAwesomeIcons.sign;
  if (value == 'signal') return FontAwesomeIcons.signal;
  if (value == 'signal5') return FontAwesomeIcons.signal5;
  if (value == 'signalPerfect') return FontAwesomeIcons.signalPerfect;
  if (value == 'signalMessenger') return FontAwesomeIcons.signalMessenger;
  if (value == 'signature') return FontAwesomeIcons.signature;
  if (value == 'signsPost') return FontAwesomeIcons.signsPost;
  if (value == 'mapSigns') return FontAwesomeIcons.mapSigns;
  if (value == 'simCard') return FontAwesomeIcons.simCard;
  if (value == 'simplybuilt') return FontAwesomeIcons.simplybuilt;
  if (value == 'sink') return FontAwesomeIcons.sink;
  if (value == 'sistrix') return FontAwesomeIcons.sistrix;
  if (value == 'sitemap') return FontAwesomeIcons.sitemap;
  if (value == 'sith') return FontAwesomeIcons.sith;
  if (value == 'sitrox') return FontAwesomeIcons.sitrox;
  if (value == 'sketch') return FontAwesomeIcons.sketch;
  if (value == 'skull') return FontAwesomeIcons.skull;
  if (value == 'skullCrossbones') return FontAwesomeIcons.skullCrossbones;
  if (value == 'skyatlas') return FontAwesomeIcons.skyatlas;
  if (value == 'skype') return FontAwesomeIcons.skype;
  if (value == 'slack') return FontAwesomeIcons.slack;
  if (value == 'slackHash') return FontAwesomeIcons.slackHash;
  if (value == 'slash') return FontAwesomeIcons.slash;
  if (value == 'sleigh') return FontAwesomeIcons.sleigh;
  if (value == 'sliders') return FontAwesomeIcons.sliders;
  if (value == 'slidersH') return FontAwesomeIcons.slidersH;
  if (value == 'slideshare') return FontAwesomeIcons.slideshare;
  if (value == 'smog') return FontAwesomeIcons.smog;
  if (value == 'smoking') return FontAwesomeIcons.smoking;
  if (value == 'snapchat') return FontAwesomeIcons.snapchat;
  if (value == 'snapchatGhost') return FontAwesomeIcons.snapchatGhost;
  if (value == 'solidSnowflake') return FontAwesomeIcons.solidSnowflake;
  if (value == 'snowflake') return FontAwesomeIcons.snowflake;
  if (value == 'snowman') return FontAwesomeIcons.snowman;
  if (value == 'snowplow') return FontAwesomeIcons.snowplow;
  if (value == 'soap') return FontAwesomeIcons.soap;
  if (value == 'socks') return FontAwesomeIcons.socks;
  if (value == 'solarPanel') return FontAwesomeIcons.solarPanel;
  if (value == 'sort') return FontAwesomeIcons.sort;
  if (value == 'unsorted') return FontAwesomeIcons.unsorted;
  if (value == 'sortDown') return FontAwesomeIcons.sortDown;
  if (value == 'sortDesc') return FontAwesomeIcons.sortDesc;
  if (value == 'sortUp') return FontAwesomeIcons.sortUp;
  if (value == 'sortAsc') return FontAwesomeIcons.sortAsc;
  if (value == 'soundcloud') return FontAwesomeIcons.soundcloud;
  if (value == 'sourcetree') return FontAwesomeIcons.sourcetree;
  if (value == 'spa') return FontAwesomeIcons.spa;
  if (value == 'spaceAwesome') return FontAwesomeIcons.spaceAwesome;
  if (value == 'spaghettiMonsterFlying') return FontAwesomeIcons.spaghettiMonsterFlying;
  if (value == 'pastafarianism') return FontAwesomeIcons.pastafarianism;
  if (value == 'speakap') return FontAwesomeIcons.speakap;
  if (value == 'speakerDeck') return FontAwesomeIcons.speakerDeck;
  if (value == 'spellCheck') return FontAwesomeIcons.spellCheck;
  if (value == 'spider') return FontAwesomeIcons.spider;
  if (value == 'spinner') return FontAwesomeIcons.spinner;
  if (value == 'splotch') return FontAwesomeIcons.splotch;
  if (value == 'spoon') return FontAwesomeIcons.spoon;
  if (value == 'utensilSpoon') return FontAwesomeIcons.utensilSpoon;
  if (value == 'spotify') return FontAwesomeIcons.spotify;
  if (value == 'sprayCan') return FontAwesomeIcons.sprayCan;
  if (value == 'sprayCanSparkles') return FontAwesomeIcons.sprayCanSparkles;
  if (value == 'airFreshener') return FontAwesomeIcons.airFreshener;
  if (value == 'solidSquare') return FontAwesomeIcons.solidSquare;
  if (value == 'square') return FontAwesomeIcons.square;
  if (value == 'squareArrowUpRight') return FontAwesomeIcons.squareArrowUpRight;
  if (value == 'externalLinkSquare') return FontAwesomeIcons.externalLinkSquare;
  if (value == 'squareBehance') return FontAwesomeIcons.squareBehance;
  if (value == 'behanceSquare') return FontAwesomeIcons.behanceSquare;
  if (value == 'solidSquareCaretDown') return FontAwesomeIcons.solidSquareCaretDown;
  if (value == 'solidCaretSquareDown') return FontAwesomeIcons.solidCaretSquareDown;
  if (value == 'squareCaretDown') return FontAwesomeIcons.squareCaretDown;
  if (value == 'caretSquareDown') return FontAwesomeIcons.caretSquareDown;
  if (value == 'solidSquareCaretLeft') return FontAwesomeIcons.solidSquareCaretLeft;
  if (value == 'solidCaretSquareLeft') return FontAwesomeIcons.solidCaretSquareLeft;
  if (value == 'squareCaretLeft') return FontAwesomeIcons.squareCaretLeft;
  if (value == 'caretSquareLeft') return FontAwesomeIcons.caretSquareLeft;
  if (value == 'solidSquareCaretRight') return FontAwesomeIcons.solidSquareCaretRight;
  if (value == 'solidCaretSquareRight') return FontAwesomeIcons.solidCaretSquareRight;
  if (value == 'squareCaretRight') return FontAwesomeIcons.squareCaretRight;
  if (value == 'caretSquareRight') return FontAwesomeIcons.caretSquareRight;
  if (value == 'solidSquareCaretUp') return FontAwesomeIcons.solidSquareCaretUp;
  if (value == 'solidCaretSquareUp') return FontAwesomeIcons.solidCaretSquareUp;
  if (value == 'squareCaretUp') return FontAwesomeIcons.squareCaretUp;
  if (value == 'caretSquareUp') return FontAwesomeIcons.caretSquareUp;
  if (value == 'solidSquareCheck') return FontAwesomeIcons.solidSquareCheck;
  if (value == 'solidCheckSquare') return FontAwesomeIcons.solidCheckSquare;
  if (value == 'squareCheck') return FontAwesomeIcons.squareCheck;
  if (value == 'checkSquare') return FontAwesomeIcons.checkSquare;
  if (value == 'squareDribbble') return FontAwesomeIcons.squareDribbble;
  if (value == 'dribbbleSquare') return FontAwesomeIcons.dribbbleSquare;
  if (value == 'squareEnvelope') return FontAwesomeIcons.squareEnvelope;
  if (value == 'envelopeSquare') return FontAwesomeIcons.envelopeSquare;
  if (value == 'squareFacebook') return FontAwesomeIcons.squareFacebook;
  if (value == 'facebookSquare') return FontAwesomeIcons.facebookSquare;
  if (value == 'squareFontAwesome') return FontAwesomeIcons.squareFontAwesome;
  if (value == 'squareFontAwesomeStroke') return FontAwesomeIcons.squareFontAwesomeStroke;
  if (value == 'fontAwesomeAlt') return FontAwesomeIcons.fontAwesomeAlt;
  if (value == 'solidSquareFull') return FontAwesomeIcons.solidSquareFull;
  if (value == 'squareFull') return FontAwesomeIcons.squareFull;
  if (value == 'squareGit') return FontAwesomeIcons.squareGit;
  if (value == 'gitSquare') return FontAwesomeIcons.gitSquare;
  if (value == 'squareGithub') return FontAwesomeIcons.squareGithub;
  if (value == 'githubSquare') return FontAwesomeIcons.githubSquare;
  if (value == 'squareGitlab') return FontAwesomeIcons.squareGitlab;
  if (value == 'gitlabSquare') return FontAwesomeIcons.gitlabSquare;
  if (value == 'squareGooglePlus') return FontAwesomeIcons.squareGooglePlus;
  if (value == 'googlePlusSquare') return FontAwesomeIcons.googlePlusSquare;
  if (value == 'squareH') return FontAwesomeIcons.squareH;
  if (value == 'hSquare') return FontAwesomeIcons.hSquare;
  if (value == 'squareHackerNews') return FontAwesomeIcons.squareHackerNews;
  if (value == 'hackerNewsSquare') return FontAwesomeIcons.hackerNewsSquare;
  if (value == 'squareInstagram') return FontAwesomeIcons.squareInstagram;
  if (value == 'instagramSquare') return FontAwesomeIcons.instagramSquare;
  if (value == 'squareJs') return FontAwesomeIcons.squareJs;
  if (value == 'jsSquare') return FontAwesomeIcons.jsSquare;
  if (value == 'squareLastfm') return FontAwesomeIcons.squareLastfm;
  if (value == 'lastfmSquare') return FontAwesomeIcons.lastfmSquare;
  if (value == 'squareLetterboxd') return FontAwesomeIcons.squareLetterboxd;
  if (value == 'solidSquareMinus') return FontAwesomeIcons.solidSquareMinus;
  if (value == 'solidMinusSquare') return FontAwesomeIcons.solidMinusSquare;
  if (value == 'squareMinus') return FontAwesomeIcons.squareMinus;
  if (value == 'minusSquare') return FontAwesomeIcons.minusSquare;
  if (value == 'squareNfi') return FontAwesomeIcons.squareNfi;
  if (value == 'squareOdnoklassniki') return FontAwesomeIcons.squareOdnoklassniki;
  if (value == 'odnoklassnikiSquare') return FontAwesomeIcons.odnoklassnikiSquare;
  if (value == 'squareParking') return FontAwesomeIcons.squareParking;
  if (value == 'parking') return FontAwesomeIcons.parking;
  if (value == 'squarePen') return FontAwesomeIcons.squarePen;
  if (value == 'penSquare') return FontAwesomeIcons.penSquare;
  if (value == 'pencilSquare') return FontAwesomeIcons.pencilSquare;
  if (value == 'squarePersonConfined') return FontAwesomeIcons.squarePersonConfined;
  if (value == 'squarePhone') return FontAwesomeIcons.squarePhone;
  if (value == 'phoneSquare') return FontAwesomeIcons.phoneSquare;
  if (value == 'squarePhoneFlip') return FontAwesomeIcons.squarePhoneFlip;
  if (value == 'phoneSquareAlt') return FontAwesomeIcons.phoneSquareAlt;
  if (value == 'squarePiedPiper') return FontAwesomeIcons.squarePiedPiper;
  if (value == 'piedPiperSquare') return FontAwesomeIcons.piedPiperSquare;
  if (value == 'squarePinterest') return FontAwesomeIcons.squarePinterest;
  if (value == 'pinterestSquare') return FontAwesomeIcons.pinterestSquare;
  if (value == 'solidSquarePlus') return FontAwesomeIcons.solidSquarePlus;
  if (value == 'solidPlusSquare') return FontAwesomeIcons.solidPlusSquare;
  if (value == 'squarePlus') return FontAwesomeIcons.squarePlus;
  if (value == 'plusSquare') return FontAwesomeIcons.plusSquare;
  if (value == 'squarePollHorizontal') return FontAwesomeIcons.squarePollHorizontal;
  if (value == 'pollH') return FontAwesomeIcons.pollH;
  if (value == 'squarePollVertical') return FontAwesomeIcons.squarePollVertical;
  if (value == 'poll') return FontAwesomeIcons.poll;
  if (value == 'squareReddit') return FontAwesomeIcons.squareReddit;
  if (value == 'redditSquare') return FontAwesomeIcons.redditSquare;
  if (value == 'squareRootVariable') return FontAwesomeIcons.squareRootVariable;
  if (value == 'squareRootAlt') return FontAwesomeIcons.squareRootAlt;
  if (value == 'squareRss') return FontAwesomeIcons.squareRss;
  if (value == 'rssSquare') return FontAwesomeIcons.rssSquare;
  if (value == 'squareShareNodes') return FontAwesomeIcons.squareShareNodes;
  if (value == 'shareAltSquare') return FontAwesomeIcons.shareAltSquare;
  if (value == 'squareSnapchat') return FontAwesomeIcons.squareSnapchat;
  if (value == 'snapchatSquare') return FontAwesomeIcons.snapchatSquare;
  if (value == 'squareSteam') return FontAwesomeIcons.squareSteam;
  if (value == 'steamSquare') return FontAwesomeIcons.steamSquare;
  if (value == 'squareThreads') return FontAwesomeIcons.squareThreads;
  if (value == 'squareTumblr') return FontAwesomeIcons.squareTumblr;
  if (value == 'tumblrSquare') return FontAwesomeIcons.tumblrSquare;
  if (value == 'squareTwitter') return FontAwesomeIcons.squareTwitter;
  if (value == 'twitterSquare') return FontAwesomeIcons.twitterSquare;
  if (value == 'squareUpRight') return FontAwesomeIcons.squareUpRight;
  if (value == 'externalLinkSquareAlt') return FontAwesomeIcons.externalLinkSquareAlt;
  if (value == 'squareViadeo') return FontAwesomeIcons.squareViadeo;
  if (value == 'viadeoSquare') return FontAwesomeIcons.viadeoSquare;
  if (value == 'squareVimeo') return FontAwesomeIcons.squareVimeo;
  if (value == 'vimeoSquare') return FontAwesomeIcons.vimeoSquare;
  if (value == 'squareVirus') return FontAwesomeIcons.squareVirus;
  if (value == 'squareWhatsapp') return FontAwesomeIcons.squareWhatsapp;
  if (value == 'whatsappSquare') return FontAwesomeIcons.whatsappSquare;
  if (value == 'squareXTwitter') return FontAwesomeIcons.squareXTwitter;
  if (value == 'squareXing') return FontAwesomeIcons.squareXing;
  if (value == 'xingSquare') return FontAwesomeIcons.xingSquare;
  if (value == 'squareXmark') return FontAwesomeIcons.squareXmark;
  if (value == 'timesSquare') return FontAwesomeIcons.timesSquare;
  if (value == 'xmarkSquare') return FontAwesomeIcons.xmarkSquare;
  if (value == 'squareYoutube') return FontAwesomeIcons.squareYoutube;
  if (value == 'youtubeSquare') return FontAwesomeIcons.youtubeSquare;
  if (value == 'squarespace') return FontAwesomeIcons.squarespace;
  if (value == 'stackExchange') return FontAwesomeIcons.stackExchange;
  if (value == 'stackOverflow') return FontAwesomeIcons.stackOverflow;
  if (value == 'stackpath') return FontAwesomeIcons.stackpath;
  if (value == 'staffSnake') return FontAwesomeIcons.staffSnake;
  if (value == 'rodAsclepius') return FontAwesomeIcons.rodAsclepius;
  if (value == 'rodSnake') return FontAwesomeIcons.rodSnake;
  if (value == 'staffAesculapius') return FontAwesomeIcons.staffAesculapius;
  if (value == 'stairs') return FontAwesomeIcons.stairs;
  if (value == 'stamp') return FontAwesomeIcons.stamp;
  if (value == 'stapler') return FontAwesomeIcons.stapler;
  if (value == 'solidStar') return FontAwesomeIcons.solidStar;
  if (value == 'star') return FontAwesomeIcons.star;
  if (value == 'starAndCrescent') return FontAwesomeIcons.starAndCrescent;
  if (value == 'solidStarHalf') return FontAwesomeIcons.solidStarHalf;
  if (value == 'starHalf') return FontAwesomeIcons.starHalf;
  if (value == 'solidStarHalfStroke') return FontAwesomeIcons.solidStarHalfStroke;
  if (value == 'solidStarHalfAlt') return FontAwesomeIcons.solidStarHalfAlt;
  if (value == 'starHalfStroke') return FontAwesomeIcons.starHalfStroke;
  if (value == 'starHalfAlt') return FontAwesomeIcons.starHalfAlt;
  if (value == 'starOfDavid') return FontAwesomeIcons.starOfDavid;
  if (value == 'starOfLife') return FontAwesomeIcons.starOfLife;
  if (value == 'staylinked') return FontAwesomeIcons.staylinked;
  if (value == 'steam') return FontAwesomeIcons.steam;
  if (value == 'steamSymbol') return FontAwesomeIcons.steamSymbol;
  if (value == 'sterlingSign') return FontAwesomeIcons.sterlingSign;
  if (value == 'gbp') return FontAwesomeIcons.gbp;
  if (value == 'poundSign') return FontAwesomeIcons.poundSign;
  if (value == 'stethoscope') return FontAwesomeIcons.stethoscope;
  if (value == 'stickerMule') return FontAwesomeIcons.stickerMule;
  if (value == 'stop') return FontAwesomeIcons.stop;
  if (value == 'stopwatch') return FontAwesomeIcons.stopwatch;
  if (value == 'stopwatch20') return FontAwesomeIcons.stopwatch20;
  if (value == 'store') return FontAwesomeIcons.store;
  if (value == 'storeSlash') return FontAwesomeIcons.storeSlash;
  if (value == 'strava') return FontAwesomeIcons.strava;
  if (value == 'streetView') return FontAwesomeIcons.streetView;
  if (value == 'strikethrough') return FontAwesomeIcons.strikethrough;
  if (value == 'stripe') return FontAwesomeIcons.stripe;
  if (value == 'stripeS') return FontAwesomeIcons.stripeS;
  if (value == 'stroopwafel') return FontAwesomeIcons.stroopwafel;
  if (value == 'stubber') return FontAwesomeIcons.stubber;
  if (value == 'studiovinari') return FontAwesomeIcons.studiovinari;
  if (value == 'stumbleupon') return FontAwesomeIcons.stumbleupon;
  if (value == 'stumbleuponCircle') return FontAwesomeIcons.stumbleuponCircle;
  if (value == 'subscript') return FontAwesomeIcons.subscript;
  if (value == 'suitcase') return FontAwesomeIcons.suitcase;
  if (value == 'suitcaseMedical') return FontAwesomeIcons.suitcaseMedical;
  if (value == 'medkit') return FontAwesomeIcons.medkit;
  if (value == 'suitcaseRolling') return FontAwesomeIcons.suitcaseRolling;
  if (value == 'solidSun') return FontAwesomeIcons.solidSun;
  if (value == 'sun') return FontAwesomeIcons.sun;
  if (value == 'sunPlantWilt') return FontAwesomeIcons.sunPlantWilt;
  if (value == 'superpowers') return FontAwesomeIcons.superpowers;
  if (value == 'superscript') return FontAwesomeIcons.superscript;
  if (value == 'supple') return FontAwesomeIcons.supple;
  if (value == 'suse') return FontAwesomeIcons.suse;
  if (value == 'swatchbook') return FontAwesomeIcons.swatchbook;
  if (value == 'swift') return FontAwesomeIcons.swift;
  if (value == 'symfony') return FontAwesomeIcons.symfony;
  if (value == 'synagogue') return FontAwesomeIcons.synagogue;
  if (value == 'syringe') return FontAwesomeIcons.syringe;
  if (value == 't') return FontAwesomeIcons.t;
  if (value == 'table') return FontAwesomeIcons.table;
  if (value == 'tableCells') return FontAwesomeIcons.tableCells;
  if (value == 'th') return FontAwesomeIcons.th;
  if (value == 'tableCellsLarge') return FontAwesomeIcons.tableCellsLarge;
  if (value == 'thLarge') return FontAwesomeIcons.thLarge;
  if (value == 'tableColumns') return FontAwesomeIcons.tableColumns;
  if (value == 'columns') return FontAwesomeIcons.columns;
  if (value == 'tableList') return FontAwesomeIcons.tableList;
  if (value == 'thList') return FontAwesomeIcons.thList;
  if (value == 'tableTennisPaddleBall') return FontAwesomeIcons.tableTennisPaddleBall;
  if (value == 'pingPongPaddleBall') return FontAwesomeIcons.pingPongPaddleBall;
  if (value == 'tableTennis') return FontAwesomeIcons.tableTennis;
  if (value == 'tablet') return FontAwesomeIcons.tablet;
  if (value == 'tabletAndroid') return FontAwesomeIcons.tabletAndroid;
  if (value == 'tabletButton') return FontAwesomeIcons.tabletButton;
  if (value == 'tabletScreenButton') return FontAwesomeIcons.tabletScreenButton;
  if (value == 'tabletAlt') return FontAwesomeIcons.tabletAlt;
  if (value == 'tablets') return FontAwesomeIcons.tablets;
  if (value == 'tachographDigital') return FontAwesomeIcons.tachographDigital;
  if (value == 'digitalTachograph') return FontAwesomeIcons.digitalTachograph;
  if (value == 'tag') return FontAwesomeIcons.tag;
  if (value == 'tags') return FontAwesomeIcons.tags;
  if (value == 'tape') return FontAwesomeIcons.tape;
  if (value == 'tarp') return FontAwesomeIcons.tarp;
  if (value == 'tarpDroplet') return FontAwesomeIcons.tarpDroplet;
  if (value == 'taxi') return FontAwesomeIcons.taxi;
  if (value == 'cab') return FontAwesomeIcons.cab;
  if (value == 'teamspeak') return FontAwesomeIcons.teamspeak;
  if (value == 'teeth') return FontAwesomeIcons.teeth;
  if (value == 'teethOpen') return FontAwesomeIcons.teethOpen;
  if (value == 'telegram') return FontAwesomeIcons.telegram;
  if (value == 'telegramPlane') return FontAwesomeIcons.telegramPlane;
  if (value == 'temperatureArrowDown') return FontAwesomeIcons.temperatureArrowDown;
  if (value == 'temperatureDown') return FontAwesomeIcons.temperatureDown;
  if (value == 'temperatureArrowUp') return FontAwesomeIcons.temperatureArrowUp;
  if (value == 'temperatureUp') return FontAwesomeIcons.temperatureUp;
  if (value == 'temperatureEmpty') return FontAwesomeIcons.temperatureEmpty;
  if (value == 'temperature0') return FontAwesomeIcons.temperature0;
  if (value == 'thermometer0') return FontAwesomeIcons.thermometer0;
  if (value == 'thermometerEmpty') return FontAwesomeIcons.thermometerEmpty;
  if (value == 'temperatureFull') return FontAwesomeIcons.temperatureFull;
  if (value == 'temperature4') return FontAwesomeIcons.temperature4;
  if (value == 'thermometer4') return FontAwesomeIcons.thermometer4;
  if (value == 'thermometerFull') return FontAwesomeIcons.thermometerFull;
  if (value == 'temperatureHalf') return FontAwesomeIcons.temperatureHalf;
  if (value == 'temperature2') return FontAwesomeIcons.temperature2;
  if (value == 'thermometer2') return FontAwesomeIcons.thermometer2;
  if (value == 'thermometerHalf') return FontAwesomeIcons.thermometerHalf;
  if (value == 'temperatureHigh') return FontAwesomeIcons.temperatureHigh;
  if (value == 'temperatureLow') return FontAwesomeIcons.temperatureLow;
  if (value == 'temperatureQuarter') return FontAwesomeIcons.temperatureQuarter;
  if (value == 'temperature1') return FontAwesomeIcons.temperature1;
  if (value == 'thermometer1') return FontAwesomeIcons.thermometer1;
  if (value == 'thermometerQuarter') return FontAwesomeIcons.thermometerQuarter;
  if (value == 'temperatureThreeQuarters') return FontAwesomeIcons.temperatureThreeQuarters;
  if (value == 'temperature3') return FontAwesomeIcons.temperature3;
  if (value == 'thermometer3') return FontAwesomeIcons.thermometer3;
  if (value == 'thermometerThreeQuarters') return FontAwesomeIcons.thermometerThreeQuarters;
  if (value == 'tencentWeibo') return FontAwesomeIcons.tencentWeibo;
  if (value == 'tengeSign') return FontAwesomeIcons.tengeSign;
  if (value == 'tenge') return FontAwesomeIcons.tenge;
  if (value == 'tent') return FontAwesomeIcons.tent;
  if (value == 'tentArrowDownToLine') return FontAwesomeIcons.tentArrowDownToLine;
  if (value == 'tentArrowLeftRight') return FontAwesomeIcons.tentArrowLeftRight;
  if (value == 'tentArrowTurnLeft') return FontAwesomeIcons.tentArrowTurnLeft;
  if (value == 'tentArrowsDown') return FontAwesomeIcons.tentArrowsDown;
  if (value == 'tents') return FontAwesomeIcons.tents;
  if (value == 'terminal') return FontAwesomeIcons.terminal;
  if (value == 'textHeight') return FontAwesomeIcons.textHeight;
  if (value == 'textSlash') return FontAwesomeIcons.textSlash;
  if (value == 'removeFormat') return FontAwesomeIcons.removeFormat;
  if (value == 'textWidth') return FontAwesomeIcons.textWidth;
  if (value == 'theRedYeti') return FontAwesomeIcons.theRedYeti;
  if (value == 'themeco') return FontAwesomeIcons.themeco;
  if (value == 'themeisle') return FontAwesomeIcons.themeisle;
  if (value == 'thermometer') return FontAwesomeIcons.thermometer;
  if (value == 'thinkPeaks') return FontAwesomeIcons.thinkPeaks;
  if (value == 'threads') return FontAwesomeIcons.threads;
  if (value == 'solidThumbsDown') return FontAwesomeIcons.solidThumbsDown;
  if (value == 'thumbsDown') return FontAwesomeIcons.thumbsDown;
  if (value == 'solidThumbsUp') return FontAwesomeIcons.solidThumbsUp;
  if (value == 'thumbsUp') return FontAwesomeIcons.thumbsUp;
  if (value == 'thumbtack') return FontAwesomeIcons.thumbtack;
  if (value == 'thumbTack') return FontAwesomeIcons.thumbTack;
  if (value == 'ticket') return FontAwesomeIcons.ticket;
  if (value == 'ticketSimple') return FontAwesomeIcons.ticketSimple;
  if (value == 'ticketAlt') return FontAwesomeIcons.ticketAlt;
  if (value == 'tiktok') return FontAwesomeIcons.tiktok;
  if (value == 'timeline') return FontAwesomeIcons.timeline;
  if (value == 'toggleOff') return FontAwesomeIcons.toggleOff;
  if (value == 'toggleOn') return FontAwesomeIcons.toggleOn;
  if (value == 'toilet') return FontAwesomeIcons.toilet;
  if (value == 'toiletPaper') return FontAwesomeIcons.toiletPaper;
  if (value == 'toiletPaperSlash') return FontAwesomeIcons.toiletPaperSlash;
  if (value == 'toiletPortable') return FontAwesomeIcons.toiletPortable;
  if (value == 'toiletsPortable') return FontAwesomeIcons.toiletsPortable;
  if (value == 'toolbox') return FontAwesomeIcons.toolbox;
  if (value == 'tooth') return FontAwesomeIcons.tooth;
  if (value == 'toriiGate') return FontAwesomeIcons.toriiGate;
  if (value == 'tornado') return FontAwesomeIcons.tornado;
  if (value == 'towerBroadcast') return FontAwesomeIcons.towerBroadcast;
  if (value == 'broadcastTower') return FontAwesomeIcons.broadcastTower;
  if (value == 'towerCell') return FontAwesomeIcons.towerCell;
  if (value == 'towerObservation') return FontAwesomeIcons.towerObservation;
  if (value == 'tractor') return FontAwesomeIcons.tractor;
  if (value == 'tradeFederation') return FontAwesomeIcons.tradeFederation;
  if (value == 'trademark') return FontAwesomeIcons.trademark;
  if (value == 'trafficLight') return FontAwesomeIcons.trafficLight;
  if (value == 'trailer') return FontAwesomeIcons.trailer;
  if (value == 'train') return FontAwesomeIcons.train;
  if (value == 'trainSubway') return FontAwesomeIcons.trainSubway;
  if (value == 'subway') return FontAwesomeIcons.subway;
  if (value == 'trainTram') return FontAwesomeIcons.trainTram;
  if (value == 'transgender') return FontAwesomeIcons.transgender;
  if (value == 'transgenderAlt') return FontAwesomeIcons.transgenderAlt;
  if (value == 'trash') return FontAwesomeIcons.trash;
  if (value == 'trashArrowUp') return FontAwesomeIcons.trashArrowUp;
  if (value == 'trashRestore') return FontAwesomeIcons.trashRestore;
  if (value == 'solidTrashCan') return FontAwesomeIcons.solidTrashCan;
  if (value == 'solidTrashAlt') return FontAwesomeIcons.solidTrashAlt;
  if (value == 'trashCan') return FontAwesomeIcons.trashCan;
  if (value == 'trashAlt') return FontAwesomeIcons.trashAlt;
  if (value == 'trashCanArrowUp') return FontAwesomeIcons.trashCanArrowUp;
  if (value == 'trashRestoreAlt') return FontAwesomeIcons.trashRestoreAlt;
  if (value == 'tree') return FontAwesomeIcons.tree;
  if (value == 'treeCity') return FontAwesomeIcons.treeCity;
  if (value == 'trello') return FontAwesomeIcons.trello;
  if (value == 'triangleExclamation') return FontAwesomeIcons.triangleExclamation;
  if (value == 'exclamationTriangle') return FontAwesomeIcons.exclamationTriangle;
  if (value == 'warning') return FontAwesomeIcons.warning;
  if (value == 'trophy') return FontAwesomeIcons.trophy;
  if (value == 'trowel') return FontAwesomeIcons.trowel;
  if (value == 'trowelBricks') return FontAwesomeIcons.trowelBricks;
  if (value == 'truck') return FontAwesomeIcons.truck;
  if (value == 'truckArrowRight') return FontAwesomeIcons.truckArrowRight;
  if (value == 'truckDroplet') return FontAwesomeIcons.truckDroplet;
  if (value == 'truckFast') return FontAwesomeIcons.truckFast;
  if (value == 'shippingFast') return FontAwesomeIcons.shippingFast;
  if (value == 'truckField') return FontAwesomeIcons.truckField;
  if (value == 'truckFieldUn') return FontAwesomeIcons.truckFieldUn;
  if (value == 'truckFront') return FontAwesomeIcons.truckFront;
  if (value == 'truckMedical') return FontAwesomeIcons.truckMedical;
  if (value == 'ambulance') return FontAwesomeIcons.ambulance;
  if (value == 'truckMonster') return FontAwesomeIcons.truckMonster;
  if (value == 'truckMoving') return FontAwesomeIcons.truckMoving;
  if (value == 'truckPickup') return FontAwesomeIcons.truckPickup;
  if (value == 'truckPlane') return FontAwesomeIcons.truckPlane;
  if (value == 'truckRampBox') return FontAwesomeIcons.truckRampBox;
  if (value == 'truckLoading') return FontAwesomeIcons.truckLoading;
  if (value == 'tty') return FontAwesomeIcons.tty;
  if (value == 'teletype') return FontAwesomeIcons.teletype;
  if (value == 'tumblr') return FontAwesomeIcons.tumblr;
  if (value == 'turkishLiraSign') return FontAwesomeIcons.turkishLiraSign;
  if (value == 'turkishLira') return FontAwesomeIcons.turkishLira;
  if (value == 'turnDown') return FontAwesomeIcons.turnDown;
  if (value == 'levelDownAlt') return FontAwesomeIcons.levelDownAlt;
  if (value == 'turnUp') return FontAwesomeIcons.turnUp;
  if (value == 'levelUpAlt') return FontAwesomeIcons.levelUpAlt;
  if (value == 'tv') return FontAwesomeIcons.tv;
  if (value == 'television') return FontAwesomeIcons.television;
  if (value == 'tvAlt') return FontAwesomeIcons.tvAlt;
  if (value == 'twitch') return FontAwesomeIcons.twitch;
  if (value == 'twitter') return FontAwesomeIcons.twitter;
  if (value == 'typo3') return FontAwesomeIcons.typo3;
  if (value == 'u') return FontAwesomeIcons.u;
  if (value == 'uber') return FontAwesomeIcons.uber;
  if (value == 'ubuntu') return FontAwesomeIcons.ubuntu;
  if (value == 'uikit') return FontAwesomeIcons.uikit;
  if (value == 'umbraco') return FontAwesomeIcons.umbraco;
  if (value == 'umbrella') return FontAwesomeIcons.umbrella;
  if (value == 'umbrellaBeach') return FontAwesomeIcons.umbrellaBeach;
  if (value == 'uncharted') return FontAwesomeIcons.uncharted;
  if (value == 'underline') return FontAwesomeIcons.underline;
  if (value == 'uniregistry') return FontAwesomeIcons.uniregistry;
  if (value == 'unity') return FontAwesomeIcons.unity;
  if (value == 'universalAccess') return FontAwesomeIcons.universalAccess;
  if (value == 'unlock') return FontAwesomeIcons.unlock;
  if (value == 'unlockKeyhole') return FontAwesomeIcons.unlockKeyhole;
  if (value == 'unlockAlt') return FontAwesomeIcons.unlockAlt;
  if (value == 'unsplash') return FontAwesomeIcons.unsplash;
  if (value == 'untappd') return FontAwesomeIcons.untappd;
  if (value == 'upDown') return FontAwesomeIcons.upDown;
  if (value == 'arrowsAltV') return FontAwesomeIcons.arrowsAltV;
  if (value == 'upDownLeftRight') return FontAwesomeIcons.upDownLeftRight;
  if (value == 'arrowsAlt') return FontAwesomeIcons.arrowsAlt;
  if (value == 'upLong') return FontAwesomeIcons.upLong;
  if (value == 'longArrowAltUp') return FontAwesomeIcons.longArrowAltUp;
  if (value == 'upRightAndDownLeftFromCenter') return FontAwesomeIcons.upRightAndDownLeftFromCenter;
  if (value == 'expandAlt') return FontAwesomeIcons.expandAlt;
  if (value == 'upRightFromSquare') return FontAwesomeIcons.upRightFromSquare;
  if (value == 'externalLinkAlt') return FontAwesomeIcons.externalLinkAlt;
  if (value == 'upload') return FontAwesomeIcons.upload;
  if (value == 'ups') return FontAwesomeIcons.ups;
  if (value == 'upwork') return FontAwesomeIcons.upwork;
  if (value == 'usb') return FontAwesomeIcons.usb;
  if (value == 'solidUser') return FontAwesomeIcons.solidUser;
  if (value == 'user') return FontAwesomeIcons.user;
  if (value == 'userAstronaut') return FontAwesomeIcons.userAstronaut;
  if (value == 'userCheck') return FontAwesomeIcons.userCheck;
  if (value == 'userClock') return FontAwesomeIcons.userClock;
  if (value == 'userDoctor') return FontAwesomeIcons.userDoctor;
  if (value == 'userMd') return FontAwesomeIcons.userMd;
  if (value == 'userGear') return FontAwesomeIcons.userGear;
  if (value == 'userCog') return FontAwesomeIcons.userCog;
  if (value == 'userGraduate') return FontAwesomeIcons.userGraduate;
  if (value == 'userGroup') return FontAwesomeIcons.userGroup;
  if (value == 'userFriends') return FontAwesomeIcons.userFriends;
  if (value == 'userInjured') return FontAwesomeIcons.userInjured;
  if (value == 'userLarge') return FontAwesomeIcons.userLarge;
  if (value == 'userAlt') return FontAwesomeIcons.userAlt;
  if (value == 'userLargeSlash') return FontAwesomeIcons.userLargeSlash;
  if (value == 'userAltSlash') return FontAwesomeIcons.userAltSlash;
  if (value == 'userLock') return FontAwesomeIcons.userLock;
  if (value == 'userMinus') return FontAwesomeIcons.userMinus;
  if (value == 'userNinja') return FontAwesomeIcons.userNinja;
  if (value == 'userNurse') return FontAwesomeIcons.userNurse;
  if (value == 'userPen') return FontAwesomeIcons.userPen;
  if (value == 'userEdit') return FontAwesomeIcons.userEdit;
  if (value == 'userPlus') return FontAwesomeIcons.userPlus;
  if (value == 'userSecret') return FontAwesomeIcons.userSecret;
  if (value == 'userShield') return FontAwesomeIcons.userShield;
  if (value == 'userSlash') return FontAwesomeIcons.userSlash;
  if (value == 'userTag') return FontAwesomeIcons.userTag;
  if (value == 'userTie') return FontAwesomeIcons.userTie;
  if (value == 'userXmark') return FontAwesomeIcons.userXmark;
  if (value == 'userTimes') return FontAwesomeIcons.userTimes;
  if (value == 'users') return FontAwesomeIcons.users;
  if (value == 'usersBetweenLines') return FontAwesomeIcons.usersBetweenLines;
  if (value == 'usersGear') return FontAwesomeIcons.usersGear;
  if (value == 'usersCog') return FontAwesomeIcons.usersCog;
  if (value == 'usersLine') return FontAwesomeIcons.usersLine;
  if (value == 'usersRays') return FontAwesomeIcons.usersRays;
  if (value == 'usersRectangle') return FontAwesomeIcons.usersRectangle;
  if (value == 'usersSlash') return FontAwesomeIcons.usersSlash;
  if (value == 'usersViewfinder') return FontAwesomeIcons.usersViewfinder;
  if (value == 'usps') return FontAwesomeIcons.usps;
  if (value == 'ussunnah') return FontAwesomeIcons.ussunnah;
  if (value == 'utensils') return FontAwesomeIcons.utensils;
  if (value == 'cutlery') return FontAwesomeIcons.cutlery;
  if (value == 'v') return FontAwesomeIcons.v;
  if (value == 'vaadin') return FontAwesomeIcons.vaadin;
  if (value == 'vanShuttle') return FontAwesomeIcons.vanShuttle;
  if (value == 'shuttleVan') return FontAwesomeIcons.shuttleVan;
  if (value == 'vault') return FontAwesomeIcons.vault;
  if (value == 'vectorSquare') return FontAwesomeIcons.vectorSquare;
  if (value == 'venus') return FontAwesomeIcons.venus;
  if (value == 'venusDouble') return FontAwesomeIcons.venusDouble;
  if (value == 'venusMars') return FontAwesomeIcons.venusMars;
  if (value == 'vest') return FontAwesomeIcons.vest;
  if (value == 'vestPatches') return FontAwesomeIcons.vestPatches;
  if (value == 'viacoin') return FontAwesomeIcons.viacoin;
  if (value == 'viadeo') return FontAwesomeIcons.viadeo;
  if (value == 'vial') return FontAwesomeIcons.vial;
  if (value == 'vialCircleCheck') return FontAwesomeIcons.vialCircleCheck;
  if (value == 'vialVirus') return FontAwesomeIcons.vialVirus;
  if (value == 'vials') return FontAwesomeIcons.vials;
  if (value == 'viber') return FontAwesomeIcons.viber;
  if (value == 'video') return FontAwesomeIcons.video;
  if (value == 'videoCamera') return FontAwesomeIcons.videoCamera;
  if (value == 'videoSlash') return FontAwesomeIcons.videoSlash;
  if (value == 'vihara') return FontAwesomeIcons.vihara;
  if (value == 'vimeo') return FontAwesomeIcons.vimeo;
  if (value == 'vimeoV') return FontAwesomeIcons.vimeoV;
  if (value == 'vine') return FontAwesomeIcons.vine;
  if (value == 'virus') return FontAwesomeIcons.virus;
  if (value == 'virusCovid') return FontAwesomeIcons.virusCovid;
  if (value == 'virusCovidSlash') return FontAwesomeIcons.virusCovidSlash;
  if (value == 'virusSlash') return FontAwesomeIcons.virusSlash;
  if (value == 'viruses') return FontAwesomeIcons.viruses;
  if (value == 'vk') return FontAwesomeIcons.vk;
  if (value == 'vnv') return FontAwesomeIcons.vnv;
  if (value == 'voicemail') return FontAwesomeIcons.voicemail;
  if (value == 'volcano') return FontAwesomeIcons.volcano;
  if (value == 'volleyball') return FontAwesomeIcons.volleyball;
  if (value == 'volleyballBall') return FontAwesomeIcons.volleyballBall;
  if (value == 'volumeHigh') return FontAwesomeIcons.volumeHigh;
  if (value == 'volumeUp') return FontAwesomeIcons.volumeUp;
  if (value == 'volumeLow') return FontAwesomeIcons.volumeLow;
  if (value == 'volumeDown') return FontAwesomeIcons.volumeDown;
  if (value == 'volumeOff') return FontAwesomeIcons.volumeOff;
  if (value == 'volumeXmark') return FontAwesomeIcons.volumeXmark;
  if (value == 'volumeMute') return FontAwesomeIcons.volumeMute;
  if (value == 'volumeTimes') return FontAwesomeIcons.volumeTimes;
  if (value == 'vrCardboard') return FontAwesomeIcons.vrCardboard;
  if (value == 'vuejs') return FontAwesomeIcons.vuejs;
  if (value == 'w') return FontAwesomeIcons.w;
  if (value == 'walkieTalkie') return FontAwesomeIcons.walkieTalkie;
  if (value == 'wallet') return FontAwesomeIcons.wallet;
  if (value == 'wandMagic') return FontAwesomeIcons.wandMagic;
  if (value == 'magic') return FontAwesomeIcons.magic;
  if (value == 'wandMagicSparkles') return FontAwesomeIcons.wandMagicSparkles;
  if (value == 'magicWandSparkles') return FontAwesomeIcons.magicWandSparkles;
  if (value == 'wandSparkles') return FontAwesomeIcons.wandSparkles;
  if (value == 'warehouse') return FontAwesomeIcons.warehouse;
  if (value == 'watchmanMonitoring') return FontAwesomeIcons.watchmanMonitoring;
  if (value == 'water') return FontAwesomeIcons.water;
  if (value == 'waterLadder') return FontAwesomeIcons.waterLadder;
  if (value == 'ladderWater') return FontAwesomeIcons.ladderWater;
  if (value == 'swimmingPool') return FontAwesomeIcons.swimmingPool;
  if (value == 'waveSquare') return FontAwesomeIcons.waveSquare;
  if (value == 'waze') return FontAwesomeIcons.waze;
  if (value == 'webflow') return FontAwesomeIcons.webflow;
  if (value == 'weebly') return FontAwesomeIcons.weebly;
  if (value == 'weibo') return FontAwesomeIcons.weibo;
  if (value == 'weightHanging') return FontAwesomeIcons.weightHanging;
  if (value == 'weightScale') return FontAwesomeIcons.weightScale;
  if (value == 'weight') return FontAwesomeIcons.weight;
  if (value == 'weixin') return FontAwesomeIcons.weixin;
  if (value == 'whatsapp') return FontAwesomeIcons.whatsapp;
  if (value == 'wheatAwn') return FontAwesomeIcons.wheatAwn;
  if (value == 'wheatAlt') return FontAwesomeIcons.wheatAlt;
  if (value == 'wheatAwnCircleExclamation') return FontAwesomeIcons.wheatAwnCircleExclamation;
  if (value == 'wheelchair') return FontAwesomeIcons.wheelchair;
  if (value == 'wheelchairMove') return FontAwesomeIcons.wheelchairMove;
  if (value == 'wheelchairAlt') return FontAwesomeIcons.wheelchairAlt;
  if (value == 'whiskeyGlass') return FontAwesomeIcons.whiskeyGlass;
  if (value == 'glassWhiskey') return FontAwesomeIcons.glassWhiskey;
  if (value == 'whmcs') return FontAwesomeIcons.whmcs;
  if (value == 'wifi') return FontAwesomeIcons.wifi;
  if (value == 'wifi3') return FontAwesomeIcons.wifi3;
  if (value == 'wifiStrong') return FontAwesomeIcons.wifiStrong;
  if (value == 'wikipediaW') return FontAwesomeIcons.wikipediaW;
  if (value == 'wind') return FontAwesomeIcons.wind;
  if (value == 'solidWindowMaximize') return FontAwesomeIcons.solidWindowMaximize;
  if (value == 'windowMaximize') return FontAwesomeIcons.windowMaximize;
  if (value == 'solidWindowMinimize') return FontAwesomeIcons.solidWindowMinimize;
  if (value == 'windowMinimize') return FontAwesomeIcons.windowMinimize;
  if (value == 'solidWindowRestore') return FontAwesomeIcons.solidWindowRestore;
  if (value == 'windowRestore') return FontAwesomeIcons.windowRestore;
  if (value == 'windows') return FontAwesomeIcons.windows;
  if (value == 'wineBottle') return FontAwesomeIcons.wineBottle;
  if (value == 'wineGlass') return FontAwesomeIcons.wineGlass;
  if (value == 'wineGlassEmpty') return FontAwesomeIcons.wineGlassEmpty;
  if (value == 'wineGlassAlt') return FontAwesomeIcons.wineGlassAlt;
  if (value == 'wirsindhandwerk') return FontAwesomeIcons.wirsindhandwerk;
  if (value == 'wsh') return FontAwesomeIcons.wsh;
  if (value == 'wix') return FontAwesomeIcons.wix;
  if (value == 'wizardsOfTheCoast') return FontAwesomeIcons.wizardsOfTheCoast;
  if (value == 'wodu') return FontAwesomeIcons.wodu;
  if (value == 'wolfPackBattalion') return FontAwesomeIcons.wolfPackBattalion;
  if (value == 'wonSign') return FontAwesomeIcons.wonSign;
  if (value == 'krw') return FontAwesomeIcons.krw;
  if (value == 'won') return FontAwesomeIcons.won;
  if (value == 'wordpress') return FontAwesomeIcons.wordpress;
  if (value == 'wordpressSimple') return FontAwesomeIcons.wordpressSimple;
  if (value == 'worm') return FontAwesomeIcons.worm;
  if (value == 'wpbeginner') return FontAwesomeIcons.wpbeginner;
  if (value == 'wpexplorer') return FontAwesomeIcons.wpexplorer;
  if (value == 'wpforms') return FontAwesomeIcons.wpforms;
  if (value == 'wpressr') return FontAwesomeIcons.wpressr;
  if (value == 'rendact') return FontAwesomeIcons.rendact;
  if (value == 'wrench') return FontAwesomeIcons.wrench;
  if (value == 'x') return FontAwesomeIcons.x;
  if (value == 'xRay') return FontAwesomeIcons.xRay;
  if (value == 'xTwitter') return FontAwesomeIcons.xTwitter;
  if (value == 'xbox') return FontAwesomeIcons.xbox;
  if (value == 'xing') return FontAwesomeIcons.xing;
  if (value == 'xmark') return FontAwesomeIcons.xmark;
  if (value == 'close') return FontAwesomeIcons.close;
  if (value == 'multiply') return FontAwesomeIcons.multiply;
  if (value == 'remove') return FontAwesomeIcons.remove;
  if (value == 'times') return FontAwesomeIcons.times;
  if (value == 'xmarksLines') return FontAwesomeIcons.xmarksLines;
  if (value == 'y') return FontAwesomeIcons.y;
  if (value == 'yCombinator') return FontAwesomeIcons.yCombinator;
  if (value == 'yahoo') return FontAwesomeIcons.yahoo;
  if (value == 'yammer') return FontAwesomeIcons.yammer;
  if (value == 'yandex') return FontAwesomeIcons.yandex;
  if (value == 'yandexInternational') return FontAwesomeIcons.yandexInternational;
  if (value == 'yarn') return FontAwesomeIcons.yarn;
  if (value == 'yelp') return FontAwesomeIcons.yelp;
  if (value == 'yenSign') return FontAwesomeIcons.yenSign;
  if (value == 'cny') return FontAwesomeIcons.cny;
  if (value == 'jpy') return FontAwesomeIcons.jpy;
  if (value == 'rmb') return FontAwesomeIcons.rmb;
  if (value == 'yen') return FontAwesomeIcons.yen;
  if (value == 'yinYang') return FontAwesomeIcons.yinYang;
  if (value == 'yoast') return FontAwesomeIcons.yoast;
  if (value == 'youtube') return FontAwesomeIcons.youtube;
  if (value == 'z') return FontAwesomeIcons.z;
  if (value == 'zhihu') return FontAwesomeIcons.zhihu;
  return null;
}

IconData? iconDataFromString(String? value) {
  ...
  if (value == 'eighteen_up_rating_sharp') return Icons.eighteen_up_rating_sharp;
  if (value == 'eighteen_up_rating_rounded') return Icons.eighteen_up_rating_rounded;
  if (value == 'eighteen_up_rating_outlined') return Icons.eighteen_up_rating_outlined;
  ...
  if (value == 'one_x_mobiledata_rounded') return Icons.one_x_mobiledata_rounded;
  if (value == 'one_x_mobiledata_outlined') return Icons.one_x_mobiledata_outlined;
  ...
  if (value == 'twenty_three_mp_rounded') return Icons.twenty_three_mp_rounded;
  if (value == 'twenty_three_mp_outlined') return Icons.twenty_three_mp_outlined;
  ...
  if (value == 'twenty_four_mp_outlined') return Icons.twenty_four_mp_outlined;
  ...
  if (value == 'thirty_fps_select_sharp') return Icons.thirty_fps_select_sharp;
  if (value == 'thirty_fps_select_rounded') return Icons.thirty_fps_select_rounded;
  if (value == 'thirty_fps_select_outlined') return Icons.thirty_fps_select_outlined;
  ...
  if (value == 'threed_rotation_rounded') return Icons.threed_rotation_rounded;
  if (value == 'threed_rotation_outlined') return Icons.threed_rotation_outlined;
  if (value == 'three_g_mobiledata') return Icons.three_g_mobiledata;
  if (value == 'three_g_mobiledata_sharp') return Icons.three_g_mobiledata_sharp;
  if (value == 'three_g_mobiledata_rounded') return Icons.three_g_mobiledata_rounded;
  if (value == 'three_g_mobiledata_outlined') return Icons.three_g_mobiledata_outlined;
  ...
  if (value == 'four_g_mobiledata_sharp') return Icons.four_g_mobiledata_sharp;
  if (value == 'four_g_mobiledata_rounded') return Icons.four_g_mobiledata_rounded;
  if (value == 'four_g_mobiledata_outlined') return Icons.four_g_mobiledata_outlined;
  if (value == 'four_g_plus_mobiledata') return Icons.four_g_plus_mobiledata;
  if (value == 'four_g_plus_mobiledata_sharp') return Icons.four_g_plus_mobiledata_sharp;
  if (value == 'four_g_plus_mobiledata_rounded') return Icons.four_g_plus_mobiledata_rounded;
  if (value == 'four_g_plus_mobiledata_outlined') return Icons.four_g_plus_mobiledata_outlined;
  ...
  if (value == 'sixty_fps_select_rounded') return Icons.sixty_fps_select_rounded;
  if (value == 'sixty_fps_select_outlined') return Icons.sixty_fps_select_outlined;
  ...
  if (value == 'access_time_filled_sharp') return Icons.access_time_filled_sharp;
  if (value == 'access_time_filled_rounded') return Icons.access_time_filled_rounded;
  if (value == 'access_time_filled_outlined') return Icons.access_time_filled_outlined;
  ...
  if (value == 'accessibility_new_sharp') return Icons.accessibility_new_sharp;
  if (value == 'accessibility_new_rounded') return Icons.accessibility_new_rounded;
  if (value == 'accessibility_new_outlined') return Icons.accessibility_new_outlined;
  ...
  if (value == 'accessible_forward_sharp') return Icons.accessible_forward_sharp;
  if (value == 'accessible_forward_rounded') return Icons.accessible_forward_rounded;
  if (value == 'accessible_forward_outlined') return Icons.accessible_forward_outlined;
  if (value == 'account_balance') return Icons.account_balance;
  if (value == 'account_balance_sharp') return Icons.account_balance_sharp;
  if (value == 'account_balance_rounded') return Icons.account_balance_rounded;
  if (value == 'account_balance_outlined') return Icons.account_balance_outlined;
  if (value == 'account_balance_wallet') return Icons.account_balance_wallet;
  if (value == 'account_balance_wallet_sharp') return Icons.account_balance_wallet_sharp;
  if (value == 'account_balance_wallet_rounded') return Icons.account_balance_wallet_rounded;
  if (value == 'account_balance_wallet_outlined') return Icons.account_balance_wallet_outlined;
  ...
  if (value == 'account_circle_outlined') return Icons.account_circle_outlined;
  ...
  if (value == 'add_circle_outline_sharp') return Icons.add_circle_outline_sharp;
  if (value == 'add_circle_outline_rounded') return Icons.add_circle_outline_rounded;
  if (value == 'add_circle_outline_outlined') return Icons.add_circle_outline_outlined;
  ...
  if (value == 'add_location_alt_rounded') return Icons.add_location_alt_rounded;
  if (value == 'add_location_alt_outlined') return Icons.add_location_alt_outlined;
  ...
  if (value == 'add_photo_alternate_sharp') return Icons.add_photo_alternate_sharp;
  if (value == 'add_photo_alternate_rounded') return Icons.add_photo_alternate_rounded;
  if (value == 'add_photo_alternate_outlined') return Icons.add_photo_alternate_outlined;
  ...
  if (value == 'add_shopping_cart_sharp') return Icons.add_shopping_cart_sharp;
  if (value == 'add_shopping_cart_rounded') return Icons.add_shopping_cart_rounded;
  if (value == 'add_shopping_cart_outlined') return Icons.add_shopping_cart_outlined;
  ...
  if (value == 'add_to_home_screen_sharp') return Icons.add_to_home_screen_sharp;
  if (value == 'add_to_home_screen_rounded') return Icons.add_to_home_screen_rounded;
  if (value == 'add_to_home_screen_outlined') return Icons.add_to_home_screen_outlined;
  ...
  if (value == 'admin_panel_settings_sharp') return Icons.admin_panel_settings_sharp;
  if (value == 'admin_panel_settings_rounded') return Icons.admin_panel_settings_rounded;
  if (value == 'admin_panel_settings_outlined') return Icons.admin_panel_settings_outlined;
  ...
  if (value == 'airline_seat_flat_sharp') return Icons.airline_seat_flat_sharp;
  if (value == 'airline_seat_flat_rounded') return Icons.airline_seat_flat_rounded;
  if (value == 'airline_seat_flat_outlined') return Icons.airline_seat_flat_outlined;
  if (value == 'airline_seat_flat_angled') return Icons.airline_seat_flat_angled;
  if (value == 'airline_seat_flat_angled_sharp') return Icons.airline_seat_flat_angled_sharp;
  if (value == 'airline_seat_flat_angled_rounded') return Icons.airline_seat_flat_angled_rounded;
  if (value == 'airline_seat_flat_angled_outlined') return Icons.airline_seat_flat_angled_outlined;
  if (value == 'airline_seat_individual_suite') return Icons.airline_seat_individual_suite;
  if (value == 'airline_seat_individual_suite_sharp') return Icons.airline_seat_individual_suite_sharp;
  if (value == 'airline_seat_individual_suite_rounded') return Icons.airline_seat_individual_suite_rounded;
  if (value == 'airline_seat_individual_suite_outlined') return Icons.airline_seat_individual_suite_outlined;
  if (value == 'airline_seat_legroom_extra') return Icons.airline_seat_legroom_extra;
  if (value == 'airline_seat_legroom_extra_sharp') return Icons.airline_seat_legroom_extra_sharp;
  if (value == 'airline_seat_legroom_extra_rounded') return Icons.airline_seat_legroom_extra_rounded;
  if (value == 'airline_seat_legroom_extra_outlined') return Icons.airline_seat_legroom_extra_outlined;
  if (value == 'airline_seat_legroom_normal') return Icons.airline_seat_legroom_normal;
  if (value == 'airline_seat_legroom_normal_sharp') return Icons.airline_seat_legroom_normal_sharp;
  if (value == 'airline_seat_legroom_normal_rounded') return Icons.airline_seat_legroom_normal_rounded;
  if (value == 'airline_seat_legroom_normal_outlined') return Icons.airline_seat_legroom_normal_outlined;
  if (value == 'airline_seat_legroom_reduced') return Icons.airline_seat_legroom_reduced;
  if (value == 'airline_seat_legroom_reduced_sharp') return Icons.airline_seat_legroom_reduced_sharp;
  if (value == 'airline_seat_legroom_reduced_rounded') return Icons.airline_seat_legroom_reduced_rounded;
  if (value == 'airline_seat_legroom_reduced_outlined') return Icons.airline_seat_legroom_reduced_outlined;
  if (value == 'airline_seat_recline_extra') return Icons.airline_seat_recline_extra;
  if (value == 'airline_seat_recline_extra_sharp') return Icons.airline_seat_recline_extra_sharp;
  if (value == 'airline_seat_recline_extra_rounded') return Icons.airline_seat_recline_extra_rounded;
  if (value == 'airline_seat_recline_extra_outlined') return Icons.airline_seat_recline_extra_outlined;
  if (value == 'airline_seat_recline_normal') return Icons.airline_seat_recline_normal;
  if (value == 'airline_seat_recline_normal_sharp') return Icons.airline_seat_recline_normal_sharp;
  if (value == 'airline_seat_recline_normal_rounded') return Icons.airline_seat_recline_normal_rounded;
  if (value == 'airline_seat_recline_normal_outlined') return Icons.airline_seat_recline_normal_outlined;
  ...
  if (value == 'airplane_ticket_rounded') return Icons.airplane_ticket_rounded;
  if (value == 'airplane_ticket_outlined') return Icons.airplane_ticket_outlined;
  if (value == 'airplanemode_active') return Icons.airplanemode_active;
  if (value == 'airplanemode_active_sharp') return Icons.airplanemode_active_sharp;
  if (value == 'airplanemode_active_rounded') return Icons.airplanemode_active_rounded;
  if (value == 'airplanemode_active_outlined') return Icons.airplanemode_active_outlined;
  if (value == 'airplanemode_inactive') return Icons.airplanemode_inactive;
  if (value == 'airplanemode_inactive_sharp') return Icons.airplanemode_inactive_sharp;
  if (value == 'airplanemode_inactive_rounded') return Icons.airplanemode_inactive_rounded;
  if (value == 'airplanemode_inactive_outlined') return Icons.airplanemode_inactive_outlined;
  ...
  if (value == 'airplanemode_off_rounded') return Icons.airplanemode_off_rounded;
  if (value == 'airplanemode_off_outlined') return Icons.airplanemode_off_outlined;
  if (value == 'airplanemode_on') return Icons.airplanemode_on;
  if (value == 'airplanemode_on_sharp') return Icons.airplanemode_on_sharp;
  if (value == 'airplanemode_on_rounded') return Icons.airplanemode_on_rounded;
  if (value == 'airplanemode_on_outlined') return Icons.airplanemode_on_outlined;
  ...
  if (value == 'airport_shuttle_rounded') return Icons.airport_shuttle_rounded;
  if (value == 'airport_shuttle_outlined') return Icons.airport_shuttle_outlined;
  ...
  if (value == 'align_horizontal_center') return Icons.align_horizontal_center;
  if (value == 'align_horizontal_center_sharp') return Icons.align_horizontal_center_sharp;
  if (value == 'align_horizontal_center_rounded') return Icons.align_horizontal_center_rounded;
  if (value == 'align_horizontal_center_outlined') return Icons.align_horizontal_center_outlined;
  if (value == 'align_horizontal_left') return Icons.align_horizontal_left;
  if (value == 'align_horizontal_left_sharp') return Icons.align_horizontal_left_sharp;
  if (value == 'align_horizontal_left_rounded') return Icons.align_horizontal_left_rounded;
  if (value == 'align_horizontal_left_outlined') return Icons.align_horizontal_left_outlined;
  if (value == 'align_horizontal_right') return Icons.align_horizontal_right;
  if (value == 'align_horizontal_right_sharp') return Icons.align_horizontal_right_sharp;
  if (value == 'align_horizontal_right_rounded') return Icons.align_horizontal_right_rounded;
  if (value == 'align_horizontal_right_outlined') return Icons.align_horizontal_right_outlined;
  if (value == 'align_vertical_bottom') return Icons.align_vertical_bottom;
  if (value == 'align_vertical_bottom_sharp') return Icons.align_vertical_bottom_sharp;
  if (value == 'align_vertical_bottom_rounded') return Icons.align_vertical_bottom_rounded;
  if (value == 'align_vertical_bottom_outlined') return Icons.align_vertical_bottom_outlined;
  if (value == 'align_vertical_center') return Icons.align_vertical_center;
  if (value == 'align_vertical_center_sharp') return Icons.align_vertical_center_sharp;
  if (value == 'align_vertical_center_rounded') return Icons.align_vertical_center_rounded;
  if (value == 'align_vertical_center_outlined') return Icons.align_vertical_center_outlined;
  if (value == 'align_vertical_top') return Icons.align_vertical_top;
  if (value == 'align_vertical_top_sharp') return Icons.align_vertical_top_sharp;
  if (value == 'align_vertical_top_rounded') return Icons.align_vertical_top_rounded;
  if (value == 'align_vertical_top_outlined') return Icons.align_vertical_top_outlined;
  ...
  if (value == 'alternate_email_rounded') return Icons.alternate_email_rounded;
  if (value == 'alternate_email_outlined') return Icons.alternate_email_outlined;
  ...
  if (value == 'app_registration_rounded') return Icons.app_registration_rounded;
  if (value == 'app_registration_outlined') return Icons.app_registration_outlined;
  ...
  if (value == 'app_settings_alt_rounded') return Icons.app_settings_alt_rounded;
  if (value == 'app_settings_alt_outlined') return Icons.app_settings_alt_outlined;
  ...
  if (value == 'arrow_back_ios_outlined') return Icons.arrow_back_ios_outlined;
  if (value == 'arrow_back_ios_new') return Icons.arrow_back_ios_new;
  if (value == 'arrow_back_ios_new_sharp') return Icons.arrow_back_ios_new_sharp;
  if (value == 'arrow_back_ios_new_rounded') return Icons.arrow_back_ios_new_rounded;
  if (value == 'arrow_back_ios_new_outlined') return Icons.arrow_back_ios_new_outlined;
  if (value == 'arrow_circle_down') return Icons.arrow_circle_down;
  if (value == 'arrow_circle_down_sharp') return Icons.arrow_circle_down_sharp;
  if (value == 'arrow_circle_down_rounded') return Icons.arrow_circle_down_rounded;
  if (value == 'arrow_circle_down_outlined') return Icons.arrow_circle_down_outlined;
  if (value == 'arrow_circle_left') return Icons.arrow_circle_left;
  if (value == 'arrow_circle_left_sharp') return Icons.arrow_circle_left_sharp;
  if (value == 'arrow_circle_left_rounded') return Icons.arrow_circle_left_rounded;
  if (value == 'arrow_circle_left_outlined') return Icons.arrow_circle_left_outlined;
  if (value == 'arrow_circle_right') return Icons.arrow_circle_right;
  if (value == 'arrow_circle_right_sharp') return Icons.arrow_circle_right_sharp;
  if (value == 'arrow_circle_right_rounded') return Icons.arrow_circle_right_rounded;
  if (value == 'arrow_circle_right_outlined') return Icons.arrow_circle_right_outlined;
  if (value == 'arrow_circle_up') return Icons.arrow_circle_up;
  if (value == 'arrow_circle_up_sharp') return Icons.arrow_circle_up_sharp;
  if (value == 'arrow_circle_up_rounded') return Icons.arrow_circle_up_rounded;
  if (value == 'arrow_circle_up_outlined') return Icons.arrow_circle_up_outlined;
  ...
  if (value == 'arrow_downward_outlined') return Icons.arrow_downward_outlined;
  if (value == 'arrow_drop_down') return Icons.arrow_drop_down;
  if (value == 'arrow_drop_down_sharp') return Icons.arrow_drop_down_sharp;
  if (value == 'arrow_drop_down_rounded') return Icons.arrow_drop_down_rounded;
  if (value == 'arrow_drop_down_outlined') return Icons.arrow_drop_down_outlined;
  if (value == 'arrow_drop_down_circle') return Icons.arrow_drop_down_circle;
  if (value == 'arrow_drop_down_circle_sharp') return Icons.arrow_drop_down_circle_sharp;
  if (value == 'arrow_drop_down_circle_rounded') return Icons.arrow_drop_down_circle_rounded;
  if (value == 'arrow_drop_down_circle_outlined') return Icons.arrow_drop_down_circle_outlined;
  ...
  if (value == 'arrow_forward_ios_sharp') return Icons.arrow_forward_ios_sharp;
  if (value == 'arrow_forward_ios_rounded') return Icons.arrow_forward_ios_rounded;
  if (value == 'arrow_forward_ios_outlined') return Icons.arrow_forward_ios_outlined;
  ...
  if (value == 'arrow_outward') return Icons.arrow_outward;
  if (value == 'arrow_outward_sharp') return Icons.arrow_outward_sharp;
  if (value == 'arrow_outward_rounded') return Icons.arrow_outward_rounded;
  if (value == 'arrow_outward_outlined') return Icons.arrow_outward_outlined;
  ...
  if (value == 'arrow_right_alt_rounded') return Icons.arrow_right_alt_rounded;
  if (value == 'arrow_right_alt_outlined') return Icons.arrow_right_alt_outlined;
  ...
  if (value == 'assignment_add') return Icons.assignment_add;
  ...
  if (value == 'assignment_ind_outlined') return Icons.assignment_ind_outlined;
  if (value == 'assignment_late') return Icons.assignment_late;
  if (value == 'assignment_late_sharp') return Icons.assignment_late_sharp;
  if (value == 'assignment_late_rounded') return Icons.assignment_late_rounded;
  if (value == 'assignment_late_outlined') return Icons.assignment_late_outlined;
  if (value == 'assignment_return') return Icons.assignment_return;
  if (value == 'assignment_return_sharp') return Icons.assignment_return_sharp;
  if (value == 'assignment_return_rounded') return Icons.assignment_return_rounded;
  if (value == 'assignment_return_outlined') return Icons.assignment_return_outlined;
  if (value == 'assignment_returned') return Icons.assignment_returned;
  if (value == 'assignment_returned_sharp') return Icons.assignment_returned_sharp;
  if (value == 'assignment_returned_rounded') return Icons.assignment_returned_rounded;
  if (value == 'assignment_returned_outlined') return Icons.assignment_returned_outlined;
  if (value == 'assignment_turned_in') return Icons.assignment_turned_in;
  if (value == 'assignment_turned_in_sharp') return Icons.assignment_turned_in_sharp;
  if (value == 'assignment_turned_in_rounded') return Icons.assignment_turned_in_rounded;
  if (value == 'assignment_turned_in_outlined') return Icons.assignment_turned_in_outlined;
  if (value == 'assist_walker') return Icons.assist_walker;
  if (value == 'assist_walker_sharp') return Icons.assist_walker_sharp;
  if (value == 'assist_walker_rounded') return Icons.assist_walker_rounded;
  if (value == 'assist_walker_outlined') return Icons.assist_walker_outlined;
  ...
  if (value == 'assistant_direction_sharp') return Icons.assistant_direction_sharp;
  if (value == 'assistant_direction_rounded') return Icons.assistant_direction_rounded;
  if (value == 'assistant_direction_outlined') return Icons.assistant_direction_outlined;
  ...
  if (value == 'assistant_photo_rounded') return Icons.assistant_photo_rounded;
  if (value == 'assistant_photo_outlined') return Icons.assistant_photo_outlined;
  ...
  if (value == 'assured_workload_rounded') return Icons.assured_workload_rounded;
  if (value == 'assured_workload_outlined') return Icons.assured_workload_outlined;
  ...
  if (value == 'auto_awesome_mosaic_sharp') return Icons.auto_awesome_mosaic_sharp;
  if (value == 'auto_awesome_mosaic_rounded') return Icons.auto_awesome_mosaic_rounded;
  if (value == 'auto_awesome_mosaic_outlined') return Icons.auto_awesome_mosaic_outlined;
  if (value == 'auto_awesome_motion') return Icons.auto_awesome_motion;
  if (value == 'auto_awesome_motion_sharp') return Icons.auto_awesome_motion_sharp;
  if (value == 'auto_awesome_motion_rounded') return Icons.auto_awesome_motion_rounded;
  if (value == 'auto_awesome_motion_outlined') return Icons.auto_awesome_motion_outlined;
  ...
  if (value == 'auto_fix_normal_rounded') return Icons.auto_fix_normal_rounded;
  if (value == 'auto_fix_normal_outlined') return Icons.auto_fix_normal_outlined;
  ...
  if (value == 'autofps_select_outlined') return Icons.autofps_select_outlined;
  ...
  if (value == 'baby_changing_station_sharp') return Icons.baby_changing_station_sharp;
  if (value == 'baby_changing_station_rounded') return Icons.baby_changing_station_rounded;
  if (value == 'baby_changing_station_outlined') return Icons.baby_changing_station_outlined;
  ...
  if (value == 'barcode_reader') return Icons.barcode_reader;
  ...
  if (value == 'batch_prediction_rounded') return Icons.batch_prediction_rounded;
  if (value == 'batch_prediction_outlined') return Icons.batch_prediction_outlined;
  ...
  if (value == 'battery_charging_full_sharp') return Icons.battery_charging_full_sharp;
  if (value == 'battery_charging_full_rounded') return Icons.battery_charging_full_rounded;
  if (value == 'battery_charging_full_outlined') return Icons.battery_charging_full_outlined;
  ...
  if (value == 'battery_unknown_rounded') return Icons.battery_unknown_rounded;
  if (value == 'battery_unknown_outlined') return Icons.battery_unknown_outlined;
  ...
  if (value == 'bedroom_parent_outlined') return Icons.bedroom_parent_outlined;
  ...
  if (value == 'blind') return Icons.blind;
  if (value == 'blind_sharp') return Icons.blind_sharp;
  if (value == 'blind_rounded') return Icons.blind_rounded;
  if (value == 'blind_outlined') return Icons.blind_outlined;
  ...
  if (value == 'bluetooth_audio_rounded') return Icons.bluetooth_audio_rounded;
  if (value == 'bluetooth_audio_outlined') return Icons.bluetooth_audio_outlined;
  if (value == 'bluetooth_connected') return Icons.bluetooth_connected;
  if (value == 'bluetooth_connected_sharp') return Icons.bluetooth_connected_sharp;
  if (value == 'bluetooth_connected_rounded') return Icons.bluetooth_connected_rounded;
  if (value == 'bluetooth_connected_outlined') return Icons.bluetooth_connected_outlined;
  if (value == 'bluetooth_disabled') return Icons.bluetooth_disabled;
  if (value == 'bluetooth_disabled_sharp') return Icons.bluetooth_disabled_sharp;
  if (value == 'bluetooth_disabled_rounded') return Icons.bluetooth_disabled_rounded;
  if (value == 'bluetooth_disabled_outlined') return Icons.bluetooth_disabled_outlined;
  if (value == 'bluetooth_drive') return Icons.bluetooth_drive;
  if (value == 'bluetooth_drive_sharp') return Icons.bluetooth_drive_sharp;
  if (value == 'bluetooth_drive_rounded') return Icons.bluetooth_drive_rounded;
  if (value == 'bluetooth_drive_outlined') return Icons.bluetooth_drive_outlined;
  if (value == 'bluetooth_searching') return Icons.bluetooth_searching;
  if (value == 'bluetooth_searching_sharp') return Icons.bluetooth_searching_sharp;
  if (value == 'bluetooth_searching_rounded') return Icons.bluetooth_searching_rounded;
  if (value == 'bluetooth_searching_outlined') return Icons.bluetooth_searching_outlined;
  ...
  if (value == 'bookmark_added_outlined') return Icons.bookmark_added_outlined;
  if (value == 'bookmark_border') return Icons.bookmark_border;
  if (value == 'bookmark_border_sharp') return Icons.bookmark_border_sharp;
  if (value == 'bookmark_border_rounded') return Icons.bookmark_border_rounded;
  if (value == 'bookmark_border_outlined') return Icons.bookmark_border_outlined;
  ...
  if (value == 'bookmark_outline_rounded') return Icons.bookmark_outline_rounded;
  if (value == 'bookmark_outline_outlined') return Icons.bookmark_outline_outlined;
  if (value == 'bookmark_remove') return Icons.bookmark_remove;
  if (value == 'bookmark_remove_sharp') return Icons.bookmark_remove_sharp;
  if (value == 'bookmark_remove_rounded') return Icons.bookmark_remove_rounded;
  if (value == 'bookmark_remove_outlined') return Icons.bookmark_remove_outlined;
  ...
  if (value == 'border_horizontal_sharp') return Icons.border_horizontal_sharp;
  if (value == 'border_horizontal_rounded') return Icons.border_horizontal_rounded;
  if (value == 'border_horizontal_outlined') return Icons.border_horizontal_outlined;
  ...
  if (value == 'border_vertical_rounded') return Icons.border_vertical_rounded;
  if (value == 'border_vertical_outlined') return Icons.border_vertical_outlined;
  ...
  if (value == 'branding_watermark_sharp') return Icons.branding_watermark_sharp;
  if (value == 'branding_watermark_rounded') return Icons.branding_watermark_rounded;
  if (value == 'branding_watermark_outlined') return Icons.branding_watermark_outlined;
  ...
  if (value == 'breakfast_dining_rounded') return Icons.breakfast_dining_rounded;
  if (value == 'breakfast_dining_outlined') return Icons.breakfast_dining_outlined;
  ...
  if (value == 'brightness_auto_rounded') return Icons.brightness_auto_rounded;
  if (value == 'brightness_auto_outlined') return Icons.brightness_auto_outlined;
  if (value == 'brightness_high') return Icons.brightness_high;
  if (value == 'brightness_high_sharp') return Icons.brightness_high_sharp;
  if (value == 'brightness_high_rounded') return Icons.brightness_high_rounded;
  if (value == 'brightness_high_outlined') return Icons.brightness_high_outlined;
  ...
  if (value == 'brightness_low_outlined') return Icons.brightness_low_outlined;
  if (value == 'brightness_medium') return Icons.brightness_medium;
  if (value == 'brightness_medium_sharp') return Icons.brightness_medium_sharp;
  if (value == 'brightness_medium_rounded') return Icons.brightness_medium_rounded;
  if (value == 'brightness_medium_outlined') return Icons.brightness_medium_outlined;
  if (value == 'broadcast_on_home') return Icons.broadcast_on_home;
  if (value == 'broadcast_on_home_sharp') return Icons.broadcast_on_home_sharp;
  if (value == 'broadcast_on_home_rounded') return Icons.broadcast_on_home_rounded;
  if (value == 'broadcast_on_home_outlined') return Icons.broadcast_on_home_outlined;
  if (value == 'broadcast_on_personal') return Icons.broadcast_on_personal;
  if (value == 'broadcast_on_personal_sharp') return Icons.broadcast_on_personal_sharp;
  if (value == 'broadcast_on_personal_rounded') return Icons.broadcast_on_personal_rounded;
  if (value == 'broadcast_on_personal_outlined') return Icons.broadcast_on_personal_outlined;
  ...
  if (value == 'browse_gallery_outlined') return Icons.browse_gallery_outlined;
  if (value == 'browser_not_supported') return Icons.browser_not_supported;
  if (value == 'browser_not_supported_sharp') return Icons.browser_not_supported_sharp;
  if (value == 'browser_not_supported_rounded') return Icons.browser_not_supported_rounded;
  if (value == 'browser_not_supported_outlined') return Icons.browser_not_supported_outlined;
  if (value == 'browser_updated') return Icons.browser_updated;
  if (value == 'browser_updated_sharp') return Icons.browser_updated_sharp;
  if (value == 'browser_updated_rounded') return Icons.browser_updated_rounded;
  if (value == 'browser_updated_outlined') return Icons.browser_updated_outlined;
  ...
  if (value == 'business_center_rounded') return Icons.business_center_rounded;
  if (value == 'business_center_outlined') return Icons.business_center_outlined;
  ...
  if (value == 'calendar_month_outlined') return Icons.calendar_month_outlined;
  ...
  if (value == 'calendar_today_outlined') return Icons.calendar_today_outlined;
  if (value == 'calendar_view_day') return Icons.calendar_view_day;
  if (value == 'calendar_view_day_sharp') return Icons.calendar_view_day_sharp;
  if (value == 'calendar_view_day_rounded') return Icons.calendar_view_day_rounded;
  if (value == 'calendar_view_day_outlined') return Icons.calendar_view_day_outlined;
  if (value == 'calendar_view_month') return Icons.calendar_view_month;
  if (value == 'calendar_view_month_sharp') return Icons.calendar_view_month_sharp;
  if (value == 'calendar_view_month_rounded') return Icons.calendar_view_month_rounded;
  if (value == 'calendar_view_month_outlined') return Icons.calendar_view_month_outlined;
  if (value == 'calendar_view_week') return Icons.calendar_view_week;
  if (value == 'calendar_view_week_sharp') return Icons.calendar_view_week_sharp;
  if (value == 'calendar_view_week_rounded') return Icons.calendar_view_week_rounded;
  if (value == 'calendar_view_week_outlined') return Icons.calendar_view_week_outlined;
  ...
  if (value == 'call_missed_outgoing_sharp') return Icons.call_missed_outgoing_sharp;
  if (value == 'call_missed_outgoing_rounded') return Icons.call_missed_outgoing_rounded;
  if (value == 'call_missed_outgoing_outlined') return Icons.call_missed_outgoing_outlined;
  ...
  if (value == 'call_to_action_outlined') return Icons.call_to_action_outlined;
  ...
  if (value == 'camera_enhance_outlined') return Icons.camera_enhance_outlined;
  ...
  if (value == 'camera_outdoor_outlined') return Icons.camera_outdoor_outlined;
  ...
  if (value == 'cancel_presentation_sharp') return Icons.cancel_presentation_sharp;
  if (value == 'cancel_presentation_rounded') return Icons.cancel_presentation_rounded;
  if (value == 'cancel_presentation_outlined') return Icons.cancel_presentation_outlined;
  if (value == 'cancel_schedule_send') return Icons.cancel_schedule_send;
  if (value == 'cancel_schedule_send_sharp') return Icons.cancel_schedule_send_sharp;
  if (value == 'cancel_schedule_send_rounded') return Icons.cancel_schedule_send_rounded;
  if (value == 'cancel_schedule_send_outlined') return Icons.cancel_schedule_send_outlined;
  if (value == 'candlestick_chart') return Icons.candlestick_chart;
  if (value == 'candlestick_chart_sharp') return Icons.candlestick_chart_sharp;
  if (value == 'candlestick_chart_rounded') return Icons.candlestick_chart_rounded;
  if (value == 'candlestick_chart_outlined') return Icons.candlestick_chart_outlined;
  ...
  if (value == 'card_membership_rounded') return Icons.card_membership_rounded;
  if (value == 'card_membership_outlined') return Icons.card_membership_outlined;
  ...
  if (value == 'cast_connected_outlined') return Icons.cast_connected_outlined;
  if (value == 'cast_for_education') return Icons.cast_for_education;
  if (value == 'cast_for_education_sharp') return Icons.cast_for_education_sharp;
  if (value == 'cast_for_education_rounded') return Icons.cast_for_education_rounded;
  if (value == 'cast_for_education_outlined') return Icons.cast_for_education_outlined;
  ...
  if (value == 'catching_pokemon_rounded') return Icons.catching_pokemon_rounded;
  if (value == 'catching_pokemon_outlined') return Icons.catching_pokemon_outlined;
  ...
  if (value == 'center_focus_strong_sharp') return Icons.center_focus_strong_sharp;
  if (value == 'center_focus_strong_rounded') return Icons.center_focus_strong_rounded;
  if (value == 'center_focus_strong_outlined') return Icons.center_focus_strong_outlined;
  if (value == 'center_focus_weak') return Icons.center_focus_weak;
  if (value == 'center_focus_weak_sharp') return Icons.center_focus_weak_sharp;
  if (value == 'center_focus_weak_rounded') return Icons.center_focus_weak_rounded;
  if (value == 'center_focus_weak_outlined') return Icons.center_focus_weak_outlined;
  ...
  if (value == 'change_history_outlined') return Icons.change_history_outlined;
  ...
  if (value == 'charging_station_rounded') return Icons.charging_station_rounded;
  if (value == 'charging_station_outlined') return Icons.charging_station_outlined;
  ...
  if (value == 'chat_bubble_outline_sharp') return Icons.chat_bubble_outline_sharp;
  if (value == 'chat_bubble_outline_rounded') return Icons.chat_bubble_outline_rounded;
  if (value == 'chat_bubble_outline_outlined') return Icons.chat_bubble_outline_outlined;
  ...
  if (value == 'check_box_outline_blank') return Icons.check_box_outline_blank;
  if (value == 'check_box_outline_blank_sharp') return Icons.check_box_outline_blank_sharp;
  if (value == 'check_box_outline_blank_rounded') return Icons.check_box_outline_blank_rounded;
  if (value == 'check_box_outline_blank_outlined') return Icons.check_box_outline_blank_outlined;
  ...
  if (value == 'check_circle_outline_sharp') return Icons.check_circle_outline_sharp;
  if (value == 'check_circle_outline_rounded') return Icons.check_circle_outline_rounded;
  if (value == 'check_circle_outline_outlined') return Icons.check_circle_outline_outlined;
  ...
  if (value == 'child_friendly_outlined') return Icons.child_friendly_outlined;
  if (value == 'chrome_reader_mode') return Icons.chrome_reader_mode;
  if (value == 'chrome_reader_mode_sharp') return Icons.chrome_reader_mode_sharp;
  if (value == 'chrome_reader_mode_rounded') return Icons.chrome_reader_mode_rounded;
  if (value == 'chrome_reader_mode_outlined') return Icons.chrome_reader_mode_outlined;
  ...
  if (value == 'circle_notifications_sharp') return Icons.circle_notifications_sharp;
  if (value == 'circle_notifications_rounded') return Icons.circle_notifications_rounded;
  if (value == 'circle_notifications_outlined') return Icons.circle_notifications_outlined;
  ...
  if (value == 'cleaning_services_sharp') return Icons.cleaning_services_sharp;
  if (value == 'cleaning_services_rounded') return Icons.cleaning_services_rounded;
  if (value == 'cleaning_services_outlined') return Icons.cleaning_services_outlined;
  ...
  if (value == 'close_fullscreen_rounded') return Icons.close_fullscreen_rounded;
  if (value == 'close_fullscreen_outlined') return Icons.close_fullscreen_outlined;
  ...
  if (value == 'closed_caption_outlined') return Icons.closed_caption_outlined;
  if (value == 'closed_caption_disabled') return Icons.closed_caption_disabled;
  if (value == 'closed_caption_disabled_sharp') return Icons.closed_caption_disabled_sharp;
  if (value == 'closed_caption_disabled_rounded') return Icons.closed_caption_disabled_rounded;
  if (value == 'closed_caption_disabled_outlined') return Icons.closed_caption_disabled_outlined;
  if (value == 'closed_caption_off') return Icons.closed_caption_off;
  if (value == 'closed_caption_off_sharp') return Icons.closed_caption_off_sharp;
  if (value == 'closed_caption_off_rounded') return Icons.closed_caption_off_rounded;
  if (value == 'closed_caption_off_outlined') return Icons.closed_caption_off_outlined;
  ...
  if (value == 'cloud_download_outlined') return Icons.cloud_download_outlined;
  ...
  if (value == 'collections_bookmark_sharp') return Icons.collections_bookmark_sharp;
  if (value == 'collections_bookmark_rounded') return Icons.collections_bookmark_rounded;
  if (value == 'collections_bookmark_outlined') return Icons.collections_bookmark_outlined;
  ...
  if (value == 'comments_disabled_sharp') return Icons.comments_disabled_sharp;
  if (value == 'comments_disabled_rounded') return Icons.comments_disabled_rounded;
  if (value == 'comments_disabled_outlined') return Icons.comments_disabled_outlined;
  ...
  if (value == 'compare_arrows_outlined') return Icons.compare_arrows_outlined;
  if (value == 'compass_calibration') return Icons.compass_calibration;
  if (value == 'compass_calibration_sharp') return Icons.compass_calibration_sharp;
  if (value == 'compass_calibration_rounded') return Icons.compass_calibration_rounded;
  if (value == 'compass_calibration_outlined') return Icons.compass_calibration_outlined;
  ...
  if (value == 'confirmation_num_rounded') return Icons.confirmation_num_rounded;
  if (value == 'confirmation_num_outlined') return Icons.confirmation_num_outlined;
  if (value == 'confirmation_number') return Icons.confirmation_number;
  if (value == 'confirmation_number_sharp') return Icons.confirmation_number_sharp;
  if (value == 'confirmation_number_rounded') return Icons.confirmation_number_rounded;
  if (value == 'confirmation_number_outlined') return Icons.confirmation_number_outlined;
  if (value == 'connect_without_contact') return Icons.connect_without_contact;
  if (value == 'connect_without_contact_sharp') return Icons.connect_without_contact_sharp;
  if (value == 'connect_without_contact_rounded') return Icons.connect_without_contact_rounded;
  if (value == 'connect_without_contact_outlined') return Icons.connect_without_contact_outlined;
  ...
  if (value == 'connecting_airports_sharp') return Icons.connecting_airports_sharp;
  if (value == 'connecting_airports_rounded') return Icons.connecting_airports_rounded;
  if (value == 'connecting_airports_outlined') return Icons.connecting_airports_outlined;
  ...
  if (value == 'contact_emergency') return Icons.contact_emergency;
  if (value == 'contact_emergency_sharp') return Icons.contact_emergency_sharp;
  if (value == 'contact_emergency_rounded') return Icons.contact_emergency_rounded;
  if (value == 'contact_emergency_outlined') return Icons.contact_emergency_outlined;
  ...
  if (value == 'contact_support_rounded') return Icons.contact_support_rounded;
  if (value == 'contact_support_outlined') return Icons.contact_support_outlined;
  ...
  if (value == 'content_paste_go_rounded') return Icons.content_paste_go_rounded;
  if (value == 'content_paste_go_outlined') return Icons.content_paste_go_outlined;
  if (value == 'content_paste_off') return Icons.content_paste_off;
  if (value == 'content_paste_off_sharp') return Icons.content_paste_off_sharp;
  if (value == 'content_paste_off_rounded') return Icons.content_paste_off_rounded;
  if (value == 'content_paste_off_outlined') return Icons.content_paste_off_outlined;
  if (value == 'content_paste_search') return Icons.content_paste_search;
  if (value == 'content_paste_search_sharp') return Icons.content_paste_search_sharp;
  if (value == 'content_paste_search_rounded') return Icons.content_paste_search_rounded;
  if (value == 'content_paste_search_outlined') return Icons.content_paste_search_outlined;
  ...
  if (value == 'control_camera_outlined') return Icons.control_camera_outlined;
  ...
  if (value == 'control_point_duplicate') return Icons.control_point_duplicate;
  if (value == 'control_point_duplicate_sharp') return Icons.control_point_duplicate_sharp;
  if (value == 'control_point_duplicate_rounded') return Icons.control_point_duplicate_rounded;
  if (value == 'control_point_duplicate_outlined') return Icons.control_point_duplicate_outlined;
  if (value == 'conveyor_belt') return Icons.conveyor_belt;
  ...
  if (value == 'corporate_fare_outlined') return Icons.corporate_fare_outlined;
  ...
  if (value == 'create_new_folder_sharp') return Icons.create_new_folder_sharp;
  if (value == 'create_new_folder_rounded') return Icons.create_new_folder_rounded;
  if (value == 'create_new_folder_outlined') return Icons.create_new_folder_outlined;
  ...
  if (value == 'credit_card_off_rounded') return Icons.credit_card_off_rounded;
  if (value == 'credit_card_off_outlined') return Icons.credit_card_off_outlined;
  ...
  if (value == 'crop_landscape_outlined') return Icons.crop_landscape_outlined;
  ...
  if (value == 'currency_bitcoin_rounded') return Icons.currency_bitcoin_rounded;
  if (value == 'currency_bitcoin_outlined') return Icons.currency_bitcoin_outlined;
  if (value == 'currency_exchange') return Icons.currency_exchange;
  if (value == 'currency_exchange_sharp') return Icons.currency_exchange_sharp;
  if (value == 'currency_exchange_rounded') return Icons.currency_exchange_rounded;
  if (value == 'currency_exchange_outlined') return Icons.currency_exchange_outlined;
  ...
  if (value == 'currency_franc_outlined') return Icons.currency_franc_outlined;
  ...
  if (value == 'currency_pound_outlined') return Icons.currency_pound_outlined;
  ...
  if (value == 'currency_ruble_outlined') return Icons.currency_ruble_outlined;
  ...
  if (value == 'currency_rupee_outlined') return Icons.currency_rupee_outlined;
  ...
  if (value == 'curtains_closed_rounded') return Icons.curtains_closed_rounded;
  if (value == 'curtains_closed_outlined') return Icons.curtains_closed_outlined;
  ...
  if (value == 'dashboard_customize_sharp') return Icons.dashboard_customize_sharp;
  if (value == 'dashboard_customize_rounded') return Icons.dashboard_customize_rounded;
  if (value == 'dashboard_customize_outlined') return Icons.dashboard_customize_outlined;
  ...
  if (value == 'data_exploration_rounded') return Icons.data_exploration_rounded;
  if (value == 'data_exploration_outlined') return Icons.data_exploration_outlined;
  ...
  if (value == 'data_saver_off_outlined') return Icons.data_saver_off_outlined;
  ...
  if (value == 'data_thresholding_sharp') return Icons.data_thresholding_sharp;
  if (value == 'data_thresholding_rounded') return Icons.data_thresholding_rounded;
  if (value == 'data_thresholding_outlined') return Icons.data_thresholding_outlined;
  ...
  if (value == 'dataset_linked_outlined') return Icons.dataset_linked_outlined;
  ...
  if (value == 'delete_forever_outlined') return Icons.delete_forever_outlined;
  ...
  if (value == 'delete_outline_outlined') return Icons.delete_outline_outlined;
  ...
  if (value == 'delivery_dining_rounded') return Icons.delivery_dining_rounded;
  if (value == 'delivery_dining_outlined') return Icons.delivery_dining_outlined;
  ...
  if (value == 'density_medium_outlined') return Icons.density_medium_outlined;
  ...
  if (value == 'departure_board_rounded') return Icons.departure_board_rounded;
  if (value == 'departure_board_outlined') return Icons.departure_board_outlined;
  ...
  if (value == 'design_services_rounded') return Icons.design_services_rounded;
  if (value == 'design_services_outlined') return Icons.design_services_outlined;
  ...
  if (value == 'desktop_access_disabled') return Icons.desktop_access_disabled;
  if (value == 'desktop_access_disabled_sharp') return Icons.desktop_access_disabled_sharp;
  if (value == 'desktop_access_disabled_rounded') return Icons.desktop_access_disabled_rounded;
  if (value == 'desktop_access_disabled_outlined') return Icons.desktop_access_disabled_outlined;
  ...
  if (value == 'desktop_windows_rounded') return Icons.desktop_windows_rounded;
  if (value == 'desktop_windows_outlined') return Icons.desktop_windows_outlined;
  ...
  if (value == 'developer_board_rounded') return Icons.developer_board_rounded;
  if (value == 'developer_board_outlined') return Icons.developer_board_outlined;
  if (value == 'developer_board_off') return Icons.developer_board_off;
  if (value == 'developer_board_off_sharp') return Icons.developer_board_off_sharp;
  if (value == 'developer_board_off_rounded') return Icons.developer_board_off_rounded;
  if (value == 'developer_board_off_outlined') return Icons.developer_board_off_outlined;
  ...
  if (value == 'developer_mode_outlined') return Icons.developer_mode_outlined;
  ...
  if (value == 'device_thermostat_sharp') return Icons.device_thermostat_sharp;
  if (value == 'device_thermostat_rounded') return Icons.device_thermostat_rounded;
  if (value == 'device_thermostat_outlined') return Icons.device_thermostat_outlined;
  ...
  if (value == 'device_unknown_outlined') return Icons.device_unknown_outlined;
  ...
  if (value == 'dew_point') return Icons.dew_point;
  ...
  if (value == 'directions_bike_rounded') return Icons.directions_bike_rounded;
  if (value == 'directions_bike_outlined') return Icons.directions_bike_outlined;
  if (value == 'directions_boat') return Icons.directions_boat;
  if (value == 'directions_boat_sharp') return Icons.directions_boat_sharp;
  if (value == 'directions_boat_rounded') return Icons.directions_boat_rounded;
  if (value == 'directions_boat_outlined') return Icons.directions_boat_outlined;
  if (value == 'directions_boat_filled') return Icons.directions_boat_filled;
  if (value == 'directions_boat_filled_sharp') return Icons.directions_boat_filled_sharp;
  if (value == 'directions_boat_filled_rounded') return Icons.directions_boat_filled_rounded;
  if (value == 'directions_boat_filled_outlined') return Icons.directions_boat_filled_outlined;
  ...
  if (value == 'directions_bus_outlined') return Icons.directions_bus_outlined;
  if (value == 'directions_bus_filled') return Icons.directions_bus_filled;
  if (value == 'directions_bus_filled_sharp') return Icons.directions_bus_filled_sharp;
  if (value == 'directions_bus_filled_rounded') return Icons.directions_bus_filled_rounded;
  if (value == 'directions_bus_filled_outlined') return Icons.directions_bus_filled_outlined;
  ...
  if (value == 'directions_car_outlined') return Icons.directions_car_outlined;
  if (value == 'directions_car_filled') return Icons.directions_car_filled;
  if (value == 'directions_car_filled_sharp') return Icons.directions_car_filled_sharp;
  if (value == 'directions_car_filled_rounded') return Icons.directions_car_filled_rounded;
  if (value == 'directions_car_filled_outlined') return Icons.directions_car_filled_outlined;
  ...
  if (value == 'directions_ferry_rounded') return Icons.directions_ferry_rounded;
  if (value == 'directions_ferry_outlined') return Icons.directions_ferry_outlined;
  ...
  if (value == 'directions_off_outlined') return Icons.directions_off_outlined;
  if (value == 'directions_railway') return Icons.directions_railway;
  if (value == 'directions_railway_sharp') return Icons.directions_railway_sharp;
  if (value == 'directions_railway_rounded') return Icons.directions_railway_rounded;
  if (value == 'directions_railway_outlined') return Icons.directions_railway_outlined;
  if (value == 'directions_railway_filled') return Icons.directions_railway_filled;
  if (value == 'directions_railway_filled_sharp') return Icons.directions_railway_filled_sharp;
  if (value == 'directions_railway_filled_rounded') return Icons.directions_railway_filled_rounded;
  if (value == 'directions_railway_filled_outlined') return Icons.directions_railway_filled_outlined;
  ...
  if (value == 'directions_run_outlined') return Icons.directions_run_outlined;
  if (value == 'directions_subway') return Icons.directions_subway;
  if (value == 'directions_subway_sharp') return Icons.directions_subway_sharp;
  if (value == 'directions_subway_rounded') return Icons.directions_subway_rounded;
  if (value == 'directions_subway_outlined') return Icons.directions_subway_outlined;
  if (value == 'directions_subway_filled') return Icons.directions_subway_filled;
  if (value == 'directions_subway_filled_sharp') return Icons.directions_subway_filled_sharp;
  if (value == 'directions_subway_filled_rounded') return Icons.directions_subway_filled_rounded;
  if (value == 'directions_subway_filled_outlined') return Icons.directions_subway_filled_outlined;
  ...
  if (value == 'directions_train_rounded') return Icons.directions_train_rounded;
  if (value == 'directions_train_outlined') return Icons.directions_train_outlined;
  if (value == 'directions_transit') return Icons.directions_transit;
  if (value == 'directions_transit_sharp') return Icons.directions_transit_sharp;
  if (value == 'directions_transit_rounded') return Icons.directions_transit_rounded;
  if (value == 'directions_transit_outlined') return Icons.directions_transit_outlined;
  if (value == 'directions_transit_filled') return Icons.directions_transit_filled;
  if (value == 'directions_transit_filled_sharp') return Icons.directions_transit_filled_sharp;
  if (value == 'directions_transit_filled_rounded') return Icons.directions_transit_filled_rounded;
  if (value == 'directions_transit_filled_outlined') return Icons.directions_transit_filled_outlined;
  if (value == 'directions_walk') return Icons.directions_walk;
  if (value == 'directions_walk_sharp') return Icons.directions_walk_sharp;
  if (value == 'directions_walk_rounded') return Icons.directions_walk_rounded;
  if (value == 'directions_walk_outlined') return Icons.directions_walk_outlined;
  ...
  if (value == 'disabled_by_default_sharp') return Icons.disabled_by_default_sharp;
  if (value == 'disabled_by_default_rounded') return Icons.disabled_by_default_rounded;
  if (value == 'disabled_by_default_outlined') return Icons.disabled_by_default_outlined;
  ...
  if (value == 'disabled_visible_rounded') return Icons.disabled_visible_rounded;
  if (value == 'disabled_visible_outlined') return Icons.disabled_visible_outlined;
  ...
  if (value == 'display_settings_rounded') return Icons.display_settings_rounded;
  if (value == 'display_settings_outlined') return Icons.display_settings_outlined;
  if (value == 'diversity_1') return Icons.diversity_1;
  if (value == 'diversity_1_sharp') return Icons.diversity_1_sharp;
  if (value == 'diversity_1_rounded') return Icons.diversity_1_rounded;
  if (value == 'diversity_1_outlined') return Icons.diversity_1_outlined;
  if (value == 'diversity_2') return Icons.diversity_2;
  if (value == 'diversity_2_sharp') return Icons.diversity_2_sharp;
  if (value == 'diversity_2_rounded') return Icons.diversity_2_rounded;
  if (value == 'diversity_2_outlined') return Icons.diversity_2_outlined;
  if (value == 'diversity_3') return Icons.diversity_3;
  if (value == 'diversity_3_sharp') return Icons.diversity_3_sharp;
  if (value == 'diversity_3_rounded') return Icons.diversity_3_rounded;
  if (value == 'diversity_3_outlined') return Icons.diversity_3_outlined;
  ...
  if (value == 'dnd_forwardslash_rounded') return Icons.dnd_forwardslash_rounded;
  if (value == 'dnd_forwardslash_outlined') return Icons.dnd_forwardslash_outlined;
  ...
  if (value == 'do_disturb_alt_outlined') return Icons.do_disturb_alt_outlined;
  ...
  if (value == 'do_disturb_off_outlined') return Icons.do_disturb_off_outlined;
  ...
  if (value == 'do_not_disturb_outlined') return Icons.do_not_disturb_outlined;
  if (value == 'do_not_disturb_alt') return Icons.do_not_disturb_alt;
  if (value == 'do_not_disturb_alt_sharp') return Icons.do_not_disturb_alt_sharp;
  if (value == 'do_not_disturb_alt_rounded') return Icons.do_not_disturb_alt_rounded;
  if (value == 'do_not_disturb_alt_outlined') return Icons.do_not_disturb_alt_outlined;
  if (value == 'do_not_disturb_off') return Icons.do_not_disturb_off;
  if (value == 'do_not_disturb_off_sharp') return Icons.do_not_disturb_off_sharp;
  if (value == 'do_not_disturb_off_rounded') return Icons.do_not_disturb_off_rounded;
  if (value == 'do_not_disturb_off_outlined') return Icons.do_not_disturb_off_outlined;
  if (value == 'do_not_disturb_on') return Icons.do_not_disturb_on;
  if (value == 'do_not_disturb_on_sharp') return Icons.do_not_disturb_on_sharp;
  if (value == 'do_not_disturb_on_rounded') return Icons.do_not_disturb_on_rounded;
  if (value == 'do_not_disturb_on_outlined') return Icons.do_not_disturb_on_outlined;
  if (value == 'do_not_disturb_on_total_silence') return Icons.do_not_disturb_on_total_silence;
  if (value == 'do_not_disturb_on_total_silence_sharp') return Icons.do_not_disturb_on_total_silence_sharp;
  if (value == 'do_not_disturb_on_total_silence_rounded') return Icons.do_not_disturb_on_total_silence_rounded;
  if (value == 'do_not_disturb_on_total_silence_outlined') return Icons.do_not_disturb_on_total_silence_outlined;
  ...
  if (value == 'document_scanner_rounded') return Icons.document_scanner_rounded;
  if (value == 'document_scanner_outlined') return Icons.document_scanner_outlined;
  ...
  if (value == 'domain_disabled_rounded') return Icons.domain_disabled_rounded;
  if (value == 'domain_disabled_outlined') return Icons.domain_disabled_outlined;
  if (value == 'domain_verification') return Icons.domain_verification;
  if (value == 'domain_verification_sharp') return Icons.domain_verification_sharp;
  if (value == 'domain_verification_rounded') return Icons.domain_verification_rounded;
  if (value == 'domain_verification_outlined') return Icons.domain_verification_outlined;
  ...
  if (value == 'door_back_door_outlined') return Icons.door_back_door_outlined;
  if (value == 'door_front_door') return Icons.door_front_door;
  if (value == 'door_front_door_sharp') return Icons.door_front_door_sharp;
  if (value == 'door_front_door_rounded') return Icons.door_front_door_rounded;
  if (value == 'door_front_door_outlined') return Icons.door_front_door_outlined;
  ...
  if (value == 'downhill_skiing_rounded') return Icons.downhill_skiing_rounded;
  if (value == 'downhill_skiing_outlined') return Icons.downhill_skiing_outlined;
  ...
  if (value == 'download_for_offline_sharp') return Icons.download_for_offline_sharp;
  if (value == 'download_for_offline_rounded') return Icons.download_for_offline_rounded;
  if (value == 'download_for_offline_outlined') return Icons.download_for_offline_outlined;
  ...
  if (value == 'drag_indicator_outlined') return Icons.drag_indicator_outlined;
  ...
  if (value == 'drive_file_move_rounded') return Icons.drive_file_move_rounded;
  if (value == 'drive_file_move_outlined') return Icons.drive_file_move_outlined;
  if (value == 'drive_file_move_outline') return Icons.drive_file_move_outline;
  if (value == 'drive_file_move_rtl') return Icons.drive_file_move_rtl;
  if (value == 'drive_file_move_rtl_sharp') return Icons.drive_file_move_rtl_sharp;
  if (value == 'drive_file_move_rtl_rounded') return Icons.drive_file_move_rtl_rounded;
  if (value == 'drive_file_move_rtl_outlined') return Icons.drive_file_move_rtl_outlined;
  if (value == 'drive_file_rename_outline') return Icons.drive_file_rename_outline;
  if (value == 'drive_file_rename_outline_sharp') return Icons.drive_file_rename_outline_sharp;
  if (value == 'drive_file_rename_outline_rounded') return Icons.drive_file_rename_outline_rounded;
  if (value == 'drive_file_rename_outline_outlined') return Icons.drive_file_rename_outline_outlined;
  if (value == 'drive_folder_upload') return Icons.drive_folder_upload;
  if (value == 'drive_folder_upload_sharp') return Icons.drive_folder_upload_sharp;
  if (value == 'drive_folder_upload_rounded') return Icons.drive_folder_upload_rounded;
  if (value == 'drive_folder_upload_outlined') return Icons.drive_folder_upload_outlined;
  ...
  if (value == 'earbuds_battery_rounded') return Icons.earbuds_battery_rounded;
  if (value == 'earbuds_battery_outlined') return Icons.earbuds_battery_outlined;
  ...
  if (value == 'edgesensor_high_rounded') return Icons.edgesensor_high_rounded;
  if (value == 'edgesensor_high_outlined') return Icons.edgesensor_high_outlined;
  ...
  if (value == 'edgesensor_low_outlined') return Icons.edgesensor_low_outlined;
  ...
  if (value == 'edit_attributes_rounded') return Icons.edit_attributes_rounded;
  if (value == 'edit_attributes_outlined') return Icons.edit_attributes_outlined;
  ...
  if (value == 'edit_document') return Icons.edit_document;
  ...
  if (value == 'edit_location_alt_sharp') return Icons.edit_location_alt_sharp;
  if (value == 'edit_location_alt_rounded') return Icons.edit_location_alt_rounded;
  if (value == 'edit_location_alt_outlined') return Icons.edit_location_alt_outlined;
  ...
  if (value == 'edit_notifications_sharp') return Icons.edit_notifications_sharp;
  if (value == 'edit_notifications_rounded') return Icons.edit_notifications_rounded;
  if (value == 'edit_notifications_outlined') return Icons.edit_notifications_outlined;
  ...
  if (value == 'edit_square') return Icons.edit_square;
  ...
  if (value == 'electric_meter_outlined') return Icons.electric_meter_outlined;
  ...
  if (value == 'electric_moped_outlined') return Icons.electric_moped_outlined;
  if (value == 'electric_rickshaw') return Icons.electric_rickshaw;
  if (value == 'electric_rickshaw_sharp') return Icons.electric_rickshaw_sharp;
  if (value == 'electric_rickshaw_rounded') return Icons.electric_rickshaw_rounded;
  if (value == 'electric_rickshaw_outlined') return Icons.electric_rickshaw_outlined;
  ...
  if (value == 'electric_scooter_rounded') return Icons.electric_scooter_rounded;
  if (value == 'electric_scooter_outlined') return Icons.electric_scooter_outlined;
  if (value == 'electrical_services') return Icons.electrical_services;
  if (value == 'electrical_services_sharp') return Icons.electrical_services_sharp;
  if (value == 'electrical_services_rounded') return Icons.electrical_services_rounded;
  if (value == 'electrical_services_outlined') return Icons.electrical_services_outlined;
  ...
  if (value == 'emergency_recording_sharp') return Icons.emergency_recording_sharp;
  if (value == 'emergency_recording_rounded') return Icons.emergency_recording_rounded;
  if (value == 'emergency_recording_outlined') return Icons.emergency_recording_outlined;
  if (value == 'emergency_share') return Icons.emergency_share;
  if (value == 'emergency_share_sharp') return Icons.emergency_share_sharp;
  if (value == 'emergency_share_rounded') return Icons.emergency_share_rounded;
  if (value == 'emergency_share_outlined') return Icons.emergency_share_outlined;
  ...
  if (value == 'emoji_emotions_outlined') return Icons.emoji_emotions_outlined;
  ...
  if (value == 'emoji_food_beverage_sharp') return Icons.emoji_food_beverage_sharp;
  if (value == 'emoji_food_beverage_rounded') return Icons.emoji_food_beverage_rounded;
  if (value == 'emoji_food_beverage_outlined') return Icons.emoji_food_beverage_outlined;
  ...
  if (value == 'emoji_transportation_sharp') return Icons.emoji_transportation_sharp;
  if (value == 'emoji_transportation_rounded') return Icons.emoji_transportation_rounded;
  if (value == 'emoji_transportation_outlined') return Icons.emoji_transportation_outlined;
  if (value == 'energy_savings_leaf') return Icons.energy_savings_leaf;
  if (value == 'energy_savings_leaf_sharp') return Icons.energy_savings_leaf_sharp;
  if (value == 'energy_savings_leaf_rounded') return Icons.energy_savings_leaf_rounded;
  if (value == 'energy_savings_leaf_outlined') return Icons.energy_savings_leaf_outlined;
  ...
  if (value == 'enhance_photo_translate') return Icons.enhance_photo_translate;
  if (value == 'enhance_photo_translate_sharp') return Icons.enhance_photo_translate_sharp;
  if (value == 'enhance_photo_translate_rounded') return Icons.enhance_photo_translate_rounded;
  if (value == 'enhance_photo_translate_outlined') return Icons.enhance_photo_translate_outlined;
  if (value == 'enhanced_encryption') return Icons.enhanced_encryption;
  if (value == 'enhanced_encryption_sharp') return Icons.enhanced_encryption_sharp;
  if (value == 'enhanced_encryption_rounded') return Icons.enhanced_encryption_rounded;
  if (value == 'enhanced_encryption_outlined') return Icons.enhanced_encryption_outlined;
  ...
  if (value == 'escalator_warning_sharp') return Icons.escalator_warning_sharp;
  if (value == 'escalator_warning_rounded') return Icons.escalator_warning_rounded;
  if (value == 'escalator_warning_outlined') return Icons.escalator_warning_outlined;
  ...
  if (value == 'event_available_rounded') return Icons.event_available_rounded;
  if (value == 'event_available_outlined') return Icons.event_available_outlined;
  ...
  if (value == 'expand_circle_down_sharp') return Icons.expand_circle_down_sharp;
  if (value == 'expand_circle_down_rounded') return Icons.expand_circle_down_rounded;
  if (value == 'expand_circle_down_outlined') return Icons.expand_circle_down_outlined;
  ...
  if (value == 'exposure_minus_1_rounded') return Icons.exposure_minus_1_rounded;
  if (value == 'exposure_minus_1_outlined') return Icons.exposure_minus_1_outlined;
  ...
  if (value == 'exposure_minus_2_rounded') return Icons.exposure_minus_2_rounded;
  if (value == 'exposure_minus_2_outlined') return Icons.exposure_minus_2_outlined;
  ...
  if (value == 'exposure_neg_1_outlined') return Icons.exposure_neg_1_outlined;
  ...
  if (value == 'exposure_neg_2_outlined') return Icons.exposure_neg_2_outlined;
  if (value == 'exposure_plus_1') return Icons.exposure_plus_1;
  if (value == 'exposure_plus_1_sharp') return Icons.exposure_plus_1_sharp;
  if (value == 'exposure_plus_1_rounded') return Icons.exposure_plus_1_rounded;
  if (value == 'exposure_plus_1_outlined') return Icons.exposure_plus_1_outlined;
  if (value == 'exposure_plus_2') return Icons.exposure_plus_2;
  if (value == 'exposure_plus_2_sharp') return Icons.exposure_plus_2_sharp;
  if (value == 'exposure_plus_2_rounded') return Icons.exposure_plus_2_rounded;
  if (value == 'exposure_plus_2_outlined') return Icons.exposure_plus_2_outlined;
  ...
  if (value == 'face_2') return Icons.face_2;
  if (value == 'face_2_sharp') return Icons.face_2_sharp;
  if (value == 'face_2_rounded') return Icons.face_2_rounded;
  if (value == 'face_2_outlined') return Icons.face_2_outlined;
  if (value == 'face_3') return Icons.face_3;
  if (value == 'face_3_sharp') return Icons.face_3_sharp;
  if (value == 'face_3_rounded') return Icons.face_3_rounded;
  if (value == 'face_3_outlined') return Icons.face_3_outlined;
  if (value == 'face_4') return Icons.face_4;
  if (value == 'face_4_sharp') return Icons.face_4_sharp;
  if (value == 'face_4_rounded') return Icons.face_4_rounded;
  if (value == 'face_4_outlined') return Icons.face_4_outlined;
  if (value == 'face_5') return Icons.face_5;
  if (value == 'face_5_sharp') return Icons.face_5_sharp;
  if (value == 'face_5_rounded') return Icons.face_5_rounded;
  if (value == 'face_5_outlined') return Icons.face_5_outlined;
  if (value == 'face_6') return Icons.face_6;
  if (value == 'face_6_sharp') return Icons.face_6_sharp;
  if (value == 'face_6_rounded') return Icons.face_6_rounded;
  if (value == 'face_6_outlined') return Icons.face_6_outlined;
  if (value == 'face_retouching_natural') return Icons.face_retouching_natural;
  if (value == 'face_retouching_natural_sharp') return Icons.face_retouching_natural_sharp;
  if (value == 'face_retouching_natural_rounded') return Icons.face_retouching_natural_rounded;
  if (value == 'face_retouching_natural_outlined') return Icons.face_retouching_natural_outlined;
  if (value == 'face_retouching_off') return Icons.face_retouching_off;
  if (value == 'face_retouching_off_sharp') return Icons.face_retouching_off_sharp;
  if (value == 'face_retouching_off_rounded') return Icons.face_retouching_off_rounded;
  if (value == 'face_retouching_off_outlined') return Icons.face_retouching_off_outlined;
  ...
  if (value == 'family_restroom_rounded') return Icons.family_restroom_rounded;
  if (value == 'family_restroom_outlined') return Icons.family_restroom_outlined;
  ...
  if (value == 'favorite_border_rounded') return Icons.favorite_border_rounded;
  if (value == 'favorite_border_outlined') return Icons.favorite_border_outlined;
  ...
  if (value == 'favorite_outline_rounded') return Icons.favorite_outline_rounded;
  if (value == 'favorite_outline_outlined') return Icons.favorite_outline_outlined;
  ...
  if (value == 'featured_play_list_sharp') return Icons.featured_play_list_sharp;
  if (value == 'featured_play_list_rounded') return Icons.featured_play_list_rounded;
  if (value == 'featured_play_list_outlined') return Icons.featured_play_list_outlined;
  ...
  if (value == 'featured_video_outlined') return Icons.featured_video_outlined;
  ...
  if (value == 'fiber_manual_record_sharp') return Icons.fiber_manual_record_sharp;
  if (value == 'fiber_manual_record_rounded') return Icons.fiber_manual_record_rounded;
  if (value == 'fiber_manual_record_outlined') return Icons.fiber_manual_record_outlined;
  ...
  if (value == 'fiber_smart_record_sharp') return Icons.fiber_smart_record_sharp;
  if (value == 'fiber_smart_record_rounded') return Icons.fiber_smart_record_rounded;
  if (value == 'fiber_smart_record_outlined') return Icons.fiber_smart_record_outlined;
  ...
  if (value == 'file_download_done_sharp') return Icons.file_download_done_sharp;
  if (value == 'file_download_done_rounded') return Icons.file_download_done_rounded;
  if (value == 'file_download_done_outlined') return Icons.file_download_done_outlined;
  if (value == 'file_download_off') return Icons.file_download_off;
  if (value == 'file_download_off_sharp') return Icons.file_download_off_sharp;
  if (value == 'file_download_off_rounded') return Icons.file_download_off_rounded;
  if (value == 'file_download_off_outlined') return Icons.file_download_off_outlined;
  ...
  if (value == 'file_upload_off') return Icons.file_upload_off;
  ...
  if (value == 'filter_alt_off_outlined') return Icons.filter_alt_off_outlined;
  ...
  if (value == 'filter_b_and_w_outlined') return Icons.filter_b_and_w_outlined;
  if (value == 'filter_center_focus') return Icons.filter_center_focus;
  if (value == 'filter_center_focus_sharp') return Icons.filter_center_focus_sharp;
  if (value == 'filter_center_focus_rounded') return Icons.filter_center_focus_rounded;
  if (value == 'filter_center_focus_outlined') return Icons.filter_center_focus_outlined;
  ...
  if (value == 'filter_list_off_rounded') return Icons.filter_list_off_rounded;
  if (value == 'filter_list_off_outlined') return Icons.filter_list_off_outlined;
  ...
  if (value == 'filter_tilt_shift_sharp') return Icons.filter_tilt_shift_sharp;
  if (value == 'filter_tilt_shift_rounded') return Icons.filter_tilt_shift_rounded;
  if (value == 'filter_tilt_shift_outlined') return Icons.filter_tilt_shift_outlined;
  ...
  if (value == 'filter_vintage_outlined') return Icons.filter_vintage_outlined;
  ...
  if (value == 'fire_extinguisher_sharp') return Icons.fire_extinguisher_sharp;
  if (value == 'fire_extinguisher_rounded') return Icons.fire_extinguisher_rounded;
  if (value == 'fire_extinguisher_outlined') return Icons.fire_extinguisher_outlined;
  ...
  if (value == 'fire_hydrant_alt_rounded') return Icons.fire_hydrant_alt_rounded;
  if (value == 'fire_hydrant_alt_outlined') return Icons.fire_hydrant_alt_outlined;
  ...
  if (value == 'fitness_center_outlined') return Icons.fitness_center_outlined;
  ...
  if (value == 'flashlight_off_outlined') return Icons.flashlight_off_outlined;
  ...
  if (value == 'flight_takeoff_outlined') return Icons.flight_takeoff_outlined;
  ...
  if (value == 'flip_camera_android_sharp') return Icons.flip_camera_android_sharp;
  if (value == 'flip_camera_android_rounded') return Icons.flip_camera_android_rounded;
  if (value == 'flip_camera_android_outlined') return Icons.flip_camera_android_outlined;
  if (value == 'flip_camera_ios') return Icons.flip_camera_ios;
  if (value == 'flip_camera_ios_sharp') return Icons.flip_camera_ios_sharp;
  if (value == 'flip_camera_ios_rounded') return Icons.flip_camera_ios_rounded;
  if (value == 'flip_camera_ios_outlined') return Icons.flip_camera_ios_outlined;
  ...
  if (value == 'fluorescent') return Icons.fluorescent;
  if (value == 'fluorescent_sharp') return Icons.fluorescent_sharp;
  if (value == 'fluorescent_rounded') return Icons.fluorescent_rounded;
  if (value == 'fluorescent_outlined') return Icons.fluorescent_outlined;
  ...
  if (value == 'folder_special_outlined') return Icons.folder_special_outlined;
  ...
  if (value == 'follow_the_signs_rounded') return Icons.follow_the_signs_rounded;
  if (value == 'follow_the_signs_outlined') return Icons.follow_the_signs_outlined;
  ...
  if (value == 'font_download_off_sharp') return Icons.font_download_off_sharp;
  if (value == 'font_download_off_rounded') return Icons.font_download_off_rounded;
  if (value == 'font_download_off_outlined') return Icons.font_download_off_outlined;
  ...
  if (value == 'forklift') return Icons.forklift;
  if (value == 'format_align_center') return Icons.format_align_center;
  if (value == 'format_align_center_sharp') return Icons.format_align_center_sharp;
  if (value == 'format_align_center_rounded') return Icons.format_align_center_rounded;
  if (value == 'format_align_center_outlined') return Icons.format_align_center_outlined;
  if (value == 'format_align_justify') return Icons.format_align_justify;
  if (value == 'format_align_justify_sharp') return Icons.format_align_justify_sharp;
  if (value == 'format_align_justify_rounded') return Icons.format_align_justify_rounded;
  if (value == 'format_align_justify_outlined') return Icons.format_align_justify_outlined;
  if (value == 'format_align_left') return Icons.format_align_left;
  if (value == 'format_align_left_sharp') return Icons.format_align_left_sharp;
  if (value == 'format_align_left_rounded') return Icons.format_align_left_rounded;
  if (value == 'format_align_left_outlined') return Icons.format_align_left_outlined;
  if (value == 'format_align_right') return Icons.format_align_right;
  if (value == 'format_align_right_sharp') return Icons.format_align_right_sharp;
  if (value == 'format_align_right_rounded') return Icons.format_align_right_rounded;
  if (value == 'format_align_right_outlined') return Icons.format_align_right_outlined;
  ...
  if (value == 'format_color_fill_sharp') return Icons.format_color_fill_sharp;
  if (value == 'format_color_fill_rounded') return Icons.format_color_fill_rounded;
  if (value == 'format_color_fill_outlined') return Icons.format_color_fill_outlined;
  if (value == 'format_color_reset') return Icons.format_color_reset;
  if (value == 'format_color_reset_sharp') return Icons.format_color_reset_sharp;
  if (value == 'format_color_reset_rounded') return Icons.format_color_reset_rounded;
  if (value == 'format_color_reset_outlined') return Icons.format_color_reset_outlined;
  if (value == 'format_color_text') return Icons.format_color_text;
  if (value == 'format_color_text_sharp') return Icons.format_color_text_sharp;
  if (value == 'format_color_text_rounded') return Icons.format_color_text_rounded;
  if (value == 'format_color_text_outlined') return Icons.format_color_text_outlined;
  if (value == 'format_indent_decrease') return Icons.format_indent_decrease;
  if (value == 'format_indent_decrease_sharp') return Icons.format_indent_decrease_sharp;
  if (value == 'format_indent_decrease_rounded') return Icons.format_indent_decrease_rounded;
  if (value == 'format_indent_decrease_outlined') return Icons.format_indent_decrease_outlined;
  if (value == 'format_indent_increase') return Icons.format_indent_increase;
  if (value == 'format_indent_increase_sharp') return Icons.format_indent_increase_sharp;
  if (value == 'format_indent_increase_rounded') return Icons.format_indent_increase_rounded;
  if (value == 'format_indent_increase_outlined') return Icons.format_indent_increase_outlined;
  ...
  if (value == 'format_line_spacing_sharp') return Icons.format_line_spacing_sharp;
  if (value == 'format_line_spacing_rounded') return Icons.format_line_spacing_rounded;
  if (value == 'format_line_spacing_outlined') return Icons.format_line_spacing_outlined;
  if (value == 'format_list_bulleted') return Icons.format_list_bulleted;
  if (value == 'format_list_bulleted_sharp') return Icons.format_list_bulleted_sharp;
  if (value == 'format_list_bulleted_rounded') return Icons.format_list_bulleted_rounded;
  if (value == 'format_list_bulleted_outlined') return Icons.format_list_bulleted_outlined;
  if (value == 'format_list_bulleted_add') return Icons.format_list_bulleted_add;
  if (value == 'format_list_numbered') return Icons.format_list_numbered;
  if (value == 'format_list_numbered_sharp') return Icons.format_list_numbered_sharp;
  if (value == 'format_list_numbered_rounded') return Icons.format_list_numbered_rounded;
  if (value == 'format_list_numbered_outlined') return Icons.format_list_numbered_outlined;
  if (value == 'format_list_numbered_rtl') return Icons.format_list_numbered_rtl;
  if (value == 'format_list_numbered_rtl_sharp') return Icons.format_list_numbered_rtl_sharp;
  if (value == 'format_list_numbered_rtl_rounded') return Icons.format_list_numbered_rtl_rounded;
  if (value == 'format_list_numbered_rtl_outlined') return Icons.format_list_numbered_rtl_outlined;
  if (value == 'format_overline') return Icons.format_overline;
  if (value == 'format_overline_sharp') return Icons.format_overline_sharp;
  if (value == 'format_overline_rounded') return Icons.format_overline_rounded;
  if (value == 'format_overline_outlined') return Icons.format_overline_outlined;
  ...
  if (value == 'format_strikethrough_sharp') return Icons.format_strikethrough_sharp;
  if (value == 'format_strikethrough_rounded') return Icons.format_strikethrough_rounded;
  if (value == 'format_strikethrough_outlined') return Icons.format_strikethrough_outlined;
  if (value == 'format_textdirection_l_to_r') return Icons.format_textdirection_l_to_r;
  if (value == 'format_textdirection_l_to_r_sharp') return Icons.format_textdirection_l_to_r_sharp;
  if (value == 'format_textdirection_l_to_r_rounded') return Icons.format_textdirection_l_to_r_rounded;
  if (value == 'format_textdirection_l_to_r_outlined') return Icons.format_textdirection_l_to_r_outlined;
  if (value == 'format_textdirection_r_to_l') return Icons.format_textdirection_r_to_l;
  if (value == 'format_textdirection_r_to_l_sharp') return Icons.format_textdirection_r_to_l_sharp;
  if (value == 'format_textdirection_r_to_l_rounded') return Icons.format_textdirection_r_to_l_rounded;
  if (value == 'format_textdirection_r_to_l_outlined') return Icons.format_textdirection_r_to_l_outlined;
  ...
  if (value == 'format_underline_rounded') return Icons.format_underline_rounded;
  if (value == 'format_underline_outlined') return Icons.format_underline_outlined;
  if (value == 'format_underlined') return Icons.format_underlined;
  if (value == 'format_underlined_sharp') return Icons.format_underlined_sharp;
  if (value == 'format_underlined_rounded') return Icons.format_underlined_rounded;
  if (value == 'format_underlined_outlined') return Icons.format_underlined_outlined;
  ...
  if (value == 'forward_to_inbox_rounded') return Icons.forward_to_inbox_rounded;
  if (value == 'forward_to_inbox_outlined') return Icons.forward_to_inbox_outlined;
  ...
  if (value == 'free_breakfast_outlined') return Icons.free_breakfast_outlined;
  if (value == 'free_cancellation') return Icons.free_cancellation;
  if (value == 'free_cancellation_sharp') return Icons.free_cancellation_sharp;
  if (value == 'free_cancellation_rounded') return Icons.free_cancellation_rounded;
  if (value == 'free_cancellation_outlined') return Icons.free_cancellation_outlined;
  ...
  if (value == 'front_loader') return Icons.front_loader;
  ...
  if (value == 'fullscreen_exit_rounded') return Icons.fullscreen_exit_rounded;
  if (value == 'fullscreen_exit_outlined') return Icons.fullscreen_exit_outlined;
  ...
  if (value == 'generating_tokens_sharp') return Icons.generating_tokens_sharp;
  if (value == 'generating_tokens_rounded') return Icons.generating_tokens_rounded;
  if (value == 'generating_tokens_outlined') return Icons.generating_tokens_outlined;
  ...
  if (value == 'grid_goldenratio_rounded') return Icons.grid_goldenratio_rounded;
  if (value == 'grid_goldenratio_outlined') return Icons.grid_goldenratio_outlined;
  ...
  if (value == 'groups_2') return Icons.groups_2;
  if (value == 'groups_2_sharp') return Icons.groups_2_sharp;
  if (value == 'groups_2_rounded') return Icons.groups_2_rounded;
  if (value == 'groups_2_outlined') return Icons.groups_2_outlined;
  if (value == 'groups_3') return Icons.groups_3;
  if (value == 'groups_3_sharp') return Icons.groups_3_sharp;
  if (value == 'groups_3_rounded') return Icons.groups_3_rounded;
  if (value == 'groups_3_outlined') return Icons.groups_3_outlined;
  ...
  if (value == 'h_plus_mobiledata_sharp') return Icons.h_plus_mobiledata_sharp;
  if (value == 'h_plus_mobiledata_rounded') return Icons.h_plus_mobiledata_rounded;
  if (value == 'h_plus_mobiledata_outlined') return Icons.h_plus_mobiledata_outlined;
  ...
  if (value == 'hdr_auto_select_rounded') return Icons.hdr_auto_select_rounded;
  if (value == 'hdr_auto_select_outlined') return Icons.hdr_auto_select_outlined;
  if (value == 'hdr_enhanced_select') return Icons.hdr_enhanced_select;
  if (value == 'hdr_enhanced_select_sharp') return Icons.hdr_enhanced_select_sharp;
  if (value == 'hdr_enhanced_select_rounded') return Icons.hdr_enhanced_select_rounded;
  if (value == 'hdr_enhanced_select_outlined') return Icons.hdr_enhanced_select_outlined;
  ...
  if (value == 'hdr_off_select_outlined') return Icons.hdr_off_select_outlined;
  ...
  if (value == 'headphones_battery_sharp') return Icons.headphones_battery_sharp;
  if (value == 'headphones_battery_rounded') return Icons.headphones_battery_rounded;
  if (value == 'headphones_battery_outlined') return Icons.headphones_battery_outlined;
  ...
  if (value == 'health_and_safety_sharp') return Icons.health_and_safety_sharp;
  if (value == 'health_and_safety_rounded') return Icons.health_and_safety_rounded;
  if (value == 'health_and_safety_outlined') return Icons.health_and_safety_outlined;
  ...
  if (value == 'hearing_disabled_rounded') return Icons.hearing_disabled_rounded;
  if (value == 'hearing_disabled_outlined') return Icons.hearing_disabled_outlined;
  ...
  if (value == 'highlight_remove_rounded') return Icons.highlight_remove_rounded;
  if (value == 'highlight_remove_outlined') return Icons.highlight_remove_outlined;
  ...
  if (value == 'history_toggle_off_sharp') return Icons.history_toggle_off_sharp;
  if (value == 'history_toggle_off_rounded') return Icons.history_toggle_off_rounded;
  if (value == 'history_toggle_off_outlined') return Icons.history_toggle_off_outlined;
  ...
  if (value == 'holiday_village_rounded') return Icons.holiday_village_rounded;
  if (value == 'holiday_village_outlined') return Icons.holiday_village_outlined;
  ...
  if (value == 'home_repair_service_sharp') return Icons.home_repair_service_sharp;
  if (value == 'home_repair_service_rounded') return Icons.home_repair_service_rounded;
  if (value == 'home_repair_service_outlined') return Icons.home_repair_service_outlined;
  ...
  if (value == 'horizontal_distribute_sharp') return Icons.horizontal_distribute_sharp;
  if (value == 'horizontal_distribute_rounded') return Icons.horizontal_distribute_rounded;
  if (value == 'horizontal_distribute_outlined') return Icons.horizontal_distribute_outlined;
  if (value == 'horizontal_rule') return Icons.horizontal_rule;
  if (value == 'horizontal_rule_sharp') return Icons.horizontal_rule_sharp;
  if (value == 'horizontal_rule_rounded') return Icons.horizontal_rule_rounded;
  if (value == 'horizontal_rule_outlined') return Icons.horizontal_rule_outlined;
  ...
  if (value == 'horizontal_split_rounded') return Icons.horizontal_split_rounded;
  if (value == 'horizontal_split_outlined') return Icons.horizontal_split_outlined;
  ...
  if (value == 'hourglass_bottom_rounded') return Icons.hourglass_bottom_rounded;
  if (value == 'hourglass_bottom_outlined') return Icons.hourglass_bottom_outlined;
  if (value == 'hourglass_disabled') return Icons.hourglass_disabled;
  if (value == 'hourglass_disabled_sharp') return Icons.hourglass_disabled_sharp;
  if (value == 'hourglass_disabled_rounded') return Icons.hourglass_disabled_rounded;
  if (value == 'hourglass_disabled_outlined') return Icons.hourglass_disabled_outlined;
  if (value == 'hourglass_empty') return Icons.hourglass_empty;
  if (value == 'hourglass_empty_sharp') return Icons.hourglass_empty_sharp;
  if (value == 'hourglass_empty_rounded') return Icons.hourglass_empty_rounded;
  if (value == 'hourglass_empty_outlined') return Icons.hourglass_empty_outlined;
  ...
  if (value == 'hourglass_full_outlined') return Icons.hourglass_full_outlined;
  ...
  if (value == 'image_aspect_ratio_sharp') return Icons.image_aspect_ratio_sharp;
  if (value == 'image_aspect_ratio_rounded') return Icons.image_aspect_ratio_rounded;
  if (value == 'image_aspect_ratio_outlined') return Icons.image_aspect_ratio_outlined;
  if (value == 'image_not_supported') return Icons.image_not_supported;
  if (value == 'image_not_supported_sharp') return Icons.image_not_supported_sharp;
  if (value == 'image_not_supported_rounded') return Icons.image_not_supported_rounded;
  if (value == 'image_not_supported_outlined') return Icons.image_not_supported_outlined;
  ...
  if (value == 'imagesearch_roller_sharp') return Icons.imagesearch_roller_sharp;
  if (value == 'imagesearch_roller_rounded') return Icons.imagesearch_roller_rounded;
  if (value == 'imagesearch_roller_outlined') return Icons.imagesearch_roller_outlined;
  if (value == 'import_contacts') return Icons.import_contacts;
  if (value == 'import_contacts_sharp') return Icons.import_contacts_sharp;
  if (value == 'import_contacts_rounded') return Icons.import_contacts_rounded;
  if (value == 'import_contacts_outlined') return Icons.import_contacts_outlined;
  ...
  if (value == 'important_devices_sharp') return Icons.important_devices_sharp;
  if (value == 'important_devices_rounded') return Icons.important_devices_rounded;
  if (value == 'important_devices_outlined') return Icons.important_devices_outlined;
  ...
  if (value == 'incomplete_circle_sharp') return Icons.incomplete_circle_sharp;
  if (value == 'incomplete_circle_rounded') return Icons.incomplete_circle_rounded;
  if (value == 'incomplete_circle_outlined') return Icons.incomplete_circle_outlined;
  if (value == 'indeterminate_check_box') return Icons.indeterminate_check_box;
  if (value == 'indeterminate_check_box_sharp') return Icons.indeterminate_check_box_sharp;
  if (value == 'indeterminate_check_box_rounded') return Icons.indeterminate_check_box_rounded;
  if (value == 'indeterminate_check_box_outlined') return Icons.indeterminate_check_box_outlined;
  ...
  if (value == 'insert_chart_outlined_sharp') return Icons.insert_chart_outlined_sharp;
  if (value == 'insert_chart_outlined_rounded') return Icons.insert_chart_outlined_rounded;
  if (value == 'insert_chart_outlined_outlined') return Icons.insert_chart_outlined_outlined;
  ...
  if (value == 'insert_comment_outlined') return Icons.insert_comment_outlined;
  if (value == 'insert_drive_file') return Icons.insert_drive_file;
  if (value == 'insert_drive_file_sharp') return Icons.insert_drive_file_sharp;
  if (value == 'insert_drive_file_rounded') return Icons.insert_drive_file_rounded;
  if (value == 'insert_drive_file_outlined') return Icons.insert_drive_file_outlined;
  if (value == 'insert_emoticon') return Icons.insert_emoticon;
  if (value == 'insert_emoticon_sharp') return Icons.insert_emoticon_sharp;
  if (value == 'insert_emoticon_rounded') return Icons.insert_emoticon_rounded;
  if (value == 'insert_emoticon_outlined') return Icons.insert_emoticon_outlined;
  if (value == 'insert_invitation') return Icons.insert_invitation;
  if (value == 'insert_invitation_sharp') return Icons.insert_invitation_sharp;
  if (value == 'insert_invitation_rounded') return Icons.insert_invitation_rounded;
  if (value == 'insert_invitation_outlined') return Icons.insert_invitation_outlined;
  ...
  if (value == 'insert_page_break_sharp') return Icons.insert_page_break_sharp;
  if (value == 'insert_page_break_rounded') return Icons.insert_page_break_rounded;
  if (value == 'insert_page_break_outlined') return Icons.insert_page_break_outlined;
  ...
  if (value == 'install_desktop_rounded') return Icons.install_desktop_rounded;
  if (value == 'install_desktop_outlined') return Icons.install_desktop_outlined;
  ...
  if (value == 'install_mobile_outlined') return Icons.install_mobile_outlined;
  if (value == 'integration_instructions') return Icons.integration_instructions;
  if (value == 'integration_instructions_sharp') return Icons.integration_instructions_sharp;
  if (value == 'integration_instructions_rounded') return Icons.integration_instructions_rounded;
  if (value == 'integration_instructions_outlined') return Icons.integration_instructions_outlined;
  ...
  if (value == 'interpreter_mode_rounded') return Icons.interpreter_mode_rounded;
  if (value == 'interpreter_mode_outlined') return Icons.interpreter_mode_outlined;
  ...
  if (value == 'invert_colors_off_sharp') return Icons.invert_colors_off_sharp;
  if (value == 'invert_colors_off_rounded') return Icons.invert_colors_off_rounded;
  if (value == 'invert_colors_off_outlined') return Icons.invert_colors_off_outlined;
  ...
  if (value == 'invert_colors_on_rounded') return Icons.invert_colors_on_rounded;
  if (value == 'invert_colors_on_outlined') return Icons.invert_colors_on_outlined;
  ...
  if (value == 'keyboard_arrow_down_sharp') return Icons.keyboard_arrow_down_sharp;
  if (value == 'keyboard_arrow_down_rounded') return Icons.keyboard_arrow_down_rounded;
  if (value == 'keyboard_arrow_down_outlined') return Icons.keyboard_arrow_down_outlined;
  if (value == 'keyboard_arrow_left') return Icons.keyboard_arrow_left;
  if (value == 'keyboard_arrow_left_sharp') return Icons.keyboard_arrow_left_sharp;
  if (value == 'keyboard_arrow_left_rounded') return Icons.keyboard_arrow_left_rounded;
  if (value == 'keyboard_arrow_left_outlined') return Icons.keyboard_arrow_left_outlined;
  if (value == 'keyboard_arrow_right') return Icons.keyboard_arrow_right;
  if (value == 'keyboard_arrow_right_sharp') return Icons.keyboard_arrow_right_sharp;
  if (value == 'keyboard_arrow_right_rounded') return Icons.keyboard_arrow_right_rounded;
  if (value == 'keyboard_arrow_right_outlined') return Icons.keyboard_arrow_right_outlined;
  if (value == 'keyboard_arrow_up') return Icons.keyboard_arrow_up;
  if (value == 'keyboard_arrow_up_sharp') return Icons.keyboard_arrow_up_sharp;
  if (value == 'keyboard_arrow_up_rounded') return Icons.keyboard_arrow_up_rounded;
  if (value == 'keyboard_arrow_up_outlined') return Icons.keyboard_arrow_up_outlined;
  if (value == 'keyboard_backspace') return Icons.keyboard_backspace;
  if (value == 'keyboard_backspace_sharp') return Icons.keyboard_backspace_sharp;
  if (value == 'keyboard_backspace_rounded') return Icons.keyboard_backspace_rounded;
  if (value == 'keyboard_backspace_outlined') return Icons.keyboard_backspace_outlined;
  if (value == 'keyboard_capslock') return Icons.keyboard_capslock;
  if (value == 'keyboard_capslock_sharp') return Icons.keyboard_capslock_sharp;
  if (value == 'keyboard_capslock_rounded') return Icons.keyboard_capslock_rounded;
  if (value == 'keyboard_capslock_outlined') return Icons.keyboard_capslock_outlined;
  if (value == 'keyboard_command_key') return Icons.keyboard_command_key;
  if (value == 'keyboard_command_key_sharp') return Icons.keyboard_command_key_sharp;
  if (value == 'keyboard_command_key_rounded') return Icons.keyboard_command_key_rounded;
  if (value == 'keyboard_command_key_outlined') return Icons.keyboard_command_key_outlined;
  ...
  if (value == 'keyboard_control_rounded') return Icons.keyboard_control_rounded;
  if (value == 'keyboard_control_outlined') return Icons.keyboard_control_outlined;
  if (value == 'keyboard_control_key') return Icons.keyboard_control_key;
  if (value == 'keyboard_control_key_sharp') return Icons.keyboard_control_key_sharp;
  if (value == 'keyboard_control_key_rounded') return Icons.keyboard_control_key_rounded;
  if (value == 'keyboard_control_key_outlined') return Icons.keyboard_control_key_outlined;
  if (value == 'keyboard_double_arrow_down') return Icons.keyboard_double_arrow_down;
  if (value == 'keyboard_double_arrow_down_sharp') return Icons.keyboard_double_arrow_down_sharp;
  if (value == 'keyboard_double_arrow_down_rounded') return Icons.keyboard_double_arrow_down_rounded;
  if (value == 'keyboard_double_arrow_down_outlined') return Icons.keyboard_double_arrow_down_outlined;
  if (value == 'keyboard_double_arrow_left') return Icons.keyboard_double_arrow_left;
  if (value == 'keyboard_double_arrow_left_sharp') return Icons.keyboard_double_arrow_left_sharp;
  if (value == 'keyboard_double_arrow_left_rounded') return Icons.keyboard_double_arrow_left_rounded;
  if (value == 'keyboard_double_arrow_left_outlined') return Icons.keyboard_double_arrow_left_outlined;
  if (value == 'keyboard_double_arrow_right') return Icons.keyboard_double_arrow_right;
  if (value == 'keyboard_double_arrow_right_sharp') return Icons.keyboard_double_arrow_right_sharp;
  if (value == 'keyboard_double_arrow_right_rounded') return Icons.keyboard_double_arrow_right_rounded;
  if (value == 'keyboard_double_arrow_right_outlined') return Icons.keyboard_double_arrow_right_outlined;
  if (value == 'keyboard_double_arrow_up') return Icons.keyboard_double_arrow_up;
  if (value == 'keyboard_double_arrow_up_sharp') return Icons.keyboard_double_arrow_up_sharp;
  if (value == 'keyboard_double_arrow_up_rounded') return Icons.keyboard_double_arrow_up_rounded;
  if (value == 'keyboard_double_arrow_up_outlined') return Icons.keyboard_double_arrow_up_outlined;
  ...
  if (value == 'keyboard_option_key_sharp') return Icons.keyboard_option_key_sharp;
  if (value == 'keyboard_option_key_rounded') return Icons.keyboard_option_key_rounded;
  if (value == 'keyboard_option_key_outlined') return Icons.keyboard_option_key_outlined;
  if (value == 'keyboard_return') return Icons.keyboard_return;
  if (value == 'keyboard_return_sharp') return Icons.keyboard_return_sharp;
  if (value == 'keyboard_return_rounded') return Icons.keyboard_return_rounded;
  if (value == 'keyboard_return_outlined') return Icons.keyboard_return_outlined;
  ...
  if (value == 'keyboard_voice_outlined') return Icons.keyboard_voice_outlined;
  ...
  if (value == 'label_important_rounded') return Icons.label_important_rounded;
  if (value == 'label_important_outlined') return Icons.label_important_outlined;
  if (value == 'label_important_outline') return Icons.label_important_outline;
  if (value == 'label_important_outline_sharp') return Icons.label_important_outline_sharp;
  if (value == 'label_important_outline_rounded') return Icons.label_important_outline_rounded;
  ...
  if (value == 'laptop_chromebook_sharp') return Icons.laptop_chromebook_sharp;
  if (value == 'laptop_chromebook_rounded') return Icons.laptop_chromebook_rounded;
  if (value == 'laptop_chromebook_outlined') return Icons.laptop_chromebook_outlined;
  ...
  if (value == 'laptop_windows_outlined') return Icons.laptop_windows_outlined;
  ...
  if (value == 'leave_bags_at_home_sharp') return Icons.leave_bags_at_home_sharp;
  if (value == 'leave_bags_at_home_rounded') return Icons.leave_bags_at_home_rounded;
  if (value == 'leave_bags_at_home_outlined') return Icons.leave_bags_at_home_outlined;
  ...
  if (value == 'library_add_check_sharp') return Icons.library_add_check_sharp;
  if (value == 'library_add_check_rounded') return Icons.library_add_check_rounded;
  if (value == 'library_add_check_outlined') return Icons.library_add_check_outlined;
  ...
  if (value == 'lightbulb_circle_rounded') return Icons.lightbulb_circle_rounded;
  if (value == 'lightbulb_circle_outlined') return Icons.lightbulb_circle_outlined;
  if (value == 'lightbulb_outline') return Icons.lightbulb_outline;
  if (value == 'lightbulb_outline_sharp') return Icons.lightbulb_outline_sharp;
  if (value == 'lightbulb_outline_rounded') return Icons.lightbulb_outline_rounded;
  ...
  if (value == 'local_activity_outlined') return Icons.local_activity_outlined;
  ...
  if (value == 'local_attraction_rounded') return Icons.local_attraction_rounded;
  if (value == 'local_attraction_outlined') return Icons.local_attraction_outlined;
  ...
  if (value == 'local_car_wash_outlined') return Icons.local_car_wash_outlined;
  if (value == 'local_convenience_store') return Icons.local_convenience_store;
  if (value == 'local_convenience_store_sharp') return Icons.local_convenience_store_sharp;
  if (value == 'local_convenience_store_rounded') return Icons.local_convenience_store_rounded;
  if (value == 'local_convenience_store_outlined') return Icons.local_convenience_store_outlined;
  ...
  if (value == 'local_fire_department_sharp') return Icons.local_fire_department_sharp;
  if (value == 'local_fire_department_rounded') return Icons.local_fire_department_rounded;
  if (value == 'local_fire_department_outlined') return Icons.local_fire_department_outlined;
  ...
  if (value == 'local_gas_station_sharp') return Icons.local_gas_station_sharp;
  if (value == 'local_gas_station_rounded') return Icons.local_gas_station_rounded;
  if (value == 'local_gas_station_outlined') return Icons.local_gas_station_outlined;
  if (value == 'local_grocery_store') return Icons.local_grocery_store;
  if (value == 'local_grocery_store_sharp') return Icons.local_grocery_store_sharp;
  if (value == 'local_grocery_store_rounded') return Icons.local_grocery_store_rounded;
  if (value == 'local_grocery_store_outlined') return Icons.local_grocery_store_outlined;
  ...
  if (value == 'local_hospital_outlined') return Icons.local_hospital_outlined;
  ...
  if (value == 'local_laundry_service_sharp') return Icons.local_laundry_service_sharp;
  if (value == 'local_laundry_service_rounded') return Icons.local_laundry_service_rounded;
  if (value == 'local_laundry_service_outlined') return Icons.local_laundry_service_outlined;
  ...
  if (value == 'local_pharmacy_outlined') return Icons.local_pharmacy_outlined;
  ...
  if (value == 'local_post_office_sharp') return Icons.local_post_office_sharp;
  if (value == 'local_post_office_rounded') return Icons.local_post_office_rounded;
  if (value == 'local_post_office_outlined') return Icons.local_post_office_outlined;
  ...
  if (value == 'local_print_shop_rounded') return Icons.local_print_shop_rounded;
  if (value == 'local_print_shop_outlined') return Icons.local_print_shop_outlined;
  if (value == 'local_printshop') return Icons.local_printshop;
  if (value == 'local_printshop_sharp') return Icons.local_printshop_sharp;
  if (value == 'local_printshop_rounded') return Icons.local_printshop_rounded;
  if (value == 'local_printshop_outlined') return Icons.local_printshop_outlined;
  ...
  if (value == 'local_restaurant_rounded') return Icons.local_restaurant_rounded;
  if (value == 'local_restaurant_outlined') return Icons.local_restaurant_outlined;
  ...
  if (value == 'local_shipping_outlined') return Icons.local_shipping_outlined;
  ...
  if (value == 'location_disabled_sharp') return Icons.location_disabled_sharp;
  if (value == 'location_disabled_rounded') return Icons.location_disabled_rounded;
  if (value == 'location_disabled_outlined') return Icons.location_disabled_outlined;
  ...
  if (value == 'location_history_rounded') return Icons.location_history_rounded;
  if (value == 'location_history_outlined') return Icons.location_history_outlined;
  ...
  if (value == 'location_searching_sharp') return Icons.location_searching_sharp;
  if (value == 'location_searching_rounded') return Icons.location_searching_rounded;
  if (value == 'location_searching_outlined') return Icons.location_searching_outlined;
  ...
  if (value == 'lte_mobiledata_outlined') return Icons.lte_mobiledata_outlined;
  if (value == 'lte_plus_mobiledata') return Icons.lte_plus_mobiledata;
  if (value == 'lte_plus_mobiledata_sharp') return Icons.lte_plus_mobiledata_sharp;
  if (value == 'lte_plus_mobiledata_rounded') return Icons.lte_plus_mobiledata_rounded;
  if (value == 'lte_plus_mobiledata_outlined') return Icons.lte_plus_mobiledata_outlined;
  ...
  if (value == 'macro_off') return Icons.macro_off;
  if (value == 'macro_off_sharp') return Icons.macro_off_sharp;
  if (value == 'macro_off_rounded') return Icons.macro_off_rounded;
  if (value == 'macro_off_outlined') return Icons.macro_off_outlined;
  ...
  if (value == 'man_2') return Icons.man_2;
  if (value == 'man_2_sharp') return Icons.man_2_sharp;
  if (value == 'man_2_rounded') return Icons.man_2_rounded;
  if (value == 'man_2_outlined') return Icons.man_2_outlined;
  if (value == 'man_3') return Icons.man_3;
  if (value == 'man_3_sharp') return Icons.man_3_sharp;
  if (value == 'man_3_rounded') return Icons.man_3_rounded;
  if (value == 'man_3_outlined') return Icons.man_3_outlined;
  if (value == 'man_4') return Icons.man_4;
  if (value == 'man_4_sharp') return Icons.man_4_sharp;
  if (value == 'man_4_rounded') return Icons.man_4_rounded;
  if (value == 'man_4_outlined') return Icons.man_4_outlined;
  if (value == 'manage_accounts') return Icons.manage_accounts;
  if (value == 'manage_accounts_sharp') return Icons.manage_accounts_sharp;
  if (value == 'manage_accounts_rounded') return Icons.manage_accounts_rounded;
  if (value == 'manage_accounts_outlined') return Icons.manage_accounts_outlined;
  ...
  if (value == 'manage_history_outlined') return Icons.manage_history_outlined;
  ...
  if (value == 'maps_home_work_outlined') return Icons.maps_home_work_outlined;
  ...
  if (value == 'mark_as_unread_outlined') return Icons.mark_as_unread_outlined;
  ...
  if (value == 'mark_chat_read_outlined') return Icons.mark_chat_read_outlined;
  ...
  if (value == 'mark_chat_unread_rounded') return Icons.mark_chat_unread_rounded;
  if (value == 'mark_chat_unread_outlined') return Icons.mark_chat_unread_outlined;
  if (value == 'mark_email_read') return Icons.mark_email_read;
  if (value == 'mark_email_read_sharp') return Icons.mark_email_read_sharp;
  if (value == 'mark_email_read_rounded') return Icons.mark_email_read_rounded;
  if (value == 'mark_email_read_outlined') return Icons.mark_email_read_outlined;
  if (value == 'mark_email_unread') return Icons.mark_email_unread;
  if (value == 'mark_email_unread_sharp') return Icons.mark_email_unread_sharp;
  if (value == 'mark_email_unread_rounded') return Icons.mark_email_unread_rounded;
  if (value == 'mark_email_unread_outlined') return Icons.mark_email_unread_outlined;
  if (value == 'mark_unread_chat_alt') return Icons.mark_unread_chat_alt;
  if (value == 'mark_unread_chat_alt_sharp') return Icons.mark_unread_chat_alt_sharp;
  if (value == 'mark_unread_chat_alt_rounded') return Icons.mark_unread_chat_alt_rounded;
  if (value == 'mark_unread_chat_alt_outlined') return Icons.mark_unread_chat_alt_outlined;
  ...
  if (value == 'markunread_mailbox_sharp') return Icons.markunread_mailbox_sharp;
  if (value == 'markunread_mailbox_rounded') return Icons.markunread_mailbox_rounded;
  if (value == 'markunread_mailbox_outlined') return Icons.markunread_mailbox_outlined;
  ...
  if (value == 'media_bluetooth_off_sharp') return Icons.media_bluetooth_off_sharp;
  if (value == 'media_bluetooth_off_rounded') return Icons.media_bluetooth_off_rounded;
  if (value == 'media_bluetooth_off_outlined') return Icons.media_bluetooth_off_outlined;
  if (value == 'media_bluetooth_on') return Icons.media_bluetooth_on;
  if (value == 'media_bluetooth_on_sharp') return Icons.media_bluetooth_on_sharp;
  if (value == 'media_bluetooth_on_rounded') return Icons.media_bluetooth_on_rounded;
  if (value == 'media_bluetooth_on_outlined') return Icons.media_bluetooth_on_outlined;
  ...
  if (value == 'medical_information_sharp') return Icons.medical_information_sharp;
  if (value == 'medical_information_rounded') return Icons.medical_information_rounded;
  if (value == 'medical_information_outlined') return Icons.medical_information_outlined;
  ...
  if (value == 'medical_services_rounded') return Icons.medical_services_rounded;
  if (value == 'medical_services_outlined') return Icons.medical_services_outlined;
  ...
  if (value == 'medication_liquid_sharp') return Icons.medication_liquid_sharp;
  if (value == 'medication_liquid_rounded') return Icons.medication_liquid_rounded;
  if (value == 'medication_liquid_outlined') return Icons.medication_liquid_outlined;
  ...
  if (value == 'messenger_outline_sharp') return Icons.messenger_outline_sharp;
  if (value == 'messenger_outline_rounded') return Icons.messenger_outline_rounded;
  if (value == 'messenger_outline_outlined') return Icons.messenger_outline_outlined;
  ...
  if (value == 'mic_external_off_rounded') return Icons.mic_external_off_rounded;
  if (value == 'mic_external_off_outlined') return Icons.mic_external_off_outlined;
  if (value == 'mic_external_on') return Icons.mic_external_on;
  if (value == 'mic_external_on_sharp') return Icons.mic_external_on_sharp;
  if (value == 'mic_external_on_rounded') return Icons.mic_external_on_rounded;
  if (value == 'mic_external_on_outlined') return Icons.mic_external_on_outlined;
  ...
  if (value == 'miscellaneous_services_sharp') return Icons.miscellaneous_services_sharp;
  if (value == 'miscellaneous_services_rounded') return Icons.miscellaneous_services_rounded;
  if (value == 'miscellaneous_services_outlined') return Icons.miscellaneous_services_outlined;
  if (value == 'missed_video_call') return Icons.missed_video_call;
  if (value == 'missed_video_call_sharp') return Icons.missed_video_call_sharp;
  if (value == 'missed_video_call_rounded') return Icons.missed_video_call_rounded;
  if (value == 'missed_video_call_outlined') return Icons.missed_video_call_outlined;
  ...
  if (value == 'mobile_friendly_rounded') return Icons.mobile_friendly_rounded;
  if (value == 'mobile_friendly_outlined') return Icons.mobile_friendly_outlined;
  ...
  if (value == 'mobile_screen_share_sharp') return Icons.mobile_screen_share_sharp;
  if (value == 'mobile_screen_share_rounded') return Icons.mobile_screen_share_rounded;
  if (value == 'mobile_screen_share_outlined') return Icons.mobile_screen_share_outlined;
  ...
  if (value == 'mobiledata_off_outlined') return Icons.mobiledata_off_outlined;
  ...
  if (value == 'mode_edit_outline_sharp') return Icons.mode_edit_outline_sharp;
  if (value == 'mode_edit_outline_rounded') return Icons.mode_edit_outline_rounded;
  if (value == 'mode_edit_outline_outlined') return Icons.mode_edit_outline_outlined;
  ...
  if (value == 'mode_of_travel_outlined') return Icons.mode_of_travel_outlined;
  ...
  if (value == 'model_training_outlined') return Icons.model_training_outlined;
  if (value == 'monetization_on') return Icons.monetization_on;
  if (value == 'monetization_on_sharp') return Icons.monetization_on_sharp;
  if (value == 'monetization_on_rounded') return Icons.monetization_on_rounded;
  if (value == 'monetization_on_outlined') return Icons.monetization_on_outlined;
  ...
  if (value == 'money_off_csred_rounded') return Icons.money_off_csred_rounded;
  if (value == 'money_off_csred_outlined') return Icons.money_off_csred_outlined;
  ...
  if (value == 'monitor_weight_outlined') return Icons.monitor_weight_outlined;
  if (value == 'monochrome_photos') return Icons.monochrome_photos;
  if (value == 'monochrome_photos_sharp') return Icons.monochrome_photos_sharp;
  if (value == 'monochrome_photos_rounded') return Icons.monochrome_photos_rounded;
  if (value == 'monochrome_photos_outlined') return Icons.monochrome_photos_outlined;
  ...
  if (value == 'motion_photos_auto_sharp') return Icons.motion_photos_auto_sharp;
  if (value == 'motion_photos_auto_rounded') return Icons.motion_photos_auto_rounded;
  if (value == 'motion_photos_auto_outlined') return Icons.motion_photos_auto_outlined;
  if (value == 'motion_photos_off') return Icons.motion_photos_off;
  if (value == 'motion_photos_off_sharp') return Icons.motion_photos_off_sharp;
  if (value == 'motion_photos_off_rounded') return Icons.motion_photos_off_rounded;
  if (value == 'motion_photos_off_outlined') return Icons.motion_photos_off_outlined;
  ...
  if (value == 'motion_photos_on_rounded') return Icons.motion_photos_on_rounded;
  if (value == 'motion_photos_on_outlined') return Icons.motion_photos_on_outlined;
  if (value == 'motion_photos_pause') return Icons.motion_photos_pause;
  if (value == 'motion_photos_pause_sharp') return Icons.motion_photos_pause_sharp;
  if (value == 'motion_photos_pause_rounded') return Icons.motion_photos_pause_rounded;
  if (value == 'motion_photos_pause_outlined') return Icons.motion_photos_pause_outlined;
  if (value == 'motion_photos_paused') return Icons.motion_photos_paused;
  if (value == 'motion_photos_paused_sharp') return Icons.motion_photos_paused_sharp;
  if (value == 'motion_photos_paused_rounded') return Icons.motion_photos_paused_rounded;
  if (value == 'motion_photos_paused_outlined') return Icons.motion_photos_paused_outlined;
  ...
  if (value == 'movie_creation_outlined') return Icons.movie_creation_outlined;
  if (value == 'movie_edit') return Icons.movie_edit;
  ...
  if (value == 'multiline_chart_rounded') return Icons.multiline_chart_rounded;
  if (value == 'multiline_chart_outlined') return Icons.multiline_chart_outlined;
  ...
  if (value == 'multitrack_audio_rounded') return Icons.multitrack_audio_rounded;
  if (value == 'multitrack_audio_outlined') return Icons.multitrack_audio_outlined;
  ...
  if (value == 'my_library_add_outlined') return Icons.my_library_add_outlined;
  ...
  if (value == 'my_library_books_rounded') return Icons.my_library_books_rounded;
  if (value == 'my_library_books_outlined') return Icons.my_library_books_outlined;
  ...
  if (value == 'my_library_music_rounded') return Icons.my_library_music_rounded;
  if (value == 'my_library_music_outlined') return Icons.my_library_music_outlined;
  ...
  if (value == 'navigate_before_rounded') return Icons.navigate_before_rounded;
  if (value == 'navigate_before_outlined') return Icons.navigate_before_outlined;
  ...
  if (value == 'near_me_disabled_rounded') return Icons.near_me_disabled_rounded;
  if (value == 'near_me_disabled_outlined') return Icons.near_me_disabled_outlined;
  ...
  if (value == 'nest_cam_wired_stand_sharp') return Icons.nest_cam_wired_stand_sharp;
  if (value == 'nest_cam_wired_stand_rounded') return Icons.nest_cam_wired_stand_rounded;
  if (value == 'nest_cam_wired_stand_outlined') return Icons.nest_cam_wired_stand_outlined;
  ...
  if (value == 'network_locked_outlined') return Icons.network_locked_outlined;
  ...
  if (value == 'network_wifi_1_bar_sharp') return Icons.network_wifi_1_bar_sharp;
  if (value == 'network_wifi_1_bar_rounded') return Icons.network_wifi_1_bar_rounded;
  if (value == 'network_wifi_1_bar_outlined') return Icons.network_wifi_1_bar_outlined;
  if (value == 'network_wifi_2_bar') return Icons.network_wifi_2_bar;
  if (value == 'network_wifi_2_bar_sharp') return Icons.network_wifi_2_bar_sharp;
  if (value == 'network_wifi_2_bar_rounded') return Icons.network_wifi_2_bar_rounded;
  if (value == 'network_wifi_2_bar_outlined') return Icons.network_wifi_2_bar_outlined;
  if (value == 'network_wifi_3_bar') return Icons.network_wifi_3_bar;
  if (value == 'network_wifi_3_bar_sharp') return Icons.network_wifi_3_bar_sharp;
  if (value == 'network_wifi_3_bar_rounded') return Icons.network_wifi_3_bar_rounded;
  if (value == 'network_wifi_3_bar_outlined') return Icons.network_wifi_3_bar_outlined;
  ...
  if (value == 'nightlight_round_rounded') return Icons.nightlight_round_rounded;
  if (value == 'nightlight_round_outlined') return Icons.nightlight_round_outlined;
  ...
  if (value == 'no_adult_content_rounded') return Icons.no_adult_content_rounded;
  if (value == 'no_adult_content_outlined') return Icons.no_adult_content_outlined;
  ...
  if (value == 'no_encryption_gmailerrorred') return Icons.no_encryption_gmailerrorred;
  if (value == 'no_encryption_gmailerrorred_sharp') return Icons.no_encryption_gmailerrorred_sharp;
  if (value == 'no_encryption_gmailerrorred_rounded') return Icons.no_encryption_gmailerrorred_rounded;
  if (value == 'no_encryption_gmailerrorred_outlined') return Icons.no_encryption_gmailerrorred_outlined;
  ...
  if (value == 'no_meeting_room_rounded') return Icons.no_meeting_room_rounded;
  if (value == 'no_meeting_room_outlined') return Icons.no_meeting_room_outlined;
  ...
  if (value == 'no_photography_outlined') return Icons.no_photography_outlined;
  ...
  if (value == 'noise_control_off_sharp') return Icons.noise_control_off_sharp;
  if (value == 'noise_control_off_rounded') return Icons.noise_control_off_rounded;
  if (value == 'noise_control_off_outlined') return Icons.noise_control_off_outlined;
  ...
  if (value == 'nordic_walking_outlined') return Icons.nordic_walking_outlined;
  ...
  if (value == 'not_accessible_outlined') return Icons.not_accessible_outlined;
  ...
  if (value == 'not_interested_outlined') return Icons.not_interested_outlined;
  if (value == 'not_listed_location') return Icons.not_listed_location;
  if (value == 'not_listed_location_sharp') return Icons.not_listed_location_sharp;
  if (value == 'not_listed_location_rounded') return Icons.not_listed_location_rounded;
  if (value == 'not_listed_location_outlined') return Icons.not_listed_location_outlined;
  ...
  if (value == 'notification_add_rounded') return Icons.notification_add_rounded;
  if (value == 'notification_add_outlined') return Icons.notification_add_outlined;
  if (value == 'notification_important') return Icons.notification_important;
  if (value == 'notification_important_sharp') return Icons.notification_important_sharp;
  if (value == 'notification_important_rounded') return Icons.notification_important_rounded;
  if (value == 'notification_important_outlined') return Icons.notification_important_outlined;
  ...
  if (value == 'notifications_active_sharp') return Icons.notifications_active_sharp;
  if (value == 'notifications_active_rounded') return Icons.notifications_active_rounded;
  if (value == 'notifications_active_outlined') return Icons.notifications_active_outlined;
  if (value == 'notifications_none') return Icons.notifications_none;
  if (value == 'notifications_none_sharp') return Icons.notifications_none_sharp;
  if (value == 'notifications_none_rounded') return Icons.notifications_none_rounded;
  if (value == 'notifications_none_outlined') return Icons.notifications_none_outlined;
  if (value == 'notifications_off') return Icons.notifications_off;
  if (value == 'notifications_off_sharp') return Icons.notifications_off_sharp;
  if (value == 'notifications_off_rounded') return Icons.notifications_off_rounded;
  if (value == 'notifications_off_outlined') return Icons.notifications_off_outlined;
  ...
  if (value == 'notifications_on_rounded') return Icons.notifications_on_rounded;
  if (value == 'notifications_on_outlined') return Icons.notifications_on_outlined;
  if (value == 'notifications_paused') return Icons.notifications_paused;
  if (value == 'notifications_paused_sharp') return Icons.notifications_paused_sharp;
  if (value == 'notifications_paused_rounded') return Icons.notifications_paused_rounded;
  if (value == 'notifications_paused_outlined') return Icons.notifications_paused_outlined;
  ...
  if (value == 'on_device_training_sharp') return Icons.on_device_training_sharp;
  if (value == 'on_device_training_rounded') return Icons.on_device_training_rounded;
  if (value == 'on_device_training_outlined') return Icons.on_device_training_outlined;
  ...
  if (value == 'ondemand_video_outlined') return Icons.ondemand_video_outlined;
  if (value == 'online_prediction') return Icons.online_prediction;
  if (value == 'online_prediction_sharp') return Icons.online_prediction_sharp;
  if (value == 'online_prediction_rounded') return Icons.online_prediction_rounded;
  if (value == 'online_prediction_outlined') return Icons.online_prediction_outlined;
  ...
  if (value == 'open_in_browser_rounded') return Icons.open_in_browser_rounded;
  if (value == 'open_in_browser_outlined') return Icons.open_in_browser_outlined;
  ...
  if (value == 'open_in_new_off_rounded') return Icons.open_in_new_off_rounded;
  if (value == 'open_in_new_off_outlined') return Icons.open_in_new_off_outlined;
  ...
  if (value == 'pallet') return Icons.pallet;
  ...
  if (value == 'panorama_fish_eye_sharp') return Icons.panorama_fish_eye_sharp;
  if (value == 'panorama_fish_eye_rounded') return Icons.panorama_fish_eye_rounded;
  if (value == 'panorama_fish_eye_outlined') return Icons.panorama_fish_eye_outlined;
  ...
  if (value == 'panorama_fisheye_rounded') return Icons.panorama_fisheye_rounded;
  if (value == 'panorama_fisheye_outlined') return Icons.panorama_fisheye_outlined;
  if (value == 'panorama_horizontal') return Icons.panorama_horizontal;
  if (value == 'panorama_horizontal_sharp') return Icons.panorama_horizontal_sharp;
  if (value == 'panorama_horizontal_rounded') return Icons.panorama_horizontal_rounded;
  if (value == 'panorama_horizontal_outlined') return Icons.panorama_horizontal_outlined;
  if (value == 'panorama_horizontal_select') return Icons.panorama_horizontal_select;
  if (value == 'panorama_horizontal_select_sharp') return Icons.panorama_horizontal_select_sharp;
  if (value == 'panorama_horizontal_select_rounded') return Icons.panorama_horizontal_select_rounded;
  if (value == 'panorama_horizontal_select_outlined') return Icons.panorama_horizontal_select_outlined;
  if (value == 'panorama_photosphere') return Icons.panorama_photosphere;
  if (value == 'panorama_photosphere_sharp') return Icons.panorama_photosphere_sharp;
  if (value == 'panorama_photosphere_rounded') return Icons.panorama_photosphere_rounded;
  if (value == 'panorama_photosphere_outlined') return Icons.panorama_photosphere_outlined;
  if (value == 'panorama_photosphere_select') return Icons.panorama_photosphere_select;
  if (value == 'panorama_photosphere_select_sharp') return Icons.panorama_photosphere_select_sharp;
  if (value == 'panorama_photosphere_select_rounded') return Icons.panorama_photosphere_select_rounded;
  if (value == 'panorama_photosphere_select_outlined') return Icons.panorama_photosphere_select_outlined;
  if (value == 'panorama_vertical') return Icons.panorama_vertical;
  if (value == 'panorama_vertical_sharp') return Icons.panorama_vertical_sharp;
  if (value == 'panorama_vertical_rounded') return Icons.panorama_vertical_rounded;
  if (value == 'panorama_vertical_outlined') return Icons.panorama_vertical_outlined;
  if (value == 'panorama_vertical_select') return Icons.panorama_vertical_select;
  if (value == 'panorama_vertical_select_sharp') return Icons.panorama_vertical_select_sharp;
  if (value == 'panorama_vertical_select_rounded') return Icons.panorama_vertical_select_rounded;
  if (value == 'panorama_vertical_select_outlined') return Icons.panorama_vertical_select_outlined;
  if (value == 'panorama_wide_angle') return Icons.panorama_wide_angle;
  if (value == 'panorama_wide_angle_sharp') return Icons.panorama_wide_angle_sharp;
  if (value == 'panorama_wide_angle_rounded') return Icons.panorama_wide_angle_rounded;
  if (value == 'panorama_wide_angle_outlined') return Icons.panorama_wide_angle_outlined;
  if (value == 'panorama_wide_angle_select') return Icons.panorama_wide_angle_select;
  if (value == 'panorama_wide_angle_select_sharp') return Icons.panorama_wide_angle_select_sharp;
  if (value == 'panorama_wide_angle_select_rounded') return Icons.panorama_wide_angle_select_rounded;
  if (value == 'panorama_wide_angle_select_outlined') return Icons.panorama_wide_angle_select_outlined;
  ...
  if (value == 'pause_circle_filled_sharp') return Icons.pause_circle_filled_sharp;
  if (value == 'pause_circle_filled_rounded') return Icons.pause_circle_filled_rounded;
  if (value == 'pause_circle_filled_outlined') return Icons.pause_circle_filled_outlined;
  if (value == 'pause_circle_outline') return Icons.pause_circle_outline;
  if (value == 'pause_circle_outline_sharp') return Icons.pause_circle_outline_sharp;
  if (value == 'pause_circle_outline_rounded') return Icons.pause_circle_outline_rounded;
  if (value == 'pause_circle_outline_outlined') return Icons.pause_circle_outline_outlined;
  if (value == 'pause_presentation') return Icons.pause_presentation;
  if (value == 'pause_presentation_sharp') return Icons.pause_presentation_sharp;
  if (value == 'pause_presentation_rounded') return Icons.pause_presentation_rounded;
  if (value == 'pause_presentation_outlined') return Icons.pause_presentation_outlined;
  ...
  if (value == 'pending_actions_rounded') return Icons.pending_actions_rounded;
  if (value == 'pending_actions_outlined') return Icons.pending_actions_outlined;
  ...
  if (value == 'people_outline_outlined') return Icons.people_outline_outlined;
  ...
  if (value == 'perm_camera_mic_rounded') return Icons.perm_camera_mic_rounded;
  if (value == 'perm_camera_mic_outlined') return Icons.perm_camera_mic_outlined;
  ...
  if (value == 'perm_contact_cal_rounded') return Icons.perm_contact_cal_rounded;
  if (value == 'perm_contact_cal_outlined') return Icons.perm_contact_cal_outlined;
  if (value == 'perm_contact_calendar') return Icons.perm_contact_calendar;
  if (value == 'perm_contact_calendar_sharp') return Icons.perm_contact_calendar_sharp;
  if (value == 'perm_contact_calendar_rounded') return Icons.perm_contact_calendar_rounded;
  if (value == 'perm_contact_calendar_outlined') return Icons.perm_contact_calendar_outlined;
  if (value == 'perm_data_setting') return Icons.perm_data_setting;
  if (value == 'perm_data_setting_sharp') return Icons.perm_data_setting_sharp;
  if (value == 'perm_data_setting_rounded') return Icons.perm_data_setting_rounded;
  if (value == 'perm_data_setting_outlined') return Icons.perm_data_setting_outlined;
  ...
  if (value == 'perm_device_info_rounded') return Icons.perm_device_info_rounded;
  if (value == 'perm_device_info_outlined') return Icons.perm_device_info_outlined;
  if (value == 'perm_device_information') return Icons.perm_device_information;
  if (value == 'perm_device_information_sharp') return Icons.perm_device_information_sharp;
  if (value == 'perm_device_information_rounded') return Icons.perm_device_information_rounded;
  if (value == 'perm_device_information_outlined') return Icons.perm_device_information_outlined;
  ...
  if (value == 'perm_phone_msg_outlined') return Icons.perm_phone_msg_outlined;
  ...
  if (value == 'perm_scan_wifi_outlined') return Icons.perm_scan_wifi_outlined;
  ...
  if (value == 'person_2') return Icons.person_2;
  if (value == 'person_2_sharp') return Icons.person_2_sharp;
  if (value == 'person_2_rounded') return Icons.person_2_rounded;
  if (value == 'person_2_outlined') return Icons.person_2_outlined;
  if (value == 'person_3') return Icons.person_3;
  if (value == 'person_3_sharp') return Icons.person_3_sharp;
  if (value == 'person_3_rounded') return Icons.person_3_rounded;
  if (value == 'person_3_outlined') return Icons.person_3_outlined;
  if (value == 'person_4') return Icons.person_4;
  if (value == 'person_4_sharp') return Icons.person_4_sharp;
  if (value == 'person_4_rounded') return Icons.person_4_rounded;
  if (value == 'person_4_outlined') return Icons.person_4_outlined;
  ...
  if (value == 'person_add_alt_outlined') return Icons.person_add_alt_outlined;
  ...
  if (value == 'person_add_alt_1_rounded') return Icons.person_add_alt_1_rounded;
  if (value == 'person_add_alt_1_outlined') return Icons.person_add_alt_1_outlined;
  if (value == 'person_add_disabled') return Icons.person_add_disabled;
  if (value == 'person_add_disabled_sharp') return Icons.person_add_disabled_sharp;
  if (value == 'person_add_disabled_rounded') return Icons.person_add_disabled_rounded;
  if (value == 'person_add_disabled_outlined') return Icons.person_add_disabled_outlined;
  ...
  if (value == 'person_outline_outlined') return Icons.person_outline_outlined;
  ...
  if (value == 'person_pin_circle_sharp') return Icons.person_pin_circle_sharp;
  if (value == 'person_pin_circle_rounded') return Icons.person_pin_circle_rounded;
  if (value == 'person_pin_circle_outlined') return Icons.person_pin_circle_outlined;
  ...
  if (value == 'person_remove_alt_1_sharp') return Icons.person_remove_alt_1_sharp;
  if (value == 'person_remove_alt_1_rounded') return Icons.person_remove_alt_1_rounded;
  if (value == 'person_remove_alt_1_outlined') return Icons.person_remove_alt_1_outlined;
  ...
  if (value == 'personal_injury_rounded') return Icons.personal_injury_rounded;
  if (value == 'personal_injury_outlined') return Icons.personal_injury_outlined;
  ...
  if (value == 'personal_video_outlined') return Icons.personal_video_outlined;
  ...
  if (value == 'pest_control_rodent_sharp') return Icons.pest_control_rodent_sharp;
  if (value == 'pest_control_rodent_rounded') return Icons.pest_control_rodent_rounded;
  if (value == 'pest_control_rodent_outlined') return Icons.pest_control_rodent_outlined;
  ...
  if (value == 'phone_bluetooth_speaker') return Icons.phone_bluetooth_speaker;
  if (value == 'phone_bluetooth_speaker_sharp') return Icons.phone_bluetooth_speaker_sharp;
  if (value == 'phone_bluetooth_speaker_rounded') return Icons.phone_bluetooth_speaker_rounded;
  if (value == 'phone_bluetooth_speaker_outlined') return Icons.phone_bluetooth_speaker_outlined;
  ...
  if (value == 'phone_callback_outlined') return Icons.phone_callback_outlined;
  ...
  if (value == 'phone_disabled_outlined') return Icons.phone_disabled_outlined;
  ...
  if (value == 'phone_forwarded_rounded') return Icons.phone_forwarded_rounded;
  if (value == 'phone_forwarded_outlined') return Icons.phone_forwarded_outlined;
  ...
  if (value == 'phonelink_erase_rounded') return Icons.phonelink_erase_rounded;
  if (value == 'phonelink_erase_outlined') return Icons.phonelink_erase_outlined;
  ...
  if (value == 'phonelink_lock_outlined') return Icons.phonelink_lock_outlined;
  ...
  if (value == 'phonelink_ring_outlined') return Icons.phonelink_ring_outlined;
  if (value == 'phonelink_setup') return Icons.phonelink_setup;
  if (value == 'phonelink_setup_sharp') return Icons.phonelink_setup_sharp;
  if (value == 'phonelink_setup_rounded') return Icons.phonelink_setup_rounded;
  if (value == 'phonelink_setup_outlined') return Icons.phonelink_setup_outlined;
  ...
  if (value == 'photo_camera_back_sharp') return Icons.photo_camera_back_sharp;
  if (value == 'photo_camera_back_rounded') return Icons.photo_camera_back_rounded;
  if (value == 'photo_camera_back_outlined') return Icons.photo_camera_back_outlined;
  if (value == 'photo_camera_front') return Icons.photo_camera_front;
  if (value == 'photo_camera_front_sharp') return Icons.photo_camera_front_sharp;
  if (value == 'photo_camera_front_rounded') return Icons.photo_camera_front_rounded;
  if (value == 'photo_camera_front_outlined') return Icons.photo_camera_front_outlined;
  ...
  if (value == 'photo_size_select_actual') return Icons.photo_size_select_actual;
  if (value == 'photo_size_select_actual_sharp') return Icons.photo_size_select_actual_sharp;
  if (value == 'photo_size_select_actual_rounded') return Icons.photo_size_select_actual_rounded;
  if (value == 'photo_size_select_actual_outlined') return Icons.photo_size_select_actual_outlined;
  if (value == 'photo_size_select_large') return Icons.photo_size_select_large;
  if (value == 'photo_size_select_large_sharp') return Icons.photo_size_select_large_sharp;
  if (value == 'photo_size_select_large_rounded') return Icons.photo_size_select_large_rounded;
  if (value == 'photo_size_select_large_outlined') return Icons.photo_size_select_large_outlined;
  if (value == 'photo_size_select_small') return Icons.photo_size_select_small;
  if (value == 'photo_size_select_small_sharp') return Icons.photo_size_select_small_sharp;
  if (value == 'photo_size_select_small_rounded') return Icons.photo_size_select_small_rounded;
  if (value == 'photo_size_select_small_outlined') return Icons.photo_size_select_small_outlined;
  ...
  if (value == 'picture_as_pdf_outlined') return Icons.picture_as_pdf_outlined;
  if (value == 'picture_in_picture') return Icons.picture_in_picture;
  if (value == 'picture_in_picture_sharp') return Icons.picture_in_picture_sharp;
  if (value == 'picture_in_picture_rounded') return Icons.picture_in_picture_rounded;
  if (value == 'picture_in_picture_outlined') return Icons.picture_in_picture_outlined;
  if (value == 'picture_in_picture_alt') return Icons.picture_in_picture_alt;
  if (value == 'picture_in_picture_alt_sharp') return Icons.picture_in_picture_alt_sharp;
  if (value == 'picture_in_picture_alt_rounded') return Icons.picture_in_picture_alt_rounded;
  if (value == 'picture_in_picture_alt_outlined') return Icons.picture_in_picture_alt_outlined;
  ...
  if (value == 'pie_chart_outline_sharp') return Icons.pie_chart_outline_sharp;
  if (value == 'pie_chart_outline_rounded') return Icons.pie_chart_outline_rounded;
  if (value == 'pie_chart_outline_outlined') return Icons.pie_chart_outline_outlined;
  ...
  if (value == 'pivot_table_chart_sharp') return Icons.pivot_table_chart_sharp;
  if (value == 'pivot_table_chart_rounded') return Icons.pivot_table_chart_rounded;
  if (value == 'pivot_table_chart_outlined') return Icons.pivot_table_chart_outlined;
  ...
  if (value == 'play_circle_fill_rounded') return Icons.play_circle_fill_rounded;
  if (value == 'play_circle_fill_outlined') return Icons.play_circle_fill_outlined;
  if (value == 'play_circle_filled') return Icons.play_circle_filled;
  if (value == 'play_circle_filled_sharp') return Icons.play_circle_filled_sharp;
  if (value == 'play_circle_filled_rounded') return Icons.play_circle_filled_rounded;
  if (value == 'play_circle_filled_outlined') return Icons.play_circle_filled_outlined;
  if (value == 'play_circle_outline') return Icons.play_circle_outline;
  if (value == 'play_circle_outline_sharp') return Icons.play_circle_outline_sharp;
  if (value == 'play_circle_outline_rounded') return Icons.play_circle_outline_rounded;
  if (value == 'play_circle_outline_outlined') return Icons.play_circle_outline_outlined;
  ...
  if (value == 'playlist_add_check_sharp') return Icons.playlist_add_check_sharp;
  if (value == 'playlist_add_check_rounded') return Icons.playlist_add_check_rounded;
  if (value == 'playlist_add_check_outlined') return Icons.playlist_add_check_outlined;
  if (value == 'playlist_add_check_circle') return Icons.playlist_add_check_circle;
  if (value == 'playlist_add_check_circle_sharp') return Icons.playlist_add_check_circle_sharp;
  if (value == 'playlist_add_check_circle_rounded') return Icons.playlist_add_check_circle_rounded;
  if (value == 'playlist_add_check_circle_outlined') return Icons.playlist_add_check_circle_outlined;
  if (value == 'playlist_add_circle') return Icons.playlist_add_circle;
  if (value == 'playlist_add_circle_sharp') return Icons.playlist_add_circle_sharp;
  if (value == 'playlist_add_circle_rounded') return Icons.playlist_add_circle_rounded;
  if (value == 'playlist_add_circle_outlined') return Icons.playlist_add_circle_outlined;
  ...
  if (value == 'playlist_remove_rounded') return Icons.playlist_remove_rounded;
  if (value == 'playlist_remove_outlined') return Icons.playlist_remove_outlined;
  ...
  if (value == 'portable_wifi_off_sharp') return Icons.portable_wifi_off_sharp;
  if (value == 'portable_wifi_off_rounded') return Icons.portable_wifi_off_rounded;
  if (value == 'portable_wifi_off_outlined') return Icons.portable_wifi_off_outlined;
  ...
  if (value == 'power_settings_new_sharp') return Icons.power_settings_new_sharp;
  if (value == 'power_settings_new_rounded') return Icons.power_settings_new_rounded;
  if (value == 'power_settings_new_outlined') return Icons.power_settings_new_outlined;
  if (value == 'precision_manufacturing') return Icons.precision_manufacturing;
  if (value == 'precision_manufacturing_sharp') return Icons.precision_manufacturing_sharp;
  if (value == 'precision_manufacturing_rounded') return Icons.precision_manufacturing_rounded;
  if (value == 'precision_manufacturing_outlined') return Icons.precision_manufacturing_outlined;
  ...
  if (value == 'pregnant_woman_outlined') return Icons.pregnant_woman_outlined;
  ...
  if (value == 'present_to_all_outlined') return Icons.present_to_all_outlined;
  ...
  if (value == 'print_disabled_outlined') return Icons.print_disabled_outlined;
  ...
  if (value == 'private_connectivity_sharp') return Icons.private_connectivity_sharp;
  if (value == 'private_connectivity_rounded') return Icons.private_connectivity_rounded;
  if (value == 'private_connectivity_outlined') return Icons.private_connectivity_outlined;
  if (value == 'production_quantity_limits') return Icons.production_quantity_limits;
  if (value == 'production_quantity_limits_sharp') return Icons.production_quantity_limits_sharp;
  if (value == 'production_quantity_limits_rounded') return Icons.production_quantity_limits_rounded;
  if (value == 'production_quantity_limits_outlined') return Icons.production_quantity_limits_outlined;
  ...
  if (value == 'psychology_alt') return Icons.psychology_alt;
  if (value == 'psychology_alt_sharp') return Icons.psychology_alt_sharp;
  if (value == 'psychology_alt_rounded') return Icons.psychology_alt_rounded;
  if (value == 'psychology_alt_outlined') return Icons.psychology_alt_outlined;
  ...
  if (value == 'published_with_changes_sharp') return Icons.published_with_changes_sharp;
  if (value == 'published_with_changes_rounded') return Icons.published_with_changes_rounded;
  if (value == 'published_with_changes_outlined') return Icons.published_with_changes_outlined;
  ...
  if (value == 'qr_code_scanner_rounded') return Icons.qr_code_scanner_rounded;
  if (value == 'qr_code_scanner_outlined') return Icons.qr_code_scanner_outlined;
  ...
  if (value == 'question_answer_rounded') return Icons.question_answer_rounded;
  if (value == 'question_answer_outlined') return Icons.question_answer_outlined;
  ...
  if (value == 'queue_play_next_rounded') return Icons.queue_play_next_rounded;
  if (value == 'queue_play_next_outlined') return Icons.queue_play_next_outlined;
  if (value == 'quick_contacts_dialer') return Icons.quick_contacts_dialer;
  if (value == 'quick_contacts_dialer_sharp') return Icons.quick_contacts_dialer_sharp;
  if (value == 'quick_contacts_dialer_rounded') return Icons.quick_contacts_dialer_rounded;
  if (value == 'quick_contacts_dialer_outlined') return Icons.quick_contacts_dialer_outlined;
  if (value == 'quick_contacts_mail') return Icons.quick_contacts_mail;
  if (value == 'quick_contacts_mail_sharp') return Icons.quick_contacts_mail_sharp;
  if (value == 'quick_contacts_mail_rounded') return Icons.quick_contacts_mail_rounded;
  if (value == 'quick_contacts_mail_outlined') return Icons.quick_contacts_mail_outlined;
  ...
  if (value == 'radio_button_checked_sharp') return Icons.radio_button_checked_sharp;
  if (value == 'radio_button_checked_rounded') return Icons.radio_button_checked_rounded;
  if (value == 'radio_button_checked_outlined') return Icons.radio_button_checked_outlined;
  ...
  if (value == 'radio_button_off_rounded') return Icons.radio_button_off_rounded;
  if (value == 'radio_button_off_outlined') return Icons.radio_button_off_outlined;
  if (value == 'radio_button_on') return Icons.radio_button_on;
  if (value == 'radio_button_on_sharp') return Icons.radio_button_on_sharp;
  if (value == 'radio_button_on_rounded') return Icons.radio_button_on_rounded;
  if (value == 'radio_button_on_outlined') return Icons.radio_button_on_outlined;
  if (value == 'radio_button_unchecked') return Icons.radio_button_unchecked;
  if (value == 'radio_button_unchecked_sharp') return Icons.radio_button_unchecked_sharp;
  if (value == 'radio_button_unchecked_rounded') return Icons.radio_button_unchecked_rounded;
  if (value == 'radio_button_unchecked_outlined') return Icons.radio_button_unchecked_outlined;
  ...
  if (value == 'real_estate_agent_sharp') return Icons.real_estate_agent_sharp;
  if (value == 'real_estate_agent_rounded') return Icons.real_estate_agent_rounded;
  if (value == 'real_estate_agent_outlined') return Icons.real_estate_agent_outlined;
  if (value == 'rebase_edit') return Icons.rebase_edit;
  ...
  if (value == 'record_voice_over_sharp') return Icons.record_voice_over_sharp;
  if (value == 'record_voice_over_rounded') return Icons.record_voice_over_rounded;
  if (value == 'record_voice_over_outlined') return Icons.record_voice_over_outlined;
  ...
  if (value == 'reduce_capacity_rounded') return Icons.reduce_capacity_rounded;
  if (value == 'reduce_capacity_outlined') return Icons.reduce_capacity_outlined;
  ...
  if (value == 'remove_circle_outline_sharp') return Icons.remove_circle_outline_sharp;
  if (value == 'remove_circle_outline_rounded') return Icons.remove_circle_outline_rounded;
  if (value == 'remove_circle_outline_outlined') return Icons.remove_circle_outline_outlined;
  ...
  if (value == 'remove_from_queue_sharp') return Icons.remove_from_queue_sharp;
  if (value == 'remove_from_queue_rounded') return Icons.remove_from_queue_rounded;
  if (value == 'remove_from_queue_outlined') return Icons.remove_from_queue_outlined;
  ...
  if (value == 'remove_moderator_rounded') return Icons.remove_moderator_rounded;
  if (value == 'remove_moderator_outlined') return Icons.remove_moderator_outlined;
  ...
  if (value == 'remove_red_eye_outlined') return Icons.remove_red_eye_outlined;
  ...
  if (value == 'remove_shopping_cart_sharp') return Icons.remove_shopping_cart_sharp;
  if (value == 'remove_shopping_cart_rounded') return Icons.remove_shopping_cart_rounded;
  if (value == 'remove_shopping_cart_outlined') return Icons.remove_shopping_cart_outlined;
  ...
  if (value == 'repartition') return Icons.repartition;
  if (value == 'repartition_sharp') return Icons.repartition_sharp;
  if (value == 'repartition_rounded') return Icons.repartition_rounded;
  if (value == 'repartition_outlined') return Icons.repartition_outlined;
  ...
  if (value == 'replay_circle_filled_sharp') return Icons.replay_circle_filled_sharp;
  if (value == 'replay_circle_filled_rounded') return Icons.replay_circle_filled_rounded;
  if (value == 'replay_circle_filled_outlined') return Icons.replay_circle_filled_outlined;
  ...
  if (value == 'report_gmailerrorred_sharp') return Icons.report_gmailerrorred_sharp;
  if (value == 'report_gmailerrorred_rounded') return Icons.report_gmailerrorred_rounded;
  if (value == 'report_gmailerrorred_outlined') return Icons.report_gmailerrorred_outlined;
  ...
  if (value == 'report_problem_outlined') return Icons.report_problem_outlined;
  ...
  if (value == 'restaurant_menu_rounded') return Icons.restaurant_menu_rounded;
  if (value == 'restaurant_menu_outlined') return Icons.restaurant_menu_outlined;
  ...
  if (value == 'restore_from_trash_sharp') return Icons.restore_from_trash_sharp;
  if (value == 'restore_from_trash_rounded') return Icons.restore_from_trash_rounded;
  if (value == 'restore_from_trash_outlined') return Icons.restore_from_trash_outlined;
  ...
  if (value == 'roller_shades_closed_sharp') return Icons.roller_shades_closed_sharp;
  if (value == 'roller_shades_closed_rounded') return Icons.roller_shades_closed_rounded;
  if (value == 'roller_shades_closed_outlined') return Icons.roller_shades_closed_outlined;
  ...
  if (value == 'roller_skating_outlined') return Icons.roller_skating_outlined;
  ...
  if (value == 'room_preferences_rounded') return Icons.room_preferences_rounded;
  if (value == 'room_preferences_outlined') return Icons.room_preferences_outlined;
  ...
  if (value == 'rotate_90_degrees_ccw_sharp') return Icons.rotate_90_degrees_ccw_sharp;
  if (value == 'rotate_90_degrees_ccw_rounded') return Icons.rotate_90_degrees_ccw_rounded;
  if (value == 'rotate_90_degrees_ccw_outlined') return Icons.rotate_90_degrees_ccw_outlined;
  if (value == 'rotate_90_degrees_cw') return Icons.rotate_90_degrees_cw;
  if (value == 'rotate_90_degrees_cw_sharp') return Icons.rotate_90_degrees_cw_sharp;
  if (value == 'rotate_90_degrees_cw_rounded') return Icons.rotate_90_degrees_cw_rounded;
  if (value == 'rotate_90_degrees_cw_outlined') return Icons.rotate_90_degrees_cw_outlined;
  ...
  if (value == 'roundabout_left_rounded') return Icons.roundabout_left_rounded;
  if (value == 'roundabout_left_outlined') return Icons.roundabout_left_outlined;
  ...
  if (value == 'roundabout_right_rounded') return Icons.roundabout_right_rounded;
  if (value == 'roundabout_right_outlined') return Icons.roundabout_right_outlined;
  ...
  if (value == 'rounded_corner_outlined') return Icons.rounded_corner_outlined;
  ...
  if (value == 'running_with_errors_sharp') return Icons.running_with_errors_sharp;
  if (value == 'running_with_errors_rounded') return Icons.running_with_errors_rounded;
  if (value == 'running_with_errors_outlined') return Icons.running_with_errors_outlined;
  ...
  if (value == 'safety_divider_outlined') return Icons.safety_divider_outlined;
  ...
  if (value == 'screen_lock_landscape_sharp') return Icons.screen_lock_landscape_sharp;
  if (value == 'screen_lock_landscape_rounded') return Icons.screen_lock_landscape_rounded;
  if (value == 'screen_lock_landscape_outlined') return Icons.screen_lock_landscape_outlined;
  if (value == 'screen_lock_portrait') return Icons.screen_lock_portrait;
  if (value == 'screen_lock_portrait_sharp') return Icons.screen_lock_portrait_sharp;
  if (value == 'screen_lock_portrait_rounded') return Icons.screen_lock_portrait_rounded;
  if (value == 'screen_lock_portrait_outlined') return Icons.screen_lock_portrait_outlined;
  if (value == 'screen_lock_rotation') return Icons.screen_lock_rotation;
  if (value == 'screen_lock_rotation_sharp') return Icons.screen_lock_rotation_sharp;
  if (value == 'screen_lock_rotation_rounded') return Icons.screen_lock_rotation_rounded;
  if (value == 'screen_lock_rotation_outlined') return Icons.screen_lock_rotation_outlined;
  if (value == 'screen_rotation') return Icons.screen_rotation;
  if (value == 'screen_rotation_sharp') return Icons.screen_rotation_sharp;
  if (value == 'screen_rotation_rounded') return Icons.screen_rotation_rounded;
  if (value == 'screen_rotation_outlined') return Icons.screen_rotation_outlined;
  if (value == 'screen_rotation_alt') return Icons.screen_rotation_alt;
  if (value == 'screen_rotation_alt_sharp') return Icons.screen_rotation_alt_sharp;
  if (value == 'screen_rotation_alt_rounded') return Icons.screen_rotation_alt_rounded;
  if (value == 'screen_rotation_alt_outlined') return Icons.screen_rotation_alt_outlined;
  if (value == 'screen_search_desktop') return Icons.screen_search_desktop;
  if (value == 'screen_search_desktop_sharp') return Icons.screen_search_desktop_sharp;
  if (value == 'screen_search_desktop_rounded') return Icons.screen_search_desktop_rounded;
  if (value == 'screen_search_desktop_outlined') return Icons.screen_search_desktop_outlined;
  ...
  if (value == 'screenshot_monitor_sharp') return Icons.screenshot_monitor_sharp;
  if (value == 'screenshot_monitor_rounded') return Icons.screenshot_monitor_rounded;
  if (value == 'screenshot_monitor_outlined') return Icons.screenshot_monitor_outlined;
  ...
  if (value == 'security_update_rounded') return Icons.security_update_rounded;
  if (value == 'security_update_outlined') return Icons.security_update_outlined;
  if (value == 'security_update_good') return Icons.security_update_good;
  if (value == 'security_update_good_sharp') return Icons.security_update_good_sharp;
  if (value == 'security_update_good_rounded') return Icons.security_update_good_rounded;
  if (value == 'security_update_good_outlined') return Icons.security_update_good_outlined;
  if (value == 'security_update_warning') return Icons.security_update_warning;
  if (value == 'security_update_warning_sharp') return Icons.security_update_warning_sharp;
  if (value == 'security_update_warning_rounded') return Icons.security_update_warning_rounded;
  if (value == 'security_update_warning_outlined') return Icons.security_update_warning_outlined;
  ...
  if (value == 'self_improvement_rounded') return Icons.self_improvement_rounded;
  if (value == 'self_improvement_outlined') return Icons.self_improvement_outlined;
  ...
  if (value == 'send_and_archive_rounded') return Icons.send_and_archive_rounded;
  if (value == 'send_and_archive_outlined') return Icons.send_and_archive_outlined;
  if (value == 'send_time_extension') return Icons.send_time_extension;
  if (value == 'send_time_extension_sharp') return Icons.send_time_extension_sharp;
  if (value == 'send_time_extension_rounded') return Icons.send_time_extension_rounded;
  if (value == 'send_time_extension_outlined') return Icons.send_time_extension_outlined;
  ...
  if (value == 'send_to_mobile_outlined') return Icons.send_to_mobile_outlined;
  ...
  if (value == 'sensor_occupied_rounded') return Icons.sensor_occupied_rounded;
  if (value == 'sensor_occupied_outlined') return Icons.sensor_occupied_outlined;
  ...
  if (value == 'sentiment_dissatisfied_sharp') return Icons.sentiment_dissatisfied_sharp;
  if (value == 'sentiment_dissatisfied_rounded') return Icons.sentiment_dissatisfied_rounded;
  if (value == 'sentiment_dissatisfied_outlined') return Icons.sentiment_dissatisfied_outlined;
  if (value == 'sentiment_neutral') return Icons.sentiment_neutral;
  if (value == 'sentiment_neutral_sharp') return Icons.sentiment_neutral_sharp;
  if (value == 'sentiment_neutral_rounded') return Icons.sentiment_neutral_rounded;
  if (value == 'sentiment_neutral_outlined') return Icons.sentiment_neutral_outlined;
  if (value == 'sentiment_satisfied') return Icons.sentiment_satisfied;
  if (value == 'sentiment_satisfied_sharp') return Icons.sentiment_satisfied_sharp;
  if (value == 'sentiment_satisfied_rounded') return Icons.sentiment_satisfied_rounded;
  if (value == 'sentiment_satisfied_outlined') return Icons.sentiment_satisfied_outlined;
  if (value == 'sentiment_satisfied_alt') return Icons.sentiment_satisfied_alt;
  if (value == 'sentiment_satisfied_alt_sharp') return Icons.sentiment_satisfied_alt_sharp;
  if (value == 'sentiment_satisfied_alt_rounded') return Icons.sentiment_satisfied_alt_rounded;
  if (value == 'sentiment_satisfied_alt_outlined') return Icons.sentiment_satisfied_alt_outlined;
  if (value == 'sentiment_very_dissatisfied') return Icons.sentiment_very_dissatisfied;
  if (value == 'sentiment_very_dissatisfied_sharp') return Icons.sentiment_very_dissatisfied_sharp;
  if (value == 'sentiment_very_dissatisfied_rounded') return Icons.sentiment_very_dissatisfied_rounded;
  if (value == 'sentiment_very_dissatisfied_outlined') return Icons.sentiment_very_dissatisfied_outlined;
  if (value == 'sentiment_very_satisfied') return Icons.sentiment_very_satisfied;
  if (value == 'sentiment_very_satisfied_sharp') return Icons.sentiment_very_satisfied_sharp;
  if (value == 'sentiment_very_satisfied_rounded') return Icons.sentiment_very_satisfied_rounded;
  if (value == 'sentiment_very_satisfied_outlined') return Icons.sentiment_very_satisfied_outlined;
  ...
  if (value == 'settings_accessibility_sharp') return Icons.settings_accessibility_sharp;
  if (value == 'settings_accessibility_rounded') return Icons.settings_accessibility_rounded;
  if (value == 'settings_accessibility_outlined') return Icons.settings_accessibility_outlined;
  if (value == 'settings_applications') return Icons.settings_applications;
  if (value == 'settings_applications_sharp') return Icons.settings_applications_sharp;
  if (value == 'settings_applications_rounded') return Icons.settings_applications_rounded;
  if (value == 'settings_applications_outlined') return Icons.settings_applications_outlined;
  if (value == 'settings_backup_restore') return Icons.settings_backup_restore;
  if (value == 'settings_backup_restore_sharp') return Icons.settings_backup_restore_sharp;
  if (value == 'settings_backup_restore_rounded') return Icons.settings_backup_restore_rounded;
  if (value == 'settings_backup_restore_outlined') return Icons.settings_backup_restore_outlined;
  if (value == 'settings_bluetooth') return Icons.settings_bluetooth;
  if (value == 'settings_bluetooth_sharp') return Icons.settings_bluetooth_sharp;
  if (value == 'settings_bluetooth_rounded') return Icons.settings_bluetooth_rounded;
  if (value == 'settings_bluetooth_outlined') return Icons.settings_bluetooth_outlined;
  if (value == 'settings_brightness') return Icons.settings_brightness;
  if (value == 'settings_brightness_sharp') return Icons.settings_brightness_sharp;
  if (value == 'settings_brightness_rounded') return Icons.settings_brightness_rounded;
  if (value == 'settings_brightness_outlined') return Icons.settings_brightness_outlined;
  ...
  if (value == 'settings_display_rounded') return Icons.settings_display_rounded;
  if (value == 'settings_display_outlined') return Icons.settings_display_outlined;
  if (value == 'settings_ethernet') return Icons.settings_ethernet;
  if (value == 'settings_ethernet_sharp') return Icons.settings_ethernet_sharp;
  if (value == 'settings_ethernet_rounded') return Icons.settings_ethernet_rounded;
  if (value == 'settings_ethernet_outlined') return Icons.settings_ethernet_outlined;
  if (value == 'settings_input_antenna') return Icons.settings_input_antenna;
  if (value == 'settings_input_antenna_sharp') return Icons.settings_input_antenna_sharp;
  if (value == 'settings_input_antenna_rounded') return Icons.settings_input_antenna_rounded;
  if (value == 'settings_input_antenna_outlined') return Icons.settings_input_antenna_outlined;
  if (value == 'settings_input_component') return Icons.settings_input_component;
  if (value == 'settings_input_component_sharp') return Icons.settings_input_component_sharp;
  if (value == 'settings_input_component_rounded') return Icons.settings_input_component_rounded;
  if (value == 'settings_input_component_outlined') return Icons.settings_input_component_outlined;
  if (value == 'settings_input_composite') return Icons.settings_input_composite;
  if (value == 'settings_input_composite_sharp') return Icons.settings_input_composite_sharp;
  if (value == 'settings_input_composite_rounded') return Icons.settings_input_composite_rounded;
  if (value == 'settings_input_composite_outlined') return Icons.settings_input_composite_outlined;
  if (value == 'settings_input_hdmi') return Icons.settings_input_hdmi;
  if (value == 'settings_input_hdmi_sharp') return Icons.settings_input_hdmi_sharp;
  if (value == 'settings_input_hdmi_rounded') return Icons.settings_input_hdmi_rounded;
  if (value == 'settings_input_hdmi_outlined') return Icons.settings_input_hdmi_outlined;
  if (value == 'settings_input_svideo') return Icons.settings_input_svideo;
  if (value == 'settings_input_svideo_sharp') return Icons.settings_input_svideo_sharp;
  if (value == 'settings_input_svideo_rounded') return Icons.settings_input_svideo_rounded;
  if (value == 'settings_input_svideo_outlined') return Icons.settings_input_svideo_outlined;
  if (value == 'settings_overscan') return Icons.settings_overscan;
  if (value == 'settings_overscan_sharp') return Icons.settings_overscan_sharp;
  if (value == 'settings_overscan_rounded') return Icons.settings_overscan_rounded;
  if (value == 'settings_overscan_outlined') return Icons.settings_overscan_outlined;
  ...
  if (value == 'settings_phone_outlined') return Icons.settings_phone_outlined;
  ...
  if (value == 'settings_power_outlined') return Icons.settings_power_outlined;
  if (value == 'settings_remote') return Icons.settings_remote;
  if (value == 'settings_remote_sharp') return Icons.settings_remote_sharp;
  if (value == 'settings_remote_rounded') return Icons.settings_remote_rounded;
  if (value == 'settings_remote_outlined') return Icons.settings_remote_outlined;
  ...
  if (value == 'settings_suggest_rounded') return Icons.settings_suggest_rounded;
  if (value == 'settings_suggest_outlined') return Icons.settings_suggest_outlined;
  if (value == 'settings_system_daydream') return Icons.settings_system_daydream;
  if (value == 'settings_system_daydream_sharp') return Icons.settings_system_daydream_sharp;
  if (value == 'settings_system_daydream_rounded') return Icons.settings_system_daydream_rounded;
  if (value == 'settings_system_daydream_outlined') return Icons.settings_system_daydream_outlined;
  ...
  if (value == 'settings_voice_outlined') return Icons.settings_voice_outlined;
  ...
  if (value == 'shape_line') return Icons.shape_line;
  if (value == 'shape_line_sharp') return Icons.shape_line_sharp;
  if (value == 'shape_line_rounded') return Icons.shape_line_rounded;
  if (value == 'shape_line_outlined') return Icons.shape_line_outlined;
  ...
  if (value == 'share_arrival_time_sharp') return Icons.share_arrival_time_sharp;
  if (value == 'share_arrival_time_rounded') return Icons.share_arrival_time_rounded;
  if (value == 'share_arrival_time_outlined') return Icons.share_arrival_time_outlined;
  ...
  if (value == 'share_location_outlined') return Icons.share_location_outlined;
  if (value == 'shelves') return Icons.shelves;
  ...
  if (value == 'shopping_basket_rounded') return Icons.shopping_basket_rounded;
  if (value == 'shopping_basket_outlined') return Icons.shopping_basket_outlined;
  ...
  if (value == 'shopping_cart_checkout_sharp') return Icons.shopping_cart_checkout_sharp;
  if (value == 'shopping_cart_checkout_rounded') return Icons.shopping_cart_checkout_rounded;
  if (value == 'shopping_cart_checkout_outlined') return Icons.shopping_cart_checkout_outlined;
  ...
  if (value == 'signal_cellular_0_bar_sharp') return Icons.signal_cellular_0_bar_sharp;
  if (value == 'signal_cellular_0_bar_rounded') return Icons.signal_cellular_0_bar_rounded;
  if (value == 'signal_cellular_0_bar_outlined') return Icons.signal_cellular_0_bar_outlined;
  if (value == 'signal_cellular_4_bar') return Icons.signal_cellular_4_bar;
  if (value == 'signal_cellular_4_bar_sharp') return Icons.signal_cellular_4_bar_sharp;
  if (value == 'signal_cellular_4_bar_rounded') return Icons.signal_cellular_4_bar_rounded;
  if (value == 'signal_cellular_4_bar_outlined') return Icons.signal_cellular_4_bar_outlined;
  if (value == 'signal_cellular_alt') return Icons.signal_cellular_alt;
  if (value == 'signal_cellular_alt_sharp') return Icons.signal_cellular_alt_sharp;
  if (value == 'signal_cellular_alt_rounded') return Icons.signal_cellular_alt_rounded;
  if (value == 'signal_cellular_alt_outlined') return Icons.signal_cellular_alt_outlined;
  if (value == 'signal_cellular_alt_1_bar') return Icons.signal_cellular_alt_1_bar;
  if (value == 'signal_cellular_alt_1_bar_sharp') return Icons.signal_cellular_alt_1_bar_sharp;
  if (value == 'signal_cellular_alt_1_bar_rounded') return Icons.signal_cellular_alt_1_bar_rounded;
  if (value == 'signal_cellular_alt_1_bar_outlined') return Icons.signal_cellular_alt_1_bar_outlined;
  if (value == 'signal_cellular_alt_2_bar') return Icons.signal_cellular_alt_2_bar;
  if (value == 'signal_cellular_alt_2_bar_sharp') return Icons.signal_cellular_alt_2_bar_sharp;
  if (value == 'signal_cellular_alt_2_bar_rounded') return Icons.signal_cellular_alt_2_bar_rounded;
  if (value == 'signal_cellular_alt_2_bar_outlined') return Icons.signal_cellular_alt_2_bar_outlined;
  if (value == 'signal_cellular_connected_no_internet_0_bar') return Icons.signal_cellular_connected_no_internet_0_bar;
  if (value == 'signal_cellular_connected_no_internet_0_bar_sharp') return Icons.signal_cellular_connected_no_internet_0_bar_sharp;
  if (value == 'signal_cellular_connected_no_internet_0_bar_rounded') return Icons.signal_cellular_connected_no_internet_0_bar_rounded;
  if (value == 'signal_cellular_connected_no_internet_0_bar_outlined') return Icons.signal_cellular_connected_no_internet_0_bar_outlined;
  if (value == 'signal_cellular_connected_no_internet_4_bar') return Icons.signal_cellular_connected_no_internet_4_bar;
  if (value == 'signal_cellular_connected_no_internet_4_bar_sharp') return Icons.signal_cellular_connected_no_internet_4_bar_sharp;
  if (value == 'signal_cellular_connected_no_internet_4_bar_rounded') return Icons.signal_cellular_connected_no_internet_4_bar_rounded;
  if (value == 'signal_cellular_connected_no_internet_4_bar_outlined') return Icons.signal_cellular_connected_no_internet_4_bar_outlined;
  if (value == 'signal_cellular_no_sim') return Icons.signal_cellular_no_sim;
  if (value == 'signal_cellular_no_sim_sharp') return Icons.signal_cellular_no_sim_sharp;
  if (value == 'signal_cellular_no_sim_rounded') return Icons.signal_cellular_no_sim_rounded;
  if (value == 'signal_cellular_no_sim_outlined') return Icons.signal_cellular_no_sim_outlined;
  if (value == 'signal_cellular_nodata') return Icons.signal_cellular_nodata;
  if (value == 'signal_cellular_nodata_sharp') return Icons.signal_cellular_nodata_sharp;
  if (value == 'signal_cellular_nodata_rounded') return Icons.signal_cellular_nodata_rounded;
  if (value == 'signal_cellular_nodata_outlined') return Icons.signal_cellular_nodata_outlined;
  if (value == 'signal_cellular_null') return Icons.signal_cellular_null;
  if (value == 'signal_cellular_null_sharp') return Icons.signal_cellular_null_sharp;
  if (value == 'signal_cellular_null_rounded') return Icons.signal_cellular_null_rounded;
  if (value == 'signal_cellular_null_outlined') return Icons.signal_cellular_null_outlined;
  if (value == 'signal_cellular_off') return Icons.signal_cellular_off;
  if (value == 'signal_cellular_off_sharp') return Icons.signal_cellular_off_sharp;
  if (value == 'signal_cellular_off_rounded') return Icons.signal_cellular_off_rounded;
  if (value == 'signal_cellular_off_outlined') return Icons.signal_cellular_off_outlined;
  if (value == 'signal_wifi_0_bar') return Icons.signal_wifi_0_bar;
  if (value == 'signal_wifi_0_bar_sharp') return Icons.signal_wifi_0_bar_sharp;
  if (value == 'signal_wifi_0_bar_rounded') return Icons.signal_wifi_0_bar_rounded;
  if (value == 'signal_wifi_0_bar_outlined') return Icons.signal_wifi_0_bar_outlined;
  if (value == 'signal_wifi_4_bar') return Icons.signal_wifi_4_bar;
  if (value == 'signal_wifi_4_bar_sharp') return Icons.signal_wifi_4_bar_sharp;
  if (value == 'signal_wifi_4_bar_rounded') return Icons.signal_wifi_4_bar_rounded;
  if (value == 'signal_wifi_4_bar_outlined') return Icons.signal_wifi_4_bar_outlined;
  if (value == 'signal_wifi_4_bar_lock') return Icons.signal_wifi_4_bar_lock;
  if (value == 'signal_wifi_4_bar_lock_sharp') return Icons.signal_wifi_4_bar_lock_sharp;
  if (value == 'signal_wifi_4_bar_lock_rounded') return Icons.signal_wifi_4_bar_lock_rounded;
  if (value == 'signal_wifi_4_bar_lock_outlined') return Icons.signal_wifi_4_bar_lock_outlined;
  if (value == 'signal_wifi_bad') return Icons.signal_wifi_bad;
  if (value == 'signal_wifi_bad_sharp') return Icons.signal_wifi_bad_sharp;
  if (value == 'signal_wifi_bad_rounded') return Icons.signal_wifi_bad_rounded;
  if (value == 'signal_wifi_bad_outlined') return Icons.signal_wifi_bad_outlined;
  if (value == 'signal_wifi_connected_no_internet_4') return Icons.signal_wifi_connected_no_internet_4;
  if (value == 'signal_wifi_connected_no_internet_4_sharp') return Icons.signal_wifi_connected_no_internet_4_sharp;
  if (value == 'signal_wifi_connected_no_internet_4_rounded') return Icons.signal_wifi_connected_no_internet_4_rounded;
  if (value == 'signal_wifi_connected_no_internet_4_outlined') return Icons.signal_wifi_connected_no_internet_4_outlined;
  if (value == 'signal_wifi_off') return Icons.signal_wifi_off;
  if (value == 'signal_wifi_off_sharp') return Icons.signal_wifi_off_sharp;
  if (value == 'signal_wifi_off_rounded') return Icons.signal_wifi_off_rounded;
  if (value == 'signal_wifi_off_outlined') return Icons.signal_wifi_off_outlined;
  if (value == 'signal_wifi_statusbar_4_bar') return Icons.signal_wifi_statusbar_4_bar;
  if (value == 'signal_wifi_statusbar_4_bar_sharp') return Icons.signal_wifi_statusbar_4_bar_sharp;
  if (value == 'signal_wifi_statusbar_4_bar_rounded') return Icons.signal_wifi_statusbar_4_bar_rounded;
  if (value == 'signal_wifi_statusbar_4_bar_outlined') return Icons.signal_wifi_statusbar_4_bar_outlined;
  if (value == 'signal_wifi_statusbar_connected_no_internet_4') return Icons.signal_wifi_statusbar_connected_no_internet_4;
  if (value == 'signal_wifi_statusbar_connected_no_internet_4_sharp') return Icons.signal_wifi_statusbar_connected_no_internet_4_sharp;
  if (value == 'signal_wifi_statusbar_connected_no_internet_4_rounded') return Icons.signal_wifi_statusbar_connected_no_internet_4_rounded;
  if (value == 'signal_wifi_statusbar_connected_no_internet_4_outlined') return Icons.signal_wifi_statusbar_connected_no_internet_4_outlined;
  if (value == 'signal_wifi_statusbar_null') return Icons.signal_wifi_statusbar_null;
  if (value == 'signal_wifi_statusbar_null_sharp') return Icons.signal_wifi_statusbar_null_sharp;
  if (value == 'signal_wifi_statusbar_null_rounded') return Icons.signal_wifi_statusbar_null_rounded;
  if (value == 'signal_wifi_statusbar_null_outlined') return Icons.signal_wifi_statusbar_null_outlined;
  ...
  if (value == 'sim_card_alert_outlined') return Icons.sim_card_alert_outlined;
  if (value == 'sim_card_download') return Icons.sim_card_download;
  if (value == 'sim_card_download_sharp') return Icons.sim_card_download_sharp;
  if (value == 'sim_card_download_rounded') return Icons.sim_card_download_rounded;
  if (value == 'sim_card_download_outlined') return Icons.sim_card_download_outlined;
  ...
  if (value == 'slow_motion_video_sharp') return Icons.slow_motion_video_sharp;
  if (value == 'slow_motion_video_rounded') return Icons.slow_motion_video_rounded;
  if (value == 'slow_motion_video_outlined') return Icons.slow_motion_video_outlined;
  ...
  if (value == 'snippet_folder_outlined') return Icons.snippet_folder_outlined;
  ...
  if (value == 'social_distance_rounded') return Icons.social_distance_rounded;
  if (value == 'social_distance_outlined') return Icons.social_distance_outlined;
  ...
  if (value == 'space_dashboard_rounded') return Icons.space_dashboard_rounded;
  if (value == 'space_dashboard_outlined') return Icons.space_dashboard_outlined;
  ...
  if (value == 'spatial_audio_off_sharp') return Icons.spatial_audio_off_sharp;
  if (value == 'spatial_audio_off_rounded') return Icons.spatial_audio_off_rounded;
  if (value == 'spatial_audio_off_outlined') return Icons.spatial_audio_off_outlined;
  ...
  if (value == 'spatial_tracking_rounded') return Icons.spatial_tracking_rounded;
  if (value == 'spatial_tracking_outlined') return Icons.spatial_tracking_outlined;
  ...
  if (value == 'speaker_notes_off_sharp') return Icons.speaker_notes_off_sharp;
  if (value == 'speaker_notes_off_rounded') return Icons.speaker_notes_off_rounded;
  if (value == 'speaker_notes_off_outlined') return Icons.speaker_notes_off_outlined;
  ...
  if (value == 'sports_baseball_rounded') return Icons.sports_baseball_rounded;
  if (value == 'sports_baseball_outlined') return Icons.sports_baseball_outlined;
  if (value == 'sports_basketball') return Icons.sports_basketball;
  if (value == 'sports_basketball_sharp') return Icons.sports_basketball_sharp;
  if (value == 'sports_basketball_rounded') return Icons.sports_basketball_rounded;
  if (value == 'sports_basketball_outlined') return Icons.sports_basketball_outlined;
  ...
  if (value == 'sports_cricket_outlined') return Icons.sports_cricket_outlined;
  ...
  if (value == 'sports_esports_outlined') return Icons.sports_esports_outlined;
  if (value == 'sports_football') return Icons.sports_football;
  if (value == 'sports_football_sharp') return Icons.sports_football_sharp;
  if (value == 'sports_football_rounded') return Icons.sports_football_rounded;
  if (value == 'sports_football_outlined') return Icons.sports_football_outlined;
  ...
  if (value == 'sports_gymnastics_sharp') return Icons.sports_gymnastics_sharp;
  if (value == 'sports_gymnastics_rounded') return Icons.sports_gymnastics_rounded;
  if (value == 'sports_gymnastics_outlined') return Icons.sports_gymnastics_outlined;
  if (value == 'sports_handball') return Icons.sports_handball;
  if (value == 'sports_handball_sharp') return Icons.sports_handball_sharp;
  if (value == 'sports_handball_rounded') return Icons.sports_handball_rounded;
  if (value == 'sports_handball_outlined') return Icons.sports_handball_outlined;
  ...
  if (value == 'sports_kabaddi_outlined') return Icons.sports_kabaddi_outlined;
  if (value == 'sports_martial_arts') return Icons.sports_martial_arts;
  if (value == 'sports_martial_arts_sharp') return Icons.sports_martial_arts_sharp;
  if (value == 'sports_martial_arts_rounded') return Icons.sports_martial_arts_rounded;
  if (value == 'sports_martial_arts_outlined') return Icons.sports_martial_arts_outlined;
  ...
  if (value == 'sports_motorsports_sharp') return Icons.sports_motorsports_sharp;
  if (value == 'sports_motorsports_rounded') return Icons.sports_motorsports_rounded;
  if (value == 'sports_motorsports_outlined') return Icons.sports_motorsports_outlined;
  ...
  if (value == 'sports_volleyball_sharp') return Icons.sports_volleyball_sharp;
  if (value == 'sports_volleyball_rounded') return Icons.sports_volleyball_rounded;
  if (value == 'sports_volleyball_outlined') return Icons.sports_volleyball_outlined;
  ...
  if (value == 'stacked_bar_chart_sharp') return Icons.stacked_bar_chart_sharp;
  if (value == 'stacked_bar_chart_rounded') return Icons.stacked_bar_chart_rounded;
  if (value == 'stacked_bar_chart_outlined') return Icons.stacked_bar_chart_outlined;
  if (value == 'stacked_line_chart') return Icons.stacked_line_chart;
  if (value == 'stacked_line_chart_sharp') return Icons.stacked_line_chart_sharp;
  if (value == 'stacked_line_chart_rounded') return Icons.stacked_line_chart_rounded;
  if (value == 'stacked_line_chart_outlined') return Icons.stacked_line_chart_outlined;
  ...
  if (value == 'star_border_purple500_sharp') return Icons.star_border_purple500_sharp;
  if (value == 'star_border_purple500_rounded') return Icons.star_border_purple500_rounded;
  if (value == 'star_border_purple500_outlined') return Icons.star_border_purple500_outlined;
  ...
  if (value == 'star_purple500_outlined') return Icons.star_purple500_outlined;
  ...
  if (value == 'stay_current_landscape_sharp') return Icons.stay_current_landscape_sharp;
  if (value == 'stay_current_landscape_rounded') return Icons.stay_current_landscape_rounded;
  if (value == 'stay_current_landscape_outlined') return Icons.stay_current_landscape_outlined;
  if (value == 'stay_current_portrait') return Icons.stay_current_portrait;
  if (value == 'stay_current_portrait_sharp') return Icons.stay_current_portrait_sharp;
  if (value == 'stay_current_portrait_rounded') return Icons.stay_current_portrait_rounded;
  if (value == 'stay_current_portrait_outlined') return Icons.stay_current_portrait_outlined;
  if (value == 'stay_primary_landscape') return Icons.stay_primary_landscape;
  if (value == 'stay_primary_landscape_sharp') return Icons.stay_primary_landscape_sharp;
  if (value == 'stay_primary_landscape_rounded') return Icons.stay_primary_landscape_rounded;
  if (value == 'stay_primary_landscape_outlined') return Icons.stay_primary_landscape_outlined;
  if (value == 'stay_primary_portrait') return Icons.stay_primary_portrait;
  if (value == 'stay_primary_portrait_sharp') return Icons.stay_primary_portrait_sharp;
  if (value == 'stay_primary_portrait_rounded') return Icons.stay_primary_portrait_rounded;
  if (value == 'stay_primary_portrait_outlined') return Icons.stay_primary_portrait_outlined;
  ...
  if (value == 'stop_screen_share_sharp') return Icons.stop_screen_share_sharp;
  if (value == 'stop_screen_share_rounded') return Icons.stop_screen_share_rounded;
  if (value == 'stop_screen_share_outlined') return Icons.stop_screen_share_outlined;
  ...
  if (value == 'store_mall_directory_sharp') return Icons.store_mall_directory_sharp;
  if (value == 'store_mall_directory_rounded') return Icons.store_mall_directory_rounded;
  if (value == 'store_mall_directory_outlined') return Icons.store_mall_directory_outlined;
  ...
  if (value == 'strikethrough_s_rounded') return Icons.strikethrough_s_rounded;
  if (value == 'strikethrough_s_outlined') return Icons.strikethrough_s_outlined;
  ...
  if (value == 'subdirectory_arrow_left') return Icons.subdirectory_arrow_left;
  if (value == 'subdirectory_arrow_left_sharp') return Icons.subdirectory_arrow_left_sharp;
  if (value == 'subdirectory_arrow_left_rounded') return Icons.subdirectory_arrow_left_rounded;
  if (value == 'subdirectory_arrow_left_outlined') return Icons.subdirectory_arrow_left_outlined;
  if (value == 'subdirectory_arrow_right') return Icons.subdirectory_arrow_right;
  if (value == 'subdirectory_arrow_right_sharp') return Icons.subdirectory_arrow_right_sharp;
  if (value == 'subdirectory_arrow_right_rounded') return Icons.subdirectory_arrow_right_rounded;
  if (value == 'subdirectory_arrow_right_outlined') return Icons.subdirectory_arrow_right_outlined;
  ...
  if (value == 'supervised_user_circle_sharp') return Icons.supervised_user_circle_sharp;
  if (value == 'supervised_user_circle_rounded') return Icons.supervised_user_circle_rounded;
  if (value == 'supervised_user_circle_outlined') return Icons.supervised_user_circle_outlined;
  if (value == 'supervisor_account') return Icons.supervisor_account;
  if (value == 'supervisor_account_sharp') return Icons.supervisor_account_sharp;
  if (value == 'supervisor_account_rounded') return Icons.supervisor_account_rounded;
  if (value == 'supervisor_account_outlined') return Icons.supervisor_account_outlined;
  ...
  if (value == 'surround_sound_outlined') return Icons.surround_sound_outlined;
  ...
  if (value == 'swap_horizontal_circle_sharp') return Icons.swap_horizontal_circle_sharp;
  if (value == 'swap_horizontal_circle_rounded') return Icons.swap_horizontal_circle_rounded;
  if (value == 'swap_horizontal_circle_outlined') return Icons.swap_horizontal_circle_outlined;
  ...
  if (value == 'swap_vert_circle_rounded') return Icons.swap_vert_circle_rounded;
  if (value == 'swap_vert_circle_outlined') return Icons.swap_vert_circle_outlined;
  if (value == 'swap_vertical_circle') return Icons.swap_vertical_circle;
  if (value == 'swap_vertical_circle_sharp') return Icons.swap_vertical_circle_sharp;
  if (value == 'swap_vertical_circle_rounded') return Icons.swap_vertical_circle_rounded;
  if (value == 'swap_vertical_circle_outlined') return Icons.swap_vertical_circle_outlined;
  ...
  if (value == 'swipe_down_alt_outlined') return Icons.swipe_down_alt_outlined;
  ...
  if (value == 'swipe_left_alt_outlined') return Icons.swipe_left_alt_outlined;
  ...
  if (value == 'swipe_right_alt_rounded') return Icons.swipe_right_alt_rounded;
  if (value == 'swipe_right_alt_outlined') return Icons.swipe_right_alt_outlined;
  ...
  if (value == 'swipe_vertical_outlined') return Icons.swipe_vertical_outlined;
  if (value == 'switch_access_shortcut') return Icons.switch_access_shortcut;
  if (value == 'switch_access_shortcut_sharp') return Icons.switch_access_shortcut_sharp;
  if (value == 'switch_access_shortcut_rounded') return Icons.switch_access_shortcut_rounded;
  if (value == 'switch_access_shortcut_outlined') return Icons.switch_access_shortcut_outlined;
  if (value == 'switch_access_shortcut_add') return Icons.switch_access_shortcut_add;
  if (value == 'switch_access_shortcut_add_sharp') return Icons.switch_access_shortcut_add_sharp;
  if (value == 'switch_access_shortcut_add_rounded') return Icons.switch_access_shortcut_add_rounded;
  if (value == 'switch_access_shortcut_add_outlined') return Icons.switch_access_shortcut_add_outlined;
  ...
  if (value == 'switch_account_outlined') return Icons.switch_account_outlined;
  ...
  if (value == 'system_security_update_sharp') return Icons.system_security_update_sharp;
  if (value == 'system_security_update_rounded') return Icons.system_security_update_rounded;
  if (value == 'system_security_update_outlined') return Icons.system_security_update_outlined;
  if (value == 'system_security_update_good') return Icons.system_security_update_good;
  if (value == 'system_security_update_good_sharp') return Icons.system_security_update_good_sharp;
  if (value == 'system_security_update_good_rounded') return Icons.system_security_update_good_rounded;
  if (value == 'system_security_update_good_outlined') return Icons.system_security_update_good_outlined;
  if (value == 'system_security_update_warning') return Icons.system_security_update_warning;
  if (value == 'system_security_update_warning_sharp') return Icons.system_security_update_warning_sharp;
  if (value == 'system_security_update_warning_rounded') return Icons.system_security_update_warning_rounded;
  if (value == 'system_security_update_warning_outlined') return Icons.system_security_update_warning_outlined;
  ...
  if (value == 'system_update_alt_sharp') return Icons.system_update_alt_sharp;
  if (value == 'system_update_alt_rounded') return Icons.system_update_alt_rounded;
  if (value == 'system_update_alt_outlined') return Icons.system_update_alt_outlined;
  ...
  if (value == 'system_update_tv_rounded') return Icons.system_update_tv_rounded;
  if (value == 'system_update_tv_outlined') return Icons.system_update_tv_outlined;
  ...
  if (value == 'tab_unselected_outlined') return Icons.tab_unselected_outlined;
  ...
  if (value == 'table_restaurant_rounded') return Icons.table_restaurant_rounded;
  if (value == 'table_restaurant_outlined') return Icons.table_restaurant_outlined;
  ...
  if (value == 'tablet_android_outlined') return Icons.tablet_android_outlined;
  ...
  if (value == 'takeout_dining_outlined') return Icons.takeout_dining_outlined;
  ...
  if (value == 'temple_buddhist_rounded') return Icons.temple_buddhist_rounded;
  if (value == 'temple_buddhist_outlined') return Icons.temple_buddhist_outlined;
  ...
  if (value == 'text_rotate_up_outlined') return Icons.text_rotate_up_outlined;
  if (value == 'text_rotate_vertical') return Icons.text_rotate_vertical;
  if (value == 'text_rotate_vertical_sharp') return Icons.text_rotate_vertical_sharp;
  if (value == 'text_rotate_vertical_rounded') return Icons.text_rotate_vertical_rounded;
  if (value == 'text_rotate_vertical_outlined') return Icons.text_rotate_vertical_outlined;
  if (value == 'text_rotation_angledown') return Icons.text_rotation_angledown;
  if (value == 'text_rotation_angledown_sharp') return Icons.text_rotation_angledown_sharp;
  if (value == 'text_rotation_angledown_rounded') return Icons.text_rotation_angledown_rounded;
  if (value == 'text_rotation_angledown_outlined') return Icons.text_rotation_angledown_outlined;
  if (value == 'text_rotation_angleup') return Icons.text_rotation_angleup;
  if (value == 'text_rotation_angleup_sharp') return Icons.text_rotation_angleup_sharp;
  if (value == 'text_rotation_angleup_rounded') return Icons.text_rotation_angleup_rounded;
  if (value == 'text_rotation_angleup_outlined') return Icons.text_rotation_angleup_outlined;
  if (value == 'text_rotation_down') return Icons.text_rotation_down;
  if (value == 'text_rotation_down_sharp') return Icons.text_rotation_down_sharp;
  if (value == 'text_rotation_down_rounded') return Icons.text_rotation_down_rounded;
  if (value == 'text_rotation_down_outlined') return Icons.text_rotation_down_outlined;
  if (value == 'text_rotation_none') return Icons.text_rotation_none;
  if (value == 'text_rotation_none_sharp') return Icons.text_rotation_none_sharp;
  if (value == 'text_rotation_none_rounded') return Icons.text_rotation_none_rounded;
  if (value == 'text_rotation_none_outlined') return Icons.text_rotation_none_outlined;
  ...
  if (value == 'theater_comedy_outlined') return Icons.theater_comedy_outlined;
  ...
  if (value == 'thermostat_auto_rounded') return Icons.thermostat_auto_rounded;
  if (value == 'thermostat_auto_outlined') return Icons.thermostat_auto_outlined;
  ...
  if (value == 'thumb_down_alt_outlined') return Icons.thumb_down_alt_outlined;
  if (value == 'thumb_down_off_alt') return Icons.thumb_down_off_alt;
  if (value == 'thumb_down_off_alt_sharp') return Icons.thumb_down_off_alt_sharp;
  if (value == 'thumb_down_off_alt_rounded') return Icons.thumb_down_off_alt_rounded;
  if (value == 'thumb_down_off_alt_outlined') return Icons.thumb_down_off_alt_outlined;
  ...
  if (value == 'thumb_up_off_alt_rounded') return Icons.thumb_up_off_alt_rounded;
  if (value == 'thumb_up_off_alt_outlined') return Icons.thumb_up_off_alt_outlined;
  ...
  if (value == 'thumbs_up_down_outlined') return Icons.thumbs_up_down_outlined;
  ...
  if (value == 'timer_10_select_rounded') return Icons.timer_10_select_rounded;
  if (value == 'timer_10_select_outlined') return Icons.timer_10_select_outlined;
  ...
  if (value == 'timer_3_select_outlined') return Icons.timer_3_select_outlined;
  ...
  if (value == 'tips_and_updates_rounded') return Icons.tips_and_updates_rounded;
  if (value == 'tips_and_updates_outlined') return Icons.tips_and_updates_outlined;
  ...
  if (value == 'transfer_within_a_station') return Icons.transfer_within_a_station;
  if (value == 'transfer_within_a_station_sharp') return Icons.transfer_within_a_station_sharp;
  if (value == 'transfer_within_a_station_rounded') return Icons.transfer_within_a_station_rounded;
  if (value == 'transfer_within_a_station_outlined') return Icons.transfer_within_a_station_outlined;
  ...
  if (value == 'transit_enterexit_sharp') return Icons.transit_enterexit_sharp;
  if (value == 'transit_enterexit_rounded') return Icons.transit_enterexit_rounded;
  if (value == 'transit_enterexit_outlined') return Icons.transit_enterexit_outlined;
  ...
  if (value == 'travel_explore_outlined') return Icons.travel_explore_outlined;
  ...
  if (value == 'trending_neutral_rounded') return Icons.trending_neutral_rounded;
  if (value == 'trending_neutral_outlined') return Icons.trending_neutral_outlined;
  ...
  if (value == 'trolley') return Icons.trolley;
  ...
  if (value == 'turn_sharp_left_rounded') return Icons.turn_sharp_left_rounded;
  if (value == 'turn_sharp_left_outlined') return Icons.turn_sharp_left_outlined;
  ...
  if (value == 'turn_sharp_right_rounded') return Icons.turn_sharp_right_rounded;
  if (value == 'turn_sharp_right_outlined') return Icons.turn_sharp_right_outlined;
  ...
  if (value == 'turn_slight_left_rounded') return Icons.turn_slight_left_rounded;
  if (value == 'turn_slight_left_outlined') return Icons.turn_slight_left_outlined;
  if (value == 'turn_slight_right') return Icons.turn_slight_right;
  if (value == 'turn_slight_right_sharp') return Icons.turn_slight_right_sharp;
  if (value == 'turn_slight_right_rounded') return Icons.turn_slight_right_rounded;
  if (value == 'turn_slight_right_outlined') return Icons.turn_slight_right_outlined;
  ...
  if (value == 'unfold_less_double') return Icons.unfold_less_double;
  if (value == 'unfold_less_double_sharp') return Icons.unfold_less_double_sharp;
  if (value == 'unfold_less_double_rounded') return Icons.unfold_less_double_rounded;
  if (value == 'unfold_less_double_outlined') return Icons.unfold_less_double_outlined;
  ...
  if (value == 'unfold_more_double') return Icons.unfold_more_double;
  if (value == 'unfold_more_double_sharp') return Icons.unfold_more_double_sharp;
  if (value == 'unfold_more_double_rounded') return Icons.unfold_more_double_rounded;
  if (value == 'unfold_more_double_outlined') return Icons.unfold_more_double_outlined;
  ...
  if (value == 'update_disabled_rounded') return Icons.update_disabled_rounded;
  if (value == 'update_disabled_outlined') return Icons.update_disabled_outlined;
  ...
  if (value == 'vertical_align_bottom_sharp') return Icons.vertical_align_bottom_sharp;
  if (value == 'vertical_align_bottom_rounded') return Icons.vertical_align_bottom_rounded;
  if (value == 'vertical_align_bottom_outlined') return Icons.vertical_align_bottom_outlined;
  if (value == 'vertical_align_center') return Icons.vertical_align_center;
  if (value == 'vertical_align_center_sharp') return Icons.vertical_align_center_sharp;
  if (value == 'vertical_align_center_rounded') return Icons.vertical_align_center_rounded;
  if (value == 'vertical_align_center_outlined') return Icons.vertical_align_center_outlined;
  if (value == 'vertical_align_top') return Icons.vertical_align_top;
  if (value == 'vertical_align_top_sharp') return Icons.vertical_align_top_sharp;
  if (value == 'vertical_align_top_rounded') return Icons.vertical_align_top_rounded;
  if (value == 'vertical_align_top_outlined') return Icons.vertical_align_top_outlined;
  if (value == 'vertical_distribute') return Icons.vertical_distribute;
  if (value == 'vertical_distribute_sharp') return Icons.vertical_distribute_sharp;
  if (value == 'vertical_distribute_rounded') return Icons.vertical_distribute_rounded;
  if (value == 'vertical_distribute_outlined') return Icons.vertical_distribute_outlined;
  if (value == 'vertical_shades') return Icons.vertical_shades;
  if (value == 'vertical_shades_sharp') return Icons.vertical_shades_sharp;
  if (value == 'vertical_shades_rounded') return Icons.vertical_shades_rounded;
  if (value == 'vertical_shades_outlined') return Icons.vertical_shades_outlined;
  if (value == 'vertical_shades_closed') return Icons.vertical_shades_closed;
  if (value == 'vertical_shades_closed_sharp') return Icons.vertical_shades_closed_sharp;
  if (value == 'vertical_shades_closed_rounded') return Icons.vertical_shades_closed_rounded;
  if (value == 'vertical_shades_closed_outlined') return Icons.vertical_shades_closed_outlined;
  ...
  if (value == 'vertical_split_outlined') return Icons.vertical_split_outlined;
  ...
  if (value == 'video_camera_back_sharp') return Icons.video_camera_back_sharp;
  if (value == 'video_camera_back_rounded') return Icons.video_camera_back_rounded;
  if (value == 'video_camera_back_outlined') return Icons.video_camera_back_outlined;
  if (value == 'video_camera_front') return Icons.video_camera_front;
  if (value == 'video_camera_front_sharp') return Icons.video_camera_front_sharp;
  if (value == 'video_camera_front_rounded') return Icons.video_camera_front_rounded;
  if (value == 'video_camera_front_outlined') return Icons.video_camera_front_outlined;
  if (value == 'video_chat') return Icons.video_chat;
  if (value == 'video_chat_sharp') return Icons.video_chat_sharp;
  if (value == 'video_chat_rounded') return Icons.video_chat_rounded;
  if (value == 'video_chat_outlined') return Icons.video_chat_outlined;
  ...
  if (value == 'video_collection_rounded') return Icons.video_collection_rounded;
  if (value == 'video_collection_outlined') return Icons.video_collection_outlined;
  ...
  if (value == 'video_settings_outlined') return Icons.video_settings_outlined;
  ...
  if (value == 'videogame_asset_rounded') return Icons.videogame_asset_rounded;
  if (value == 'videogame_asset_outlined') return Icons.videogame_asset_outlined;
  if (value == 'videogame_asset_off') return Icons.videogame_asset_off;
  if (value == 'videogame_asset_off_sharp') return Icons.videogame_asset_off_sharp;
  if (value == 'videogame_asset_off_rounded') return Icons.videogame_asset_off_rounded;
  if (value == 'videogame_asset_off_outlined') return Icons.videogame_asset_off_outlined;
  ...
  if (value == 'view_comfortable_rounded') return Icons.view_comfortable_rounded;
  if (value == 'view_comfortable_outlined') return Icons.view_comfortable_outlined;
  ...
  if (value == 'view_comfy_alt_outlined') return Icons.view_comfy_alt_outlined;
  ...
  if (value == 'view_compact_alt_rounded') return Icons.view_compact_alt_rounded;
  if (value == 'view_compact_alt_outlined') return Icons.view_compact_alt_outlined;
  ...
  if (value == 'visibility_off_outlined') return Icons.visibility_off_outlined;
  ...
  if (value == 'voice_over_off_outlined') return Icons.voice_over_off_outlined;
  ...
  if (value == 'volunteer_activism_sharp') return Icons.volunteer_activism_sharp;
  if (value == 'volunteer_activism_rounded') return Icons.volunteer_activism_rounded;
  if (value == 'volunteer_activism_outlined') return Icons.volunteer_activism_outlined;
  ...
  if (value == 'wallet_giftcard_rounded') return Icons.wallet_giftcard_rounded;
  if (value == 'wallet_giftcard_outlined') return Icons.wallet_giftcard_outlined;
  if (value == 'wallet_membership') return Icons.wallet_membership;
  if (value == 'wallet_membership_sharp') return Icons.wallet_membership_sharp;
  if (value == 'wallet_membership_rounded') return Icons.wallet_membership_rounded;
  if (value == 'wallet_membership_outlined') return Icons.wallet_membership_outlined;
  ...
  if (value == 'waterfall_chart_rounded') return Icons.waterfall_chart_rounded;
  if (value == 'waterfall_chart_outlined') return Icons.waterfall_chart_outlined;
  ...
  if (value == 'wb_incandescent_rounded') return Icons.wb_incandescent_rounded;
  if (value == 'wb_incandescent_outlined') return Icons.wb_incandescent_outlined;
  ...
  if (value == 'web_stories_sharp') return Icons.web_stories_sharp;
  if (value == 'web_stories_rounded') return Icons.web_stories_rounded;
  if (value == 'web_stories_outlined') return Icons.web_stories_outlined;
  ...
  if (value == 'wheelchair_pickup_sharp') return Icons.wheelchair_pickup_sharp;
  if (value == 'wheelchair_pickup_rounded') return Icons.wheelchair_pickup_rounded;
  if (value == 'wheelchair_pickup_outlined') return Icons.wheelchair_pickup_outlined;
  ...
  if (value == 'wifi_calling_3_outlined') return Icons.wifi_calling_3_outlined;
  ...
  if (value == 'wifi_protected_setup_sharp') return Icons.wifi_protected_setup_sharp;
  if (value == 'wifi_protected_setup_rounded') return Icons.wifi_protected_setup_rounded;
  if (value == 'wifi_protected_setup_outlined') return Icons.wifi_protected_setup_outlined;
  ...
  if (value == 'wifi_tethering_outlined') return Icons.wifi_tethering_outlined;
  if (value == 'wifi_tethering_error') return Icons.wifi_tethering_error;
  if (value == 'wifi_tethering_error_sharp') return Icons.wifi_tethering_error_sharp;
  if (value == 'wifi_tethering_error_rounded') return Icons.wifi_tethering_error_rounded;
  if (value == 'wifi_tethering_error_outlined') return Icons.wifi_tethering_error_outlined;
  if (value == 'wifi_tethering_error_rounded_sharp') return Icons.wifi_tethering_error_rounded_sharp;
  if (value == 'wifi_tethering_error_rounded_rounded') return Icons.wifi_tethering_error_rounded_rounded;
  if (value == 'wifi_tethering_error_rounded_outlined') return Icons.wifi_tethering_error_rounded_outlined;
  if (value == 'wifi_tethering_off') return Icons.wifi_tethering_off;
  if (value == 'wifi_tethering_off_sharp') return Icons.wifi_tethering_off_sharp;
  if (value == 'wifi_tethering_off_rounded') return Icons.wifi_tethering_off_rounded;
  if (value == 'wifi_tethering_off_outlined') return Icons.wifi_tethering_off_outlined;
  ...
  if (value == 'woman_2') return Icons.woman_2;
  if (value == 'woman_2_sharp') return Icons.woman_2_sharp;
  if (value == 'woman_2_rounded') return Icons.woman_2_rounded;
  if (value == 'woman_2_outlined') return Icons.woman_2_outlined;
  ...
  if (value == 'workspace_premium_sharp') return Icons.workspace_premium_sharp;
  if (value == 'workspace_premium_rounded') return Icons.workspace_premium_rounded;
  if (value == 'workspace_premium_outlined') return Icons.workspace_premium_outlined;
  ...
  if (value == 'wrong_location_outlined') return Icons.wrong_location_outlined;
  ...
  if (value == 'youtube_searched_for_sharp') return Icons.youtube_searched_for_sharp;
  if (value == 'youtube_searched_for_rounded') return Icons.youtube_searched_for_rounded;
  if (value == 'youtube_searched_for_outlined') return Icons.youtube_searched_for_outlined;
