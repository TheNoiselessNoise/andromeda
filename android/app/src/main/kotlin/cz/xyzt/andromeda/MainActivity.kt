...
class MainActivity: FlutterFragmentActivity() {
    private val COMMAND_CHANNEL = "cz.xyzt.andromeda/command"
    private val SCAN_CHANNEL = "cz.xyzt.andromeda/scan"
    private val PROFILE_INTENT_ACTION = "cz.xyzt.andromeda.SCAN"
                ...
                object : StreamHandler {
                    ...
                    override fun onListen(arguments: Any?, events: EventSink?) {
                        ...
                        try {
                            ...
                            Log.e("DATAWEDGE", "Error registering broadcast receiver", e)
                        }
                    }
